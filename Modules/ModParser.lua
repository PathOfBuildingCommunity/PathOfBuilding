...
local preFlagList = {
	...
	["^enemies (%a+) by you ([th]a[vk]e) "] = function(cond, takeOrHave)
		return { tag = { type = "Condition", var = cond:gsub("^%a", string.upper) }, applyToEnemy = true, modSuffix = takeOrHave == "take" and "Taken" or "" }
	end,
