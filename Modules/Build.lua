...
function buildMode:Init(dbFileName, buildName, buildXML, targetVersion)
	...
	self.displayStats = {
		...
		{ stat = "PvpWithPoisonDPS", label = "Total Pvp DPS inc. Poison", fmt = ".1f", compPercent = true, flag = "poison", condFunc = function(v,o) return v ~= o.TotalDPS end },
		...
		{ stat = "PvpWithPoisonAverageDamage", label = "Average Pvp Dmg. inc. Poison", fmt = ".1f", compPercent = true, flag = "poison", condFunc = function(v,o) return v ~= o.AverageDamage end },
		...
		{ stat = "PvpCombinedDPS", label = "PvP Combined DPS", fmt = ".1f", compPercent = true, flag = "notAverage", condFunc = function(v,o) return v ~= o.TotalDPS and v ~= o.WithImpaleDPS and v ~= o.WithPoisonDPS and v ~= o.WithIgniteDPS end},
