...
=======
		{ stat = "TotalDPS", label = "Total DPS", fmt = ".1f", compPercent = true, flag = "notAverage", notFlag = "triggered" },
		{ stat = "TotalDPS", label = "Total DPS", fmt = ".1f", compPercent = true, flag = "triggered" },
>>>>>>> CoC
					...
					if statData.skillDPSStat then
						...
						for _, skillData in ipairs(actor.output.SkillDPS) do
							...
							if skillData.source then
								t_insert(statBoxList, {
									height = 16,
									colorCodes.UNIQUE.."^ Source:",
									colorCodes.CUSTOM..skillData.source,
								})
							end
						end
