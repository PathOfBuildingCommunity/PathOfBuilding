...
return {
	...
	{ var = "physMode", type = "list", label = "Physical As Random mode:", ifFlag = "randomPhys", tooltip = "Controls how modifiers which grant Damage of a random element based on Physical Damage will function.\n\tAverage: Modifiers will grant one third of their value as extra Fire, Cold, and Lightning simultaneously\n\tFire/Cold/Lightning: Modifiers will grant their full value as the specified element", list = {{val="AVERAGE",label="Average"},{val="FIRE",label="Fire"},{val="COLD",label="Cold"},{val="LIGHTNING",label="Lightning"}} },
