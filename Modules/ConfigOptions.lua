...
return {
	...
	{ var = "multiplierPvpDotTvalueOverride", type = "count", label = "PvP Dot Tvalue override (ms):", ifFlag = "isPvP", tooltip = "Tvalue in milliseconds. This overrides the Tvalue of the dot portion of a given skill, not used for generic dots like bleed, ingite or poison, it only applys to dots granted by skills", apply = function(val, modList, enemyModList)
		modList:NewMod("Multiplier:PvpTvalueOverride", "BASE", val, "Config", { type = "Condition", var = "Combat" })
	end },
