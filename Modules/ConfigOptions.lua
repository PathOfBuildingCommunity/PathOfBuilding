...
return {
	...
	{ var = "conditionChainedFromTarget", type = "check", label = "Skill chains to another target?", ifFlag = "chaining", apply = function(val, modList, enemyModList)
		enemyModList:NewMod("Condition:ChainedFromTarget", "FLAG", true, "Config", { type = "Condition", var = "Effective" })
	end },
