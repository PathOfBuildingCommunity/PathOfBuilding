...
{ 3, "DamageTaken", 1, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "Damage Taken", data = {
	...
	{ label = "Hit taken",
		{ format = "x {2:output:SecondMaximumTakenHitMult}", 
			{ breakdown = "SecondMaximumTakenHitMult" }, 
		},
	...
	{ label = "DoT taken",
		{ format = "x {2:output:SecondMaximumTakenDotMult}", 
			{ breakdown = "SecondMaximumTakenDotMult" }, 
		},
	...
	colWidth = 95,
	{ label = "Melee Ch.",
		{ format = "{1:output:SecondMinimumMeleeDamageChance}%", 
			{ breakdown = "SecondMinimumMeleeDamageChance" }, 
		},
	...
	{ label = "Projectile Ch.",
		{ format = "{1:output:SecondMinimumProjectileDamageChance}%", 
			{ breakdown = "SecondMinimumProjectileDamageChance" }, 
		},
	...
	{ label = "Spell Ch.",
		{ format = "{1:output:SecondMinimumSpellDamageChance}%", 
			{ breakdown = "SecondMinimumSpellDamageChance" }, 
		},
	...
	{ label = "Spell Projectile Ch.",
		{ format = "{1:output:SecondMinimumSpellProjectileDamageChance}%", 
			{ breakdown = "SecondMinimumSpellProjectileDamageChance" }, 
		},
	...
	{ label = "Total Pool",
		{ format = "{0:output:SecondMinimumTotalPool}", 
			{ breakdown = "SecondMinimumTotalPool" },			
		},
	...
	{ label = "Maximum Hit Taken",
		{ format = "{0:output:SecondMinimumMaximumHitTaken}", 
			{ breakdown = "SecondMinimumMaximumHitTaken" }, 
		},
	...
	{ label = "Effective DoT Pool",
		{ format = "{0:output:SecondMinimumDotEHP}", 
			{ breakdown = "SecondMinimumDotEHP" }, 
		},
	...
	{ label = "Effective Hit Pool",
		{ format = "{0:output:SecondMinimumTotalEHP}", 
			{ breakdown = "SecondMinimumTotalEHP" }, 
		},
