...
{ 3, "HitDamage", 1, "Skill Hit Damage", data.colorCodes.OFFENCE, {
	...
	{ label = "Effective DPS Mod", flag = "effective",
		...
		{ format = "x {2:output:ChaosEffMult}",
...
{ 3, "Dot", 1, "Skill Damage over Time", data.colorCodes.OFFENCE, {
	...
	{ label = "Effective DPS Mod", flag = "effective",
		{ },
		{ format = "x {2:output:PhysicalDotEffMult}",
		...
		{ format = "x {2:output:LightningDotEffMult}",
		...
		{ format = "x {2:output:ColdDotEffMult}",
		...
		{ format = "x {2:output:FireDotEffMult}",
		...
		{ format = "x {2:output:ChaosDotEffMult}",
...
{ 1, "Bleed", 1, "Bleed", data.colorCodes.OFFENCE, {
	...
	{ label = "Effective DPS Mod", flag = "effective", { format = "x {2:output:BleedEffMult}", { breakdown = "BleedEffMult" }, { label = "Enemy modifiers", modName = { "DamageTaken", "DotTaken", "PhysicalDamageTaken", "PhysicalDamageReduction" }, enemy = true }, }, },
...
{ 1, "Poison", 1, "Poison", data.colorCodes.OFFENCE, {
	...
	{ label = "Effective DPS Mod", flag = "effective", { format = "x {2:output:PoisonEffMult}", { breakdown = "PoisonEffMult" }, { label = "Enemy modifiers", modName = { "ChaosResist", "DamageTaken", "DotTaken", "ChaosDamageTaken" }, enemy = true }, }, },
...
{ 1, "Ignite", 1, "Ignite", data.colorCodes.OFFENCE, {	
	...
	{ label = "Effective DPS Mod", flag = "effective", { format = "x {2:output:IgniteEffMult}", { breakdown = "IgniteEffMult" }, { label = "Enemy modifiers", modName = { "FireResist", "ElementalResist", "DamageTaken", "DotTaken", "FireDamageTaken", "ElementalDamageTaken" }, enemy = true }, }, },
