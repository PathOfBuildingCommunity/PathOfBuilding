...
{ 3, "DamageTaken", 1, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "Damage Taken", data = {
	...
	{ label = "Number Hit Taken",
		{ format = "{2:output:PhysicalNumberOfHits}", 
			{ breakdown = "PhysicalNumberOfHits" }, 
		},
		{ format = "{2:output:LightningNumberOfHits}",
			{ breakdown = "LightningNumberOfHits" }, 
		},
		{ format = "{2:output:ColdNumberOfHits}",
			{ breakdown = "ColdNumberOfHits" }, 
		},
		{ format = "{2:output:FireNumberOfHits}", 
			{ breakdown = "FireNumberOfHits" }, 
		},
		{ format = "{2:output:ChaosNumberOfHits}",
			{ breakdown = "ChaosNumberOfHits" }, 
		},
	},
