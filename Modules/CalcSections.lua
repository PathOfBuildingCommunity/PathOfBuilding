...
{ 3, "HitDamage", 1, "Skill Hit Damage", data.colorCodes.OFFENCE, {
	...
	{ label = "Hit Damage", textSize = 12,
		...
		{ format = "{0:output:ColdMin} to {0:output:ColdMax}", { breakdown = "Cold" }, { label = "Conversions", modName = { "SkillColdDamageConvertToFire", "ColdDamageConvertToFire", "ColdDamageConvertToChaos", "ColdDamageGainAsFire", "ColdDamageGainAsChaos" }, modType = "BASE", skill = true }, },
