...
local specialModList = {
	...
	["damage from blocked hits cannot bypass energy shield"] = { flag("BlockedDamageDoesntBypassES") },
	["damage from unblocked hits always bypasses energy shield"] = { flag("UnblockedDamageDoesBypassES") },
