...
local modTagList = {
	...
	["w?i?t?[h ]?main hand"] = { tag = { type = "Condition", var = "MainHandAttack" } },
	["w?i?t?[h ]?off hand"] = { tag = { type = "Condition", var = "OffHandAttack" } },
	...
	["while wielding two different weapon types"] = { tag = { type = "Condition", var = "DualWieldingDifferentWeaponTypes" } },
