...
local modTagList = {
	...
	["if you[' ]h?a?ve hit with your main hand weapon recently"] = { tagList = { { type = "Condition", var = "HitRecentlyWithMainHandWeapon" } } },
	["if you[' ]h?a?ve hit with your off hand weapon recently"] = { tagList = { { type = "Condition", var = "HitRecentlyWithOffHandWeapon" } } },
