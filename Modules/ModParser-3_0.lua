...
local specialModList = {
	...
	-- Raider
	["nearby enemies have (%d+)%% less accuracy rating while you have phasing"] = function(num) return { mod("EnemyModifier", "LIST", { mod = mod("Accuracy", "LESS", num) }), { type = "Condition", var = "Phasing" } } end,
