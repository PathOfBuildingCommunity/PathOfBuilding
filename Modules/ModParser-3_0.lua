...
local modFlagList = {
	...
	["with maces or sceptres"] = { flags = ModFlag.Mace },
...
local preFlagList = {
	...
	["^axe attacks [hdf][aei][var][el] "] = { flags = ModFlag.Axe },
	["^claw attacks [hdf][aei][var][el] "] = { flags = ModFlag.Claw },
	["^dagger attacks [hdf][aei][var][el] "] = { flags = ModFlag.Dagger },
	["^mace or sceptre attacks [hdf][aei][var][el] "] = { flags = ModFlag.Mace },
	["^staff attacks [hdf][aei][var][el] "] = { flags = ModFlag.Staff },
	["^sword attacks [hdf][aei][var][el] "] = { flags = ModFlag.Sword },
	["^wand attacks [hdf][aei][var][el] "] = { flags = ModFlag.Wand },
	...
	["^attacks with melee weapons [hdf][aei][var][el] "] = { flags = ModFlag.WeaponMelee },
	["^attacks with one handed melee weapons [hdf][aei][var][el] "] = { flags = bor(ModFlag.Weapon1H, ModFlag.WeaponMelee) },
	["^attacks with one handed weapons [hdf][aei][var][el] "] = { flags = ModFlag.Weapon1H },
	["^attacks with two handed melee weapons [hdf][aei][var][el] "] = { flags = bor(ModFlag.Weapon2H, ModFlag.WeaponMelee) },
	["^attacks with two handed weapons [hdf][aei][var][el] "] = { flags = ModFlag.Weapon2H },
