...
local jewelThresholdFuncs = {
	...
	["With at least 40 Intelligence in Radius, Discharge Cooldown is 250 ms"] = getThreshold("Int", "ExtraSkillMod", "LIST", { mod = mod("SkillData", "LIST", { key = "cooldown", value = 0.25 }, { type = "SkillName", skillName = "Discharge" }) }),
