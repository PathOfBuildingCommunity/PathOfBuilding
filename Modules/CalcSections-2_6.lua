...
{ 1, "DamageTaken", 3, "Damage Taken", colorCodes.DEFENCE, {
	{ label = "Physical Hit/DoT", { format = "x {3:output:PhysicalTakenHitMult} / x {3:output:PhysicalTakenDotMult}", 
	...
	{ label = "Fire Hit/DoT", { format = "x {3:output:FireTakenHitMult} / x {3:output:FireTakenDotMult}",
	...
	{ label = "Cold Hit/DoT", { format = "x {3:output:ColdTakenHitMult} / x {3:output:ColdTakenDotMult}",
	...
	{ label = "Lightning Hit/DoT", { format = "x {3:output:LightningTakenHitMult} / x {3:output:LightningTakenDotMult}",
	...
	{ label = "Chaos Hit/DoT", { format = "x {3:output:ChaosTakenHitMult} / x {3:output:ChaosTakenDotMult}",
