...
{ 1, "Bleed", 1, "Bleed", colorCodes.OFFENCE, {
	...
	{ label = "PvP Bleed DPS", { format = "{1:output:PvpBleedDPS}", { breakdown = "PvpBleedDPS" }, { breakdown = "MainHand.PvpBleedDPS" }, { breakdown = "OffHand.PvpBleedDPS" }, }, },
...
{ 1, "Impale", 1, "Impale", colorCodes.OFFENCE, {
	...
	{ label = "PvP Impale DPS", flag = "PvpImpale", flag = "notAverage", { format = "{1:output:PvpImpaleDPS}", { breakdown = "PvpImpaleDPS" }, }, },
	{ label = "Impale Damage", flag = "impale", flag = "showAverage", { format = "{1:output:ImpaleDPS}", { breakdown = "ImpaleDPS" }, }, },
	{ label = "PvP Impale Damage", flag = "PvpImpale", flag = "showAverage", { format = "{1:output:PvpImpaleDPS}", { breakdown = "PvpImpaleDPS" }, }, },
} },
{ 1, "Poison", 1, "Poison", colorCodes.OFFENCE, {
	...
	{ label = "PvP Poison DPS", { format = "{1:output:PvpPoisonDPS}", 
	...
	{ label = "PvP Dmg. per Poison", { format = "{1:output:PvpPoisonDamage}", 
...
{ 1, "Ignite", 1, "Ignite", colorCodes.OFFENCE, {	
	...
	{ label = "PvP Ignite DPS", { format = "{1:output:PvpIgniteDPS}", 
	...
	{ label = "PvP Dmg. per Ignite", flag = "igniteCanStack", { format = "{1:output:PvpIgniteDamage}",
...
{ 1, "Decay", 1, "Decay", colorCodes.OFFENCE, {
	...
	{ label = "PvP Decay DPS", { format = "{1:output:PvpDecayDPS}", 
