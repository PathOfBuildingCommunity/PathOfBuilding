...
{ 3, "DamageTaken", 1, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "Damage Taken", data = {
	...
	{ label = "Hit taken",
		{ format = "x {2:output:SmaxTakenHitMult}", 
			{ breakdown = "SmaxTakenHitMult" }, 
		},
	...
	{ label = "Dot taken",
		{ format = "x {2:output:SmaxTakenDotMult}", 
			{ breakdown = "SmaxTakenDotMult" }, 
		},
	...
	colWidth = 95,
	{ label = "Melee Ch.",
		{ format = "{1:output:SminMeleeDamageChance}%", 
			{ breakdown = "SminMeleeDamageChance" }, 
		},
	...
	{ label = "Projectile Ch.",
		{ format = "{1:output:SminProjectileDamageChance}%", 
			{ breakdown = "SminProjectileDamageChance" }, 
		},
	...
	{ label = "Spell Ch.",
		{ format = "{1:output:SminSpellDamageChance}%", 
			{ breakdown = "SminSpellDamageChance" }, 
		},
	...
	{ label = "Spell Projectile Ch.",
		{ format = "{1:output:SminSpellProjectileDamageChance}%", 
			{ breakdown = "SminSpellProjectileDamageChance" }, 
		},
	...
	{ label = "Mind over Matter", haveOutput = "MindOverMatter",
		...
		{ format = "{0:output:MindOverMatter}", 
	...
	{ label = "Total pool",
		{ format = "{0:output:SminTotalPool}", 
			{ breakdown = "SminTotalPool" },			
		},
	...
	{ label = "Maximum Hit taken.",
		{ format = "{0:output:SminMaximumHitTaken}", 
			{ breakdown = "SminMaximumHitTaken" }, 
		},
	...
	{ label = "Effective DoT Pool",
		{ format = "{0:output:SminDotEHP}", 
			{ breakdown = "SminDotEHP" }, 
		},
	...
	{ label = "Effective Hit Pool",
		{ format = "{0:output:SminTotalEHP}", 
			{ breakdown = "SminTotalEHP" }, 
		},
