...
{ 3, "HitDamage", 1, "Skill Hit Damage", colorCodes.OFFENCE, {
	...
	{ label = "Skill PvP Average Hit", notFlag = "attack", { format = "{1:output:PvpAverageHit}", { breakdown = "PvpAverageHit" }, }, },
	...
	{ label = "MH PvP Average Hit", bgCol = colorCodes.MAINHANDBG, flag = "weapon1Attack", { format = "{1:output:MainHand.PvpAverageHit}", { breakdown = "MainHand.PvpAverageHit" }, }, },
	-- Off Hand Hit Damage
	...
	{ label = "OH PvP Average Hit", bgCol = colorCodes.OFFHANDBG, flag = "weapon2Attack", { format = "{1:output:OffHand.PvpAverageHit}", { breakdown = "OffHand.PvpAverageHit" }, }, },
	...
	{ label = "PvP Average Damage", flag = "attack", { format = "{1:output:PvpAverageDamage}", 
	...
	{ label = "Skill PvP DPS", flag = "notAverage", { format = "{1:output:PvpTotalDPS}", { breakdown = "PvpTotalDPS" }, }, },
