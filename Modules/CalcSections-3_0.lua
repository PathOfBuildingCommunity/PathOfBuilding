...
{ 1, "Poison", 1, "Poison", colorCodes.OFFENCE, {
	...
	{ label = "OH Source Physical", bgCol = colorCodes.OFFHANDBG, textSize = 12, flag = "weapon2Attack", haveOutput = "MainHand.PoisonPhysicalMax", { format = "{0:output:OffHand.PoisonPhysicalMin} - {0:output:OffHand.PoisonPhysicalMax}", { breakdown = "OffHand.PoisonPhysical" }, }, },
	...
	{ label = "MH Source Chaos", bgCol = colorCodes.MAINHANDBG, textSize = 12, flag = "weapon1Attack", haveOutput = "OffHand.PoisonChaosMax", { format = "{0:output:MainHand.PoisonChaosMin} - {0:output:MainHand.PoisonChaosMax}", { breakdown = "MainHand.PoisonChaos" }, }, },
...
{ 1, "Ignite", 1, "Ignite", colorCodes.OFFENCE, {	
	...
	{ label = "OH Source Fire", bgCol = colorCodes.OFFHANDBG, textSize = 12, flag = "weapon2Attack", haveOutput = "MainHand.IgniteFireMax", { format = "{0:output:OffHand.IgniteFireMin} - {0:output:OffHand.IgniteFireMax}", { breakdown = "OffHand.IgniteFire" }, }, },
	...
	{ label = "MH Source Cold", bgCol = colorCodes.MAINHANDBG, textSize = 12, flag = "weapon1Attack", haveOutput = "OffHand.IgniteColdMax", { format = "{0:output:MainHand.IgniteColdMin} - {0:output:MainHand.IgniteColdMax}", { breakdown = "MainHand.IgniteCold" }, }, },
