...
{ 3, "Warcries", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Offensive Warcries", data = {
	...
	colWidth = 142,
	{
		{ format = "Effective Impact = (1 + " },
		{ format = "Avg Exert Dmg Multi" },
		{ format = "x Uptime %)" },
		{ format = "Num Exerts" },
	},
	{ label = "Seismic Cry",
		{ format = "{2:output:SeismicHitEffect}" },
		{ format = "{2:output:SeismicAvgDmg}", { breakdown = "SeismicAvgDmg"}, { modName = "ExertIncrease", cfg = "skill" }, },
		{ format = "{2:output:SeismicUpTimeRatio}", { breakdown = "SeismicUpTimeRatio" }, },
		{ format = "{2:output:SeismicExertsCount}" },
	},
	{ label = "Intimidating Cry",
		{ format = "{2:output:IntimidatingHitEffect}" },
		{ format = "{2:output:IntimidatingAvgDmg}", { breakdown = "IntimidatingAvgDmg"}, { modName = "ExertIncrease", cfg = "skill" }, },
		{ format = "{2:output:IntimidatingUpTimeRatio}", { breakdown = "IntimidatingUpTimeRatio" }, },
		{ format = "{2:output:IntimidatingExertsCount}" },
	},
	{ label = "Rallying Cry",
		{ format = "{2:output:RallyingHitEffect}" },
		{ format = "{2:output:RallyingAvgDmg}", { breakdown = "RallyingAvgDmg"}, { modName = "ExertIncrease", cfg = "skill" }, },
		{ format = "{2:output:RallyingUpTimeRatio}", { breakdown = "RallyingUpTimeRatio" }, },
		{ format = "{2:output:RallyingExertsCount}" },
	},
} }
} },
