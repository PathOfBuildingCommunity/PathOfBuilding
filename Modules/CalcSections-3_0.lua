...
{ 3, "Warcry", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Offensive Warcries", data = {
	extra = "{2:output:OffensiveWarcryEffect}%",
	colWidth = 142,
	{
	...
	{ label = "Seismic Cry",
		{ format = "{2:output:SeismicHitEffect}", { modName = { "SeismicHitEffect" }, }, },
		{ format = "{2:output:SeismicExertsCount}", { modName = { "SeismicExertsCount" }, }, },
		{ format = "{2:output:SeismicAvgDmg}", { modName = { "SeismicAvgDmg" }, }, },
		{ format = "{2:output:SeismicUpTimeRatio}", { modName = { "SeismicUpTimeRatio" }, }, },
	},
	{ label = "Intimdiating Cry",
		{ format = "{2:output:IntimidatingHitEffect}", { modName = { "IntimidatingHitEffect" }, }, },
		{ format = "{2:output:IntimidatingExertsCount}", { modName = { "IntimidatingExertsCount" }, }, },
		{ format = "{2:output:IntimidatingAvgDmg}", { modName = { "IntimidatingAvgDmg" }, }, },
		{ format = "{2:output:IntimidatingUpTimeRatio}", { modName = { "IntimidatingUpTimeRatio" }, }, },
	},
	{ label = "Rallying Cry",
		{ format = "{2:output:RallyingHitEffect}", { modName = { "RallyingHitEffect" }, }, },
		{ format = "{2:output:RallyingExertsCount}", { modName = { "RallyingExertsCount" }, }, },
		{ format = "{2:output:RallyingAvgDmg}", { modName = { "RallyingAvgDmg" }, }, },
		{ format = "{2:output:RallyingUpTimeRatio}", { modName = { "RallyingUpTimeRatio" }, }, },
	},
} }
} },
