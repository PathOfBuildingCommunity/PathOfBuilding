...
{ 3, "Warcries", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Offensive Warcries", data = {
	extra = "Aggregated Dmg Multiplier: {2:output:OffensiveWarcryEffect}",
	colWidth = 142,
	{
	...
	{ label = "Intimidating Cry",
		...
		{ format = "{2:output:IntimidatingUpTimeRatio}" },
	},
	{ label = "Rallying Cry",
		{ format = "{2:output:RallyingHitEffect}" },
		{ format = "{2:output:RallyingExertsCount}" },
		{ format = "{2:output:RallyingAvgDmg}" },
		{ format = "{2:output:RallyingUpTimeRatio}" },
	},
} }
} },
