...
{ 3, "DamageTaken", 1, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "Damage Taken", data = {
	...
	{ label = "Melee Ch.",
		{ },
		{ format = "{2:output:PhysicalMeleeDamageChance}%", 
			{ breakdown = "PhysicalMeleeDamageChance" }, 
		},
		{ format = "{2:output:LightningMeleeDamageChance}%",
			{ breakdown = "LightningMeleeDamageChance" }, 
		},
		{ format = "{2:output:ColdMeleeDamageChance}%",
			{ breakdown = "ColdMeleeDamageChance" }, 
		},
		{ format = "{2:output:FireMeleeDamageChance}%", 
			{ breakdown = "FireMeleeDamageChance" }, 
		},
		{ format = "{2:output:ChaosMeleeDamageChance}%",
			{ breakdown = "ChaosMeleeDamageChance" }, 
		},
	},
	{ label = "Projectile Ch.",
		{ },
		{ format = "{2:output:PhysicalProjectileDamageChance}%", 
			{ breakdown = "PhysicalProjectileDamageChance" }, 
		},
		{ format = "{2:output:LightningProjectileDamageChance}%",
			{ breakdown = "LightningProjectileDamageChance" }, 
		},
		{ format = "{2:output:ColdProjectileDamageChance}%",
			{ breakdown = "ColdProjectileDamageChance" }, 
		},
		{ format = "{2:output:FireProjectileDamageChance}%", 
			{ breakdown = "FireProjectileDamageChance" }, 
		},
		{ format = "{2:output:ChaosProjectileDamageChance}%",
			{ breakdown = "ChaosProjectileDamageChance" }, 
		},
	},
	{ label = "Spell Ch.",
		{ },
		{ format = "{2:output:PhysicalSpellDamageChance}%", 
			{ breakdown = "PhysicalSpellDamageChance" }, 
		},
		{ format = "{2:output:LightningSpellDamageChance}%",
			{ breakdown = "LightningSpellDamageChance" }, 
		},
		{ format = "{2:output:ColdSpellDamageChance}%",
			{ breakdown = "ColdSpellDamageChance" }, 
		},
		{ format = "{2:output:FireSpellDamageChance}%", 
			{ breakdown = "FireSpellDamageChance" }, 
		},
		{ format = "{2:output:ChaosSpellDamageChance}%",
			{ breakdown = "ChaosSpellDamageChance" }, 
		},
	},
	{ label = "Spell Projectile Ch.",
		{ },
		{ format = "{2:output:PhysicalSpellProjectileDamageChance}%", 
			{ breakdown = "PhysicalSpellProjectileDamageChance" }, 
		},
		{ format = "{2:output:LightningSpellProjectileDamageChance}%",
			{ breakdown = "LightningSpellProjectileDamageChance" }, 
		},
		{ format = "{2:output:ColdSpellProjectileDamageChance}%",
			{ breakdown = "ColdSpellProjectileDamageChance" }, 
		},
		{ format = "{2:output:FireSpellProjectileDamageChance}%", 
			{ breakdown = "FireSpellProjectileDamageChance" }, 
		},
		{ format = "{2:output:ChaosSpellProjectileDamageChance}%",
