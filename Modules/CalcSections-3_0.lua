...
{ 1, "Resist", 3, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "Resists", data = {
	extra = colorCodes.FIRE.."{output:FireResist}{0:output:FireResistOverCap}^7/"..colorCodes.COLD.."{output:ColdResist}{0:output:ColdResistOverCap}^7/"..colorCodes.LIGHTNING.."{output:LightningResist}{0:output:LightningResistOverCap}",
	{ label = "Fire Resist", { format = "{output:FireResist}% ({0:output:FireResistOverCap}%)",
		{ breakdown = "FireResist" }, 
		{ modName = { "FireResistMax", "ElementalResistMax", "FireResist", "ElementalResist" }, },
	}, },
	{ label = "Cold Resist", { format = "{output:ColdResist}% ({0:output:ColdResistOverCap}%)", 
		{ breakdown = "ColdResist" },
		{ modName = { "ColdResistMax", "ElementalResistMax", "ColdResist", "ElementalResist" }, },
	}, },
	{ label = "Lightning Resist", { format = "{output:LightningResist}% ({0:output:LightningResistOverCap}%)",
		{ breakdown = "LightningResist" },
		{ modName = { "LightningResistMax", "ElementalResistMax", "LightningResist", "ElementalResist" }, },
	}, },
	{ label = "Chaos Resist", { format = "{output:ChaosResist}% ({0:output:ChaosResistOverCap}%)",
