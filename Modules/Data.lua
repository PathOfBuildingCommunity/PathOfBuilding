...
data.powerStatList = {
	...
	{ stat="PhysicalTotalEHP", label="Phys HP" },
	{ stat="LightningTotalEHP", label="Lightning HP" },
	{ stat="ColdTotalEHP", label="Cold HP" },
	{ stat="FireTotalEHP", label="Fire HP" },
	{ stat="ChaosTotalEHP", label="Chaos HP" },
