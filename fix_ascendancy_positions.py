...
NODE_GROUPS = {
	...
	"Trialmaster": Point2D(-6750, 12000),
	"Oshabi": Point2D(-5250, 12000),
	"KingInTheMists": Point2D(-3750, 12000),
	"Catarina": Point2D(-2250, 12000),
	"Aul": Point2D(-750, 12000),
	"Lycia": Point2D(750, 12000),
	"Olroth": Point2D(2250, 12000),
	"Farrul": Point2D(3750, 12000),
	"Delirious": Point2D(5250, 12000),
	"Breachlord": Point2D(6750, 12000),
}
EXTRA_NODES = {
