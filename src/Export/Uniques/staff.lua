...
ConvertPhysicalToColdUnique__3
...
{variant:2}StaffBlockPercentImplicitStaff1[18,18]
{variant:3}StaffBlockPercentImplicitStaff1
WeaponPhysicalDamagePerStrength
...
{variant:2,3}CannotBeShockedWhileChilledUnique__1
...
{variant:1,2}RemoteMineLayingSpeedUniqueStaff11
