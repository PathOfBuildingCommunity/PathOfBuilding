...
{variant:2}LifeGainedFromEnemyDeathUniqueDagger11[30,30]
...
PoisonDamageUnique__2
TriggeredSpellsPoisonOnHitUnique_1
AllDamageFromTriggeredSpellsCanPoisonUnique_1
]],
}
