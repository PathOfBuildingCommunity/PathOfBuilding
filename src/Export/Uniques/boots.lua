...
{variant:2}BleedingExpiresSlowerWhileMovingUnique__1
{variant:2}CannotBePoisonedWhileBleedingUnique__1
{variant:2}CannotBeStunnedWhileBleedingUnique__1
{variant:1}MovementVelocityWhileBleedingUnique__1[15,15]
{variant:2}MovementVelocityWhileBleedingUnique__1
...
LocalIncreasedPhysicalDamageReductionRatingPercentUnique__28
MovementVelocityUnique__52
StunRecoveryUnique__8
UnaffectedByDamagingAilmentsUnique__1
]],[[
Kaom's Roots
Titan Greaves
Variant: Pre 2.6.0
...
Variant: Pre 3.19.0
Variant: Current
LightningResistUnique__13
{variant:1}MovementVelocityUniqueBootsDex8
{variant:2}MovementVelocityUnique__21
{variant:1}ConvertPhysicaltoLightningUnique__2
{variant:1}ShockDurationUnique__2[50,50]
...
{variant:3}CurseAreaOfEffectUnique__3
]],[[
Windshriek
Reinforced Greaves
...
{variant:1,2}LifeRegenerationPerFrenzyChargeUniqueBootsDex4[60,60]
{variant:3}LifeRegenerationPerFrenzyChargeUniqueBootsDex4[30,30]
{variant:4}LifeRegenerationPerFrenzyChargeUniqueBootsDex4
FrenzyChargeOnKillChanceUniqueBootsDex4
{variant:1}EnemiesOnLowLifeTakeMoreDamagePerFrenzyChargeUniqueBootsDex4[3,3]
{variant:2,3}EnemiesOnLowLifeTakeMoreDamagePerFrenzyChargeUniqueBootsDex4[6,6]
...
{variant:1,2}DisplaySupportedByTrapUniqueBootsDex6[11,11]
...
{variant:1}ItemFoundQuantityIncreaseUniqueBootsDex2[20,30]
{variant:2}ItemFoundQuantityIncreaseUniqueBootsDex2[14,20]
{variant:3}ItemFoundRarityIncreaseUnique__10
]],[[
Garukhan's Flight
Stealth Boots
Variant: Pre 3.5.0
...
{variant:1}IncreasedEvasionWithOnslaughtUnique_1[40,40]
{variant:2,3}IncreasedEvasionWithOnslaughtUnique_1
...
{variant:3}MovementVelocityOnLowLifeUnique__1
{variant:1,2}PercentDamageGoesToManaUniqueBootsDex3
{variant:3}QuicksilverFlaskAppliesToAlliesUnique__1
...
{variant:1,2,3,4}SpellBlockPercentageUniqueBootsInt5[6,7]
{variant:5}SpellBlockPercentageUniqueBootsInt5[4,6]
{variant:6}SpellBlockPercentageUniqueBootsInt5
{variant:1,2}LocalIncreasedEnergyShieldPercentUniqueBootsInt5[150,200]
{variant:3,4,5}LocalIncreasedEnergyShieldPercentUniqueBootsInt5
{variant:1,2}IncreasedManaUniqueBootsInt5[80,100]
...
{variant:1,2,3}DexterityUniqueBootsInt3
{variant:1}IntelligenceUniqueBootsInt3[10,10]
{variant:2,3,4}IntelligenceUniqueBootsInt3
...
{variant:1,2}LocalIncreasedEnergyShieldPercentAndStunRecoveryUniqueBootsInt3[100,140][10,15]
{variant:3}LocalIncreasedEnergyShieldPercentAndStunRecoveryUniqueBootsInt3
{variant:2,3}MovementVelocityUniqueBootsDexInt2
{variant:1}MovementVelocityOnFullLifeUniqueBootsInt3[35,35]
{variant:2,3}MovementVelocityOnFullLifeUniqueBootsInt3
{variant:1}EnergyShieldRegenerationperMinuteWhileOnLowLifeTransformedUnique__1
{variant:2,3}EnergyShieldRegenerationUnique__1
]],[[
Skyforth
Sorcerer Boots
Energy Shield: 64
...
Variant: Pre 3.19.0
Variant: Current
{variant:1,2}StrengthUniqueBootsInt1[5,10]
{variant:3}StrengthUniqueBootsInt1
{variant:1,2}DexterityUniqueBootsInt1[5,10]
{variant:3}DexterityUniqueBootsInt1
{variant:1,2}IntelligenceUniqueBootsInt1[5,10]
{variant:3}IntelligenceUniqueBootsInt1
{variant:1,2}LocalIncreasedEnergyShieldPercentUniqueBootsInt1[10,16]
{variant:3}LocalIncreasedEnergyShieldPercentUniqueBootsInt1
ItemRarityOnLowLifeUniqueBootsInt1
{variant:1}MovementVelocityUniqueBootsInt1[15,15]
{variant:2}MovementVelocityUniqueBootsInt1[10,10]
...
{variant:1}LocalIncreasedArmourAndEvasionUnique__13
MovementVelocityUniqueBootsA1
{variant:2}IncreasedAilmentEffectOnEnemiesUnique_2
...
{variant:1}FrenzyChargeDurationUniqueBootsStrDex2[-50,-50]
{variant:2,3}FrenzyChargeDurationUniqueBootsStrDex2
LightRadiusUniqueBootsStrDex2
{variant:1,2}ChanceToDodgePerFrenzyChargeUniqueBootsStrDex2
]],[[
Dusktoe
...
Variant: Pre 3.19.0
Variant: Current
{variant:1,2,3}LocalIncreasedArmourAndEvasionUniqueBootsStrDex3[40,60]
{variant:4}LocalIncreasedArmourAndEvasionUniqueBootsStrDex3
{variant:1,2}IncreasedLifeUniqueBootsStrDex3[10,20]
{variant:3}IncreasedLifeUniqueBootsStrDex3
{variant:1,2}IncreasedManaUniqueBootsStrDex3
{variant:1,2,3}MovementVelocityUniqueBootsStrDex3[15,15]
{variant:4}MovementVelocityUniqueBootsStrDex3
{variant:1,2,3}StunRecoveryUniqueBootsStrDex3
...
IncreasedLifeUnique__68_
MovementVelocityUniqueBootsStrDex3
StunRecoveryUniqueBootsStrDex3
LightRadiusUniqueBootsStrDex3
ChaosResistanceWhileUsingFlaskUniqueBootsStrDex3
{variant:2}AddedChaosDamageWhileUsingAFlaskUnique__1_
]],[[
Legacy of Fury
Wyrmscale Boots
...
ScorchedEnemiesDegenExplodeUnique__1_
]],[[
...
{variant:2}FireDamageTakenFireTouchedUnique__1
GainAdrenalineFireTouchedGainUnique__1
...
AddedFireDamageUniqueBootsStrDex1
MovementVelocityUniqueBootsStrDex1
...
{variant:1}SpellAddedColdDamageUniqueBootsStrDex5[15,19][28,35]
{variant:2}SpellAddedColdDamageUniqueBootsStrDex5
{variant:1}SpellCriticalStrikeChanceUniqueBootsStrDex5[20,40]
{variant:2}SpellCriticalStrikeChanceUniqueBootsStrDex5
LocalIncreasedEvasionRatingPercentUniqueBootsStrDex5
ColdResistUniqueBootsStrDex5
{variant:1}MovementVelocityUniqueBootsStrDex5[20,20]
...
{variant:1}ChanceToIgniteUniqueBootsStrInt3[5,7]
{variant:2}ChanceToIgniteUniqueBootsStrInt3
{variant:1}IncreasedDamageToIgnitedTargetsUniqueBootsStrInt3[15,15]
...
League: Synthesis
Requires Level 58, 54 Str, 54 Int
{variant:1}LocalIncreaseSocketedAuraGemLevelUnique___1
...
ChaosResistUnique__7
{variant:3,4,5}MovementVelocityUnique__57
{variant:3,4,5}CorruptedBloodImmunityUnique_1
{variant:1,2,3}CountAsHavingMaxEnduranceChargesUnique__1
{variant:1,2,4}CountAsHavingMaxFrenzyChargesUnique__1
{variant:1,2,5}CountAsHavingMaxPowerChargesUnique__1
{variant:1}GainARandomChargePerSecondWhileStationaryUnique__1
{variant:1}Lose all Frenzy, Endurance, and Power Charges when you Move
]],[[
Wake of Destruction
Mesh Boots
Variant: Pre 2.6.0
...
{variant:2,3}MovementVelocityUniqueBootsStrInt2_[15,15]
...
{variant:1}LocalIncreasedEnergyShieldUniqueBootsDexInt4[60,80]
{variant:2}LocalIncreasedEnergyShieldUniqueBootsDexInt4[120,150]
...
{variant:3,4}MovementVelocityWithMagicAbyssJewelUnique__1
{variant:1,2}DamagePerAbyssJewelTypeUnique__1_
{variant:3,4}ReservationEfficiencyWithUniqueAbyssJewelUnique__1
]],[[
Corpsewalker
Carnal Boots
Variant: Pre 3.19.0
...
{variant:2}MovementVelocityPerNearbyCorpseUnique__1
]],[[
...
OnslaughtWhileNotOnLowManaUnique__1_
LoseManaPercentPerSecondUnique__1
]],[[
Fenumus' Spinnerets
Assassin's Boots
League: Bestiary
...
MovementVelocityWhileOnFullEnergyShieldUniqueBootsDex8
]],[[
The Stampede
Assassin's Boots
Requires Level 63, 62 Dex, 62 Int
...
FireResistUniqueBootsDexInt1
MovementVelocityUniqueBootsDexInt1
MovementVelocityWhileIgnitedUnique__2
IncreasedChanceToBeIgnitedUnique__1
LifeRegeneratedPerMinuteWhileIgnitedUnique__1
]],[[
Veruso's Ambition
Shackled Boots
League: Necropolis
