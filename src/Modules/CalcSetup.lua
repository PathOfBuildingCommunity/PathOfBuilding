...
function calcs.initEnv(build, mode, override, specEnv)
	...
	if not cachedPlayerDB then
		...
		modDB:NewMod("ActiveTrapLimit", "BASE", 15, "Base", nil, KeywordFlag.Trap)
		modDB:NewMod("ActiveMineLimit", "BASE", 15, "Base", nil, KeywordFlag.Mine)
		modDB:NewMod("ActiveBrandLimit", "BASE", 3, "Base", nil, KeywordFlag.Brand)
