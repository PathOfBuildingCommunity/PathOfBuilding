...
{ 1, "Bleed", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Bleed", data = {
	...
	{ label = "Aggravate Chance", { format = "{0:output:AggravateChance}%",
		{ breakdown = "MainHand.AggravateChance" },
		{ breakdown = "OffHand.AggravateChance" },
		{ breakdown = "AggravateChance" },
		{ modName = { "AggravateChance", "AggravateChanceOnCrit", "ExertAggravateChance", "BleedingYouInflictIsAggravated", "Condition:CannotAggravate" }, cfg = "skill" },
	}, },
