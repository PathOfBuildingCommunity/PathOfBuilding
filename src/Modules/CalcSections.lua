...
{ 1, "MiscDefences", 3, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "Other Defences", data = {
	...
	{ label = "Freeze Avoid Ch.", haveOutput = "FreezeAvoidChance", { format = "{0:output:FreezeAvoidChance}%", { modName = { "AvoidFreeze", "AvoidElementalAilments", "AvoidAilments" } }, }, },
	{ label = "Chill Avoid Ch.", haveOutput = "ChillAvoidChance", { format = "{0:output:ChillAvoidChance}%", { modName = { "AvoidChill", "AvoidElementalAilments", "AvoidAilments" } }, }, },
	{ label = "Ignite Avoid Ch.", haveOutput = "IgniteAvoidChance", { format = "{0:output:IgniteAvoidChance}%", { modName = { "AvoidIgnite", "AvoidElementalAilments", "AvoidAilments" } }, }, },
	{ label = "Sap Avoid Ch.", haveOutput = "SapAvoidChance", { format = "{0:output:SapAvoidChance}%", { modName = { "AvoidSap", "AvoidElementalAilments", "AvoidAilments" } }, }, },
	{ label = "Brittle Avoid Ch.", haveOutput = "BrittleAvoidChance", { format = "{0:output:BrittleAvoidChance}%", { modName = { "AvoidBrittle", "AvoidElementalAilments", "AvoidAilments" } }, }, },
	{ label = "Scorch Avoid Ch.", haveOutput = "ScorchAvoidChance", { format = "{0:output:ScorchAvoidChance}%", { modName = { "AvoidScorch", "AvoidElementalAilments", "AvoidAilments" } }, }, },
	...
	{ label = "Freeze Duration", { format = "{1:output:SelfFreezeDuration}%", { modName = { "SelfFreezeDuration", "SelfDebuffExpirationRate", "SelfFreezeDebuffExpirationRate", "SelfAilmentDuration", "SelfElementalAilmentDuration" },cfg = {skillGrantsDebuff = true}, }, }, },
	{ label = "Chill Duration", { format = "{1:output:SelfChillDuration}%", { modName = { "SelfChillDuration", "SelfDebuffExpirationRate", "SelfChillDebuffExpirationRate", "SelfAilmentDuration", "SelfElementalAilmentDuration" }, cfg = {skillGrantsDebuff = true}, }, }, },
	{ label = "Shock Duration", { format = "{1:output:SelfShockDuration}%", { modName = { "SelfShockDuration", "SelfDebuffExpirationRate", "SelfShockDebuffExpirationRate", "SelfAilmentDuration", "SelfElementalAilmentDuration" }, cfg = {skillGrantsDebuff = true}, }, }, },
	...
	{ label = "Sap Duration", { format = "{1:output:SelfSapDuration}%", { modName = { "SelfSapDuration", "SelfDebuffExpirationRate", "SelfSapDebuffExpirationRate", "SelfAilmentDuration", "SelfElementalAilmentDuration" }, cfg = {skillGrantsDebuff = true}, }, }, },
	{ label = "Brittle Duration", { format = "{1:output:SelfBrittleDuration}%", { modName = { "SelfBrittleDuration", "SelfDebuffExpirationRate", "SelfBrittleDebuffExpirationRate", "SelfAilmentDuration", "SelfElementalAilmentDuration" }, cfg = {skillGrantsDebuff = true}, }, }, },
	{ label = "Scorch Duration", { format = "{1:output:SelfScorchDuration}%", { modName = { "SelfScorchDuration", "SelfDebuffExpirationRate", "SelfScorchDebuffExpirationRate", "SelfAilmentDuration", "SelfElementalAilmentDuration" }, cfg = {skillGrantsDebuff = true}, }, }, },
...
{ 3, "DamageTaken", 1, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "Damage Taken", data = {
	...
	{ label = "Prevented Life Loss", haveOutput = "preventedLifeLoss",
		{ format = "{0:output:preventedLifeLoss}",
			{ breakdown = "preventedLifeLoss" },
			{ modName = { "LifeLossBelowHalfPrevented" } },
		},
	},
	...
	{ label = "Petrified Blood Max.", haveOutput = "preventedLifeLoss", { format = "{0:output:LifeLossBelowHalfLostMax}",
			{ breakdown = "LifeLossBelowHalfLostMax" },
			{ modName = { "LifeLossBelowHalfPrevented", "LifeLossBelowHalfLost" } },
		},
	},
	{ label = "Petrified Blood Avg.", haveOutput = "preventedLifeLoss", { format = "{0:output:LifeLossBelowHalfLostAvg}",
