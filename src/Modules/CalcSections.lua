...
{ 1, "SkillTypeStats", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Skill type-specific Stats", data = {
	...
	{ label = "Skill Duration", haveOutput = "BerserkDuration", { format = "{3:output:BerserkDuration}s", { breakdown = "BerserkDuration" }, { modName = { "RageRegen", "MaximumRage", "Multiplier:RageStack"} } }, },
