...
{ 1, "SkillTypeStats", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Skill type-specific Stats", data = {
	...
	{ label = "Skill Duration", flag = "duration", haveOutput = "Duration", { format = "{3:output:Duration}s", { breakdown = "Duration" },
		{ haveSkillCfgSetting = "haveDebuffDurationMult", modName = "EffectExpiresFaster", cfg = "skill", enemy = true }, 
		{ haveSkillCfgSetting = "haveBuffDurationMult", modName = "EffectExpiresFaster", cfg = "skill" },
	}, },
	{ label = "Secondary Duration", flag = "duration", haveOutput = "DurationSecondary", { format = "{3:output:DurationSecondary}s", { breakdown = "DurationSecondary" },
		{  haveOutput = "haveDebuffDurationMultSecondary", modName = "EffectExpiresFaster", cfg = "skill", enemy = true  }, 
		{  haveOutput = "haveBuffDurationMultSecondary", modName = "EffectExpiresFaster", cfg = "skill" },
	}, },
...
{ 1, "Poison", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Poison", data = {
	...
	{ label = "Poison Duration", { format = "{2:output:PoisonDuration}s", 
		...
		{ label = "Enemy modifiers", modName = { "SelfPoisonDuration", "SelfAilmentDuration", "SelfPoisonFaster" }, enemy = true , cfg = {skillGrantsDebuff = true}},
	}, },
...
{ 1, "Ignite", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Ignite", data = {	
	...
	{ label = "Chance to Ignite", { format = "{0:output:IgniteChancePerHit}%", 
		...
		{ label = "Enemy modifiers", modName = { "SelfIgniteChance", "EffectExpiresFaster" }, enemy = true , cfg = {skillGrantsDebuff = true}},
	}, },
...
{ 1, "EleAilments", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Non-Damaging Ailments", data = {
	...
	{ label = "Scorch Duration", bgCol = colorCodes.SCORCHBG, flag = "scorch", { format = "{2:output:ScorchDuration}s",
		...
		{ label = "Enemy modifiers", modName = { "SelfScorchDuration", "SelfAilmentDuration", "SelfElementalAilmentDuration", "BuffExpireFaster" }, enemy = true, cfg = {skillGrantsDebuff = true} },
	}, },
	...
	{ label = "Chill Duration", bgCol = colorCodes.CHILLBG, flag = "chill", { format = "{2:output:ChillDuration}s",
		...
		{ label = "Enemy modifiers", modName = { "SelfChillDuration", "SelfAilmentDuration", "SelfElementalAilmentDuration", "BuffExpireFaster" }, enemy = true, cfg = {skillGrantsDebuff = true} },
	}, },
	...
	{ label = "Brittle Duration", bgCol = colorCodes.BRITTLEBG, flag = "brittle", { format = "{2:output:BrittleDuration}s",
		...
		{ label = "Enemy modifiers", modName = { "SelfBrittleDuration", "SelfAilmentDuration", "SelfElementalAilmentDuration", "BuffExpireFaster" }, enemy = true, cfg = {skillGrantsDebuff = true} },
	}, },
	...
	{ label = "Shock Duration", bgCol = colorCodes.SHOCKBG, flag = "shock", { format = "{2:output:ShockDuration}s",
		...
		{ label = "Enemy modifiers", modName = { "SelfShockDuration", "SelfAilmentDuration", "SelfElementalAilmentDuration", "BuffExpireFaster" }, enemy = true, cfg = {skillGrantsDebuff = true} },
	}, },
	...
	{ label = "Sap Duration", bgCol = colorCodes.SAPBG, flag = "sap", { format = "{2:output:SapDuration}s",
		...
		{ label = "Enemy modifiers", modName = { "SelfSapDuration", "SelfAilmentDuration", "SelfElementalAilmentDuration", "BuffExpireFaster" }, enemy = true, cfg = {skillGrantsDebuff = true} },
	}, },
...
{ 1, "MiscDefences", 3, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "Other Defences", data = {
	...
	{ label = "Freeze Avoid Ch.", haveOutput = "FreezeAvoidChance", { format = "{0:output:FreezeAvoidChance}%", { modName = { "AvoidFreeze", "AvoidElementalAilments", "AvoidAilments", "AvoidShockAppliesToElementalAilments" } }, }, },
	{ label = "Chill Avoid Ch.", haveOutput = "ChillAvoidChance", { format = "{0:output:ChillAvoidChance}%", { modName = { "AvoidChill", "AvoidElementalAilments", "AvoidAilments", "AvoidShockAppliesToElementalAilments" } }, }, },
	{ label = "Ignite Avoid Ch.", haveOutput = "IgniteAvoidChance", { format = "{0:output:IgniteAvoidChance}%", { modName = { "AvoidIgnite", "AvoidElementalAilments", "AvoidAilments", "AvoidShockAppliesToElementalAilments" } }, }, },
	{ label = "Sap Avoid Ch.", haveOutput = "SapAvoidChance", { format = "{0:output:SapAvoidChance}%", { modName = { "AvoidSap", "AvoidElementalAilments", "AvoidAilments", "AvoidShockAppliesToElementalAilments" } }, }, },
	{ label = "Brittle Avoid Ch.", haveOutput = "BrittleAvoidChance", { format = "{0:output:BrittleAvoidChance}%", { modName = { "AvoidBrittle", "AvoidElementalAilments", "AvoidAilments", "AvoidShockAppliesToElementalAilments" } }, }, },
	{ label = "Scorch Avoid Ch.", haveOutput = "ScorchAvoidChance", { format = "{0:output:ScorchAvoidChance}%", { modName = { "AvoidScorch", "AvoidElementalAilments", "AvoidAilments", "AvoidShockAppliesToElementalAilments" } }, }, },
	{ label = "Bleed Avoid Ch.", haveOutput = "BleedAvoidChance", { format = "{0:output:BleedAvoidChance}%", { modName = { "AvoidBleed", "AvoidAilments" } }, }, },
	{ label = "Poison Avoid Ch.", haveOutput = "PoisonAvoidChance", { format = "{0:output:PoisonAvoidChance}%", { modName = { "AvoidPoison", "AvoidAilments" } }, }, },
	...
	{ label = "Freeze Duration", { format = "{1:output:SelfFreezeDuration}%", { modName = { "SelfFreezeDuration", "SelfDebuffExpirationRate", "SelfFreezeDebuffExpirationRate", "SelfAilmentDuration", "SelfElementalAilmentDuration", "SelfIgniteDurationToElementalAilments" }, cfg = {skillGrantsDebuff = true}, }, }, },
	{ label = "Chill Duration", { format = "{1:output:SelfChillDuration}%", { modName = { "SelfChillDuration", "SelfDebuffExpirationRate", "SelfChillDebuffExpirationRate", "SelfAilmentDuration", "SelfElementalAilmentDuration", "SelfIgniteDurationToElementalAilments" }, cfg = {skillGrantsDebuff = true}, }, }, },
	{ label = "Shock Duration", { format = "{1:output:SelfShockDuration}%", { modName = { "SelfShockDuration", "SelfDebuffExpirationRate", "SelfShockDebuffExpirationRate", "SelfAilmentDuration", "SelfElementalAilmentDuration", "SelfIgniteDurationToElementalAilments" }, cfg = {skillGrantsDebuff = true}, }, }, },
	{ label = "Ignite Duration", { format = "{1:output:SelfIgniteDuration}%", { modName = { "SelfIgniteDuration", "SelfDebuffExpirationRate", "SelfIgniteDebuffExpirationRate", "SelfAilmentDuration", "SelfElementalAilmentDuration" }, cfg = {skillGrantsDebuff = true}, }, }, },
	{ label = "Sap Duration", { format = "{1:output:SelfSapDuration}%", { modName = { "SelfSapDuration", "SelfDebuffExpirationRate", "SelfSapDebuffExpirationRate", "SelfAilmentDuration", "SelfElementalAilmentDuration", "SelfIgniteDurationToElementalAilments" }, cfg = {skillGrantsDebuff = true}, }, }, },
	{ label = "Brittle Duration", { format = "{1:output:SelfBrittleDuration}%", { modName = { "SelfBrittleDuration", "SelfDebuffExpirationRate", "SelfBrittleDebuffExpirationRate", "SelfAilmentDuration", "SelfElementalAilmentDuration", "SelfIgniteDurationToElementalAilments" }, cfg = {skillGrantsDebuff = true}, }, }, },
	{ label = "Scorch Duration", { format = "{1:output:SelfScorchDuration}%", { modName = { "SelfScorchDuration", "SelfDebuffExpirationRate", "SelfScorchDebuffExpirationRate", "SelfAilmentDuration", "SelfElementalAilmentDuration", "SelfIgniteDurationToElementalAilments" }, cfg = {skillGrantsDebuff = true}, }, }, },
	{ label = "Bleed Duration", { format = "{1:output:SelfBleedDuration}%", { modName = { "SelfBleedDuration", "SelfDebuffExpirationRate", "SelfBleedDebuffExpirationRate", "SelfAilmentDuration" }, cfg = {skillGrantsDebuff = true}, }, }, },
	{ label = "Poison Duration", { format = "{1:output:SelfPoisonDuration}%", { modName = { "SelfPoisonDuration", "SelfDebuffExpirationRate", "SelfPoisonDebuffExpirationRate", "SelfAilmentDuration" }, cfg = {skillGrantsDebuff = true}, }, }, },
	{ label = "Freeze Effect", { format = "{1:output:SelfFreezeEffect}%", { modName = "SelfFreezeEffect" }, cfg = {skillGrantsDebuff = true}, }, },
	{ label = "Chill Effect", { format = "{1:output:SelfChillEffect}%", { modName = "SelfChillEffect" }, cfg = {skillGrantsDebuff = true}, }, },
	{ label = "Shock Effect", { format = "{1:output:SelfShockEffect}%", { modName = "SelfShockEffect" }, cfg = {skillGrantsDebuff = true}, }, },
	{ label = "Ignite Effect", { format = "{1:output:SelfIgniteEffect}%", { modName = "SelfIgniteEffect" }, cfg = {skillGrantsDebuff = true}, }, },
	{ label = "Sap Effect", { format = "{1:output:SelfSapEffect}%", { modName = "SelfSapEffect" }, cfg = {skillGrantsDebuff = true}, }, },
	{ label = "Brittle Effect", { format = "{1:output:SelfBrittleEffect}%", { modName = "SelfBrittleEffect" }, cfg = {skillGrantsDebuff = true}, }, },
	{ label = "Scorch Effect", { format = "{1:output:SelfScorchEffect}%", { modName = "SelfScorchEffect" }, cfg = {skillGrantsDebuff = true}, }, },
	{ label = "Bleed Effect", { format = "{1:output:SelfBleedEffect}%", { modName = "SelfBleedEffect" }, cfg = {skillGrantsDebuff = true}, }, },
	{ label = "Poison Effect", { format = "{1:output:SelfPoisonEffect}%", { modName = "SelfPoisonEffect" }, cfg = {skillGrantsDebuff = true}, }, },
} }, { defaultCollapsed = false, label = "Dodge", data = {
	extra = "{0:output:AttackDodgeChance}%/{0:output:SpellDodgeChance}%",
	{ label = "Dodge Chance", { format = "{0:output:AttackDodgeChance}% (+{0:output:AttackDodgeChanceOverCap}%)",
		{ breakdown = "AttackDodgeChance" },
