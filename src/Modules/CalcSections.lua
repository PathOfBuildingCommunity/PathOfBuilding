...
{ 3, "DamageTaken", 1, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "Damage Taken", data = {
	...
	{ label = "Life Recoup Max.", haveOutput = "LifeRecoupRecoveryMax", { format = "{0:output:LifeRecoupRecoveryMax}",
			{ breakdown = "LifeRecoupRecoveryMax" },
		},
	},
	{ label = "Life Recoup Avg.", haveOutput = "LifeRecoupRecoveryAvg", { format = "{0:output:LifeRecoupRecoveryAvg}",
			{ breakdown = "LifeRecoupRecoveryAvg" },
		},
	},
	{ label = "Mana Recoup Max.", haveOutput = "ManaRecoupRecoveryMax", { format = "{0:output:ManaRecoupRecoveryMax}",
			{ breakdown = "ManaRecoupRecoveryMax" },
		},
	},
	{ label = "Mana Recoup Avg.", haveOutput = "ManaRecoupRecoveryAvg", { format = "{0:output:ManaRecoupRecoveryAvg}",
			{ breakdown = "ManaRecoupRecoveryAvg" },
		},
	},
	{ label = "ES Recoup Max.", haveOutput = "EnergyShieldRecoupRecoveryMax", { format = "{0:output:EnergyShieldRecoupRecoveryMax}",
			{ breakdown = "EnergyShieldRecoupRecoveryMax" },
		},
	},
	{ label = "ES Recoup Avg.", haveOutput = "EnergyShieldRecoupRecoveryAvg", { format = "{0:output:EnergyShieldRecoupRecoveryAvg}",
