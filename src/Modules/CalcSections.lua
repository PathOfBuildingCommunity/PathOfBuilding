...
{ 1, "EleAilments", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Non-Damaging Ailments", data = {
	...
	{ label = "Chill Duration", bgCol = colorCodes.CHILLBG, flag = "chill", flag = "chillHasDuration", { format = "{2:output:ChillDuration}s",
	...
	{ label = "Chill Duration", bgCol = colorCodes.CHILLBG, flag = "chill", notFlag = "chillHasDuration", { format = "x {2:output:ChillDurationMod}",
		{ breakdown = "MainHand.ChillDuration" },
		{ breakdown = "OffHand.ChillDuration" },
		{ breakdown = "ChillDuration" },
		{ label = "Player modifiers", modName = "EnemyChillDuration", cfg = "skill" },
	...
	{ label = "Freeze Duration", bgCol = colorCodes.FREEZEBG, flag = "freeze", flag = "freezeHasDuration", { format = "{2:output:FreezeDuration}s",
		...
		{ label = "Enemy modifiers", modName = { "SelfFreezeDuration", "BuffExpireFaster" }, enemy = true },
	}, },
	{ label = "Freeze Duration", bgCol = colorCodes.FREEZEBG, flag = "freeze", notFlag = "freezeHasDuration", { format = "x {2:output:FreezeDurationMod}",
		{ breakdown = "FreezeDurationMod" },
		{ breakdown = "MainHand.FreezeDPS" },
		{ breakdown = "OffHand.FreezeDPS" },
		{ breakdown = "FreezeDPS" },
