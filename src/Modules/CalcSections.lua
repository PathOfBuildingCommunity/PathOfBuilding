...
{ 1, "DisplaySpeed", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Attack/Cast Rate", data = {
	extra = "{2:output:DisplaySpeed}/s",
	...
	{ label = "Attacks per second", flag = "bothWeaponAttack", notFlag = "triggered", { format = "{2:output:DisplaySpeed}", { breakdown = "Speed" }, }, },
	...
	{ label = "Casts per second", flag = "spell", notFlag = "triggered", { format = "{2:output:DisplaySpeed}", { breakdown = "Speed" }, }, },
	...
	{ label = "Eff. Trigger Rate", flag = "triggered", notFlag = "dontDisplay", { format = "{2:output:DisplaySpeed}", { breakdown = "Speed" }, }, },
