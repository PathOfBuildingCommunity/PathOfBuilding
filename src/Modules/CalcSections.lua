...
{ 1, "SkillTypeStats", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Skill type-specific Stats", data = {
	...
	{ label = "Return Chance", haveOutput = "ReturnChanceString", { format = "{output:ReturnChanceString}", { breakdown = "ReturnChanceString" }, { modName = { "CannotReturn", "ReturnChance", "SecondaryReturnChance" }, cfg = "skill" }, }, },
