...
{ 3, "DamageTaken", 1, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "Damage Taken", data = {
	...
	{ label = "Prevented Life Loss", haveOutput = "AnyPreventedLifeLoss",
		{ format = "{0:output:PhysicalPreventedLifeLoss}",
			{ breakdown = "PhysicalPreventedLifeLoss" },
			{ modName = "LifeLossBelowHalfPrevented" },
		},
		{ format = "{0:output:LightningPreventedLifeLoss}",
			{ breakdown = "LightningPreventedLifeLoss" },
			{ modName = "LifeLossBelowHalfPrevented" },
		},
		{ format = "{0:output:ColdPreventedLifeLoss}",
			{ breakdown = "ColdPreventedLifeLoss" },
			{ modName = "LifeLossBelowHalfPrevented" },
		},
		{ format = "{0:output:FirePreventedLifeLoss}",
			{ breakdown = "FirePreventedLifeLoss" },
			{ modName = "LifeLossBelowHalfPrevented" },
		},
		{ format = "{0:output:ChaosPreventedLifeLoss}",
			{ breakdown = "ChaosPreventedLifeLoss" },
			{ modName = "LifeLossBelowHalfPrevented" },
		},
	},
