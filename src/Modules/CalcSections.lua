...
return {
{ 3, "HitDamage", 1, CC.CALC_SECTION_BORDER_OFFENCE, {{ defaultCollapsed = false, label = "Skill Hit Damage", data = {
	extra = "{output:DisplayDamage}",
	flag = "hit",
	colWidth = 95,
	{
		{ format = "All Types:" },
		{ format = c_format("{STAT_PHYS}Physical{TEXT_PRIMARY}:") },
		{ format = c_format("{STAT_LIGHTNING}Lightning{TEXT_PRIMARY}:") },
		{ format = c_format("{STAT_COLD}Cold{TEXT_PRIMARY}:") },
		{ format = c_format("{STAT_FIRE}Fire{TEXT_PRIMARY}:") },
		{ format = c_format("{STAT_CHAOS}Chaos{TEXT_PRIMARY}:") },
	},
	{ label = "Added Min",
		{ },
		{ format = "{0:mod:1,2}", 
	...
	{ label = "MH Total Increased", bgCol = CC.BUILD_MAINHANDBG, flag = "weapon1Attack",
	...
	{ label = "MH Total More", bgCol = CC.BUILD_MAINHANDBG, flag = "weapon1Attack",
	...
	{ label = "MH Eff. DPS Mod", bgCol = CC.BUILD_MAINHANDBG, flagList = {"weapon1Attack","effective"},
		{ },
	...
	{ label = "MH Hit Damage", bgCol = CC.BUILD_MAINHANDBG, textSize = 12, flag = "weapon1Attack",
	...
	{ label = "MH Average Hit", bgCol = CC.BUILD_MAINHANDBG, flag = "weapon1Attack", { format = "{1:output:MainHand.AverageHit}", { breakdown = "MainHand.AverageHit" }, }, },
	{ label = "MH PvP Average Hit", bgCol = CC.BUILD_MAINHANDBG, flag = "weapon1AttackPvP", { format = "{1:output:MainHand.PvpAverageHit}", { breakdown = "MainHand.PvpAverageHit" }, 
		{ label = "Tvalue Override (ms)", modName = "MultiplierPvpTvalueOverride" }, 
		{ label = "PvP Multiplier", cfg = "skill", modName = "PvpDamageMultiplier" }, 
	}, }, 
	-- Off Hand Hit Damage
	{ label = "OH Total Increased", bgCol = CC.BUILD_OFFHANDBG, flag = "weapon2Attack",
	...
	{ label = "OH Total More", bgCol = CC.BUILD_OFFHANDBG, flag = "weapon2Attack",
	...
	{ label = "OH Eff. DPS Mod", bgCol = CC.BUILD_OFFHANDBG, flagList = {"weapon2Attack","effective"},
		{ },
	...
	{ label = "OH Hit Damage", bgCol = CC.BUILD_OFFHANDBG, textSize = 12, flag = "weapon2Attack",
	...
	{ label = "OH Average Hit", bgCol = CC.BUILD_OFFHANDBG, flag = "weapon2Attack", { format = "{1:output:OffHand.AverageHit}", { breakdown = "OffHand.AverageHit" }, }, },
	{ label = "OH PvP Average Hit", bgCol = CC.BUILD_OFFHANDBG, flag = "weapon2AttackPvP", { format = "{1:output:OffHand.PvpAverageHit}", { breakdown = "OffHand.PvpAverageHit" }, 
		{ label = "Tvalue Override (ms)", modName = "MultiplierPvpTvalueOverride" }, 
		{ label = "PvP Multiplier", cfg = "skill", modName = "PvpDamageMultiplier" }, 
	}, },
...
{ 3, "Warcries", 1, CC.CALC_SECTION_BORDER_OFFENCE, {{ defaultCollapsed = false, label = "Exerting Warcries", data = {
	...
	{ label = "Exerted Attacks", bgCol = CC.BUILD_MAINHANDBG, haveOutput = "ExertedAttackUptimeRatio",
	...
	{ label = "Fist of War", bgCol = CC.BUILD_MAINHANDBG, haveOutput = "FistOfWarUptimeRatio",
...
{ 3, "Dot", 1, CC.CALC_SECTION_BORDER_OFFENCE, {{ defaultCollapsed = false, label = "Skill Damage over Time", data = {
...
{ 1, "Speed", 1, CC.CALC_SECTION_BORDER_OFFENCE, {{ defaultCollapsed = false, label = "Attack/Cast Rate", data = {
	extra = "{2:output:Speed}/s",
	{ label = "MH Inc. Att. Speed", bgCol = CC.BUILD_MAINHANDBG, flag = "weapon1Attack", notFlag = "triggered", { format = "{0:mod:1}%", { modName = "Speed", modType = "INC", cfg = "weapon1", }, }, },
	{ label = "MH More Att. Speed", bgCol = CC.BUILD_MAINHANDBG, flag = "weapon1Attack", notFlag = "triggered", { format = "{0:mod:1}%", { modName = "Speed", modType = "MORE", cfg = "weapon1", }, }, },
	{ label = "MH Att. per second", bgCol = CC.BUILD_MAINHANDBG, flag = "weapon1Attack", notFlag = "triggered", { format = "{2:output:MainHand.Speed}", { breakdown = "MainHand.Speed" }, }, },
	{ label = "OH Inc. Att. Speed", bgCol = CC.BUILD_OFFHANDBG, flag = "weapon2Attack", notFlag = "triggered", { format = "{0:mod:1}%", { modName = "Speed", modType = "INC", cfg = "weapon2", }, }, },
	{ label = "OH More Att. Speed", bgCol = CC.BUILD_OFFHANDBG, flag = "weapon2Attack", notFlag = "triggered", { format = "{0:mod:1}%", { modName = "Speed", modType = "MORE", cfg = "weapon2", }, }, },
	{ label = "OH Att. per second", bgCol = CC.BUILD_OFFHANDBG, flag = "weapon2Attack", notFlag = "triggered", { format = "{2:output:OffHand.Speed}", { breakdown = "OffHand.Speed" }, }, },
...
{ 1, "Crit", 1, CC.CALC_SECTION_BORDER_OFFENCE, {{ defaultCollapsed = false, label = "Crits", data = {
	...
	-- Main Hand
	{ label = "MH Inc. Crit Chance", bgCol = CC.BUILD_MAINHANDBG, flag = "weapon1Attack", { format = "{0:mod:1,2}%", 
		{ label = "Player modifiers", modName = "CritChance", modType = "INC", cfg = "weapon1" }, 
		{ label = "Enemy modifiers", modName = "SelfCritChance", modType = "INC", enemy = true }, 
	}, },
	{ label = "MH Crit Chance", bgCol = CC.BUILD_MAINHANDBG, flag = "weapon1Attack", { format = "{2:output:MainHand.CritChance}%", 
	...
	{ label = "MH Crit Multiplier", bgCol = CC.BUILD_MAINHANDBG, flag = "weapon1Attack", { format = "x {2:output:MainHand.CritMultiplier}", 
		{ breakdown = "MainHand.CritMultiplier" }, 
		{ label = "Player modifiers", modName = "CritMultiplier", cfg = "weapon1" }, 
		{ label = "Enemy modifiers", modName = "SelfCritMultiplier", enemy = true },
	}, },
	{ label = "MH Crit Effect Mod", bgCol = CC.BUILD_MAINHANDBG, flag = "weapon1Attack", { format = "x {3:output:MainHand.CritEffect}", { breakdown = "MainHand.CritEffect" }, }, },
	-- Off Hand
	{ label = "OH Inc. Crit Chance", bgCol = CC.BUILD_OFFHANDBG, flag = "weapon2Attack", { format = "{0:mod:1,2}%", 
		{ label = "Player modifiers", modName = "CritChance", modType = "INC", cfg = "weapon2" }, 
		{ label = "Enemy modifiers", modName = "SelfCritChance", modType = "INC", enemy = true }, 
	}, },
	{ label = "OH Crit Chance", bgCol = CC.BUILD_OFFHANDBG, flag = "weapon2Attack", { format = "{2:output:OffHand.CritChance}%", 
	...
	{ label = "OH Crit Multiplier", bgCol = CC.BUILD_OFFHANDBG, flag = "weapon2Attack", { format = "x {2:output:OffHand.CritMultiplier}", 
		{ breakdown = "OffHand.CritMultiplier" }, 
		{ label = "Player modifiers", modName = "CritMultiplier", cfg = "weapon2" }, 
		{ label = "Enemy modifiers", modName = "SelfCritMultiplier", enemy = true },
	}, },
	{ label = "OH Crit Effect Mod", bgCol = CC.BUILD_OFFHANDBG, flag = "weapon2Attack", { format = "x {3:output:OffHand.CritEffect}", { breakdown = "OffHand.CritEffect" }, }, },
} }
} },
{ 1, "Impale", 1, CC.CALC_SECTION_BORDER_OFFENCE, {{ defaultCollapsed = false, label = "Impale", data = {
    flag = "impale",
	...
	{ label = "Impale Chance", bgCol = CC.BUILD_MAINHANDBG, flag = "spell", haveOutput = "ImpaleChance", { format = "{0:output:ImpaleChance}%",
		{ flag = "impale", modName = "ImpaleChance", modType = "BASE", cfg = "skill" },
	}, },
	{ label = "Crit Impale Chance", bgCol = CC.BUILD_MAINHANDBG, flag = "spell", haveOutput = "ImpaleChanceOnCrit", { format = "{0:output:ImpaleChanceOnCrit}%",
		{ flag = "impale", modName = "ImpaleChanceOnCrit", modType = "BASE", cfg = "skill" },
	}, },
	{ label = "Stored Damage",  bgCol = CC.BUILD_MAINHANDBG, flag = "spell", haveOutput = "ImpaleStoredDamage", { format = "{1:output:ImpaleStoredDamage}%",
		{ breakdown = "ImpaleStoredDamage" },
		{ flag = "spell", modName = "ImpaleEffect", cfg = "skill" },
	}, },
	{ label = "Damage Mod.",  bgCol = CC.BUILD_MAINHANDBG, flag = "spell", haveOutput = "ImpaleModifier", { format = "{3:output:ImpaleModifier}",
		{ breakdown = "ImpaleModifier" },
	} },
	{ label = "MH Impale Chance", bgCol = CC.BUILD_MAINHANDBG, flag = "weapon1Attack", haveOutput = "MainHand.ImpaleChance", { format = "{0:output:MainHand.ImpaleChance}%",
		{ flag = "weapon1Attack", modName = "ImpaleChance", modType = "BASE", cfg = "weapon1" },
	}, },
	{ label = "MH Stored Damage",  bgCol = CC.BUILD_MAINHANDBG, flag = "weapon1Attack", haveOutput = "MainHand.ImpaleStoredDamage", { format = "{1:output:MainHand.ImpaleStoredDamage}%",
		{ breakdown = "MainHand.ImpaleStoredDamage" },
		{ flag = "weapon1Attack", modName = "ImpaleEffect", cfg = "weapon1" },
	}, },
	{ label = "MH DMG Mod.",  bgCol = CC.BUILD_MAINHANDBG, flag = "weapon1Attack", haveOutput = "MainHand.ImpaleModifier", { format = "{3:output:MainHand.ImpaleModifier}",
		{ breakdown = "MainHand.ImpaleModifier" },
	} },
	{ label = "OH Impale Chance", bgCol = CC.BUILD_OFFHANDBG, flag = "weapon2Attack", haveOutput = "OffHand.ImpaleChance", { format = "{0:output:OffHand.ImpaleChance}%",
		{ flag = "weapon2Attack", modName = "ImpaleChance", modType = "BASE", cfg = "weapon2" },
	}, },
	{ label = "OH Stored Damage",  bgCol = CC.BUILD_OFFHANDBG, flag = "weapon2Attack", haveOutput = "OffHand.ImpaleStoredDamage", { format = "{1:output:OffHand.ImpaleStoredDamage}%",
		{ breakdown = "OffHand.ImpaleStoredDamage" },
		{ flag = "weapon2Attack", modName = "ImpaleEffect", cfg = "weapon2" },
	}, },
	{ label = "OH DMG Mod.", bgCol = CC.BUILD_OFFHANDBG, flag = "weapon2Attack", haveOutput = "OffHand.ImpaleModifier", { format = "{3:output:OffHand.ImpaleModifier}", modType = "MORE",
...
{ 1, "SkillTypeStats", 1, CC.CALC_SECTION_BORDER_OFFENCE, {{ defaultCollapsed = false, label = "Skill type-specific Stats", data = {
	{ label = "Mana Cost", color = CC.STAT_MANA, haveOutput = "ManaHasCost", { format = "{0:output:ManaCost}", { breakdown = "ManaCost" }, { modName = { "ManaCost", "Cost" }, cfg = "skill" }, }, },
	{ label = "Mana % Cost", color = CC.STAT_MANA, haveOutput = "ManaPercentHasCost", { format = "{0:output:ManaPercentCost}", { breakdown = "ManaPercentCost" }, { modName = { "ManaCost", "Cost" }, cfg = "skill" }, }, },
	{ label = "Mana per second", color = CC.STAT_MANA, haveOutput = "ManaPerSecondHasCost", { format = "{2:output:ManaPerSecondCost}", { breakdown = "ManaPerSecondCost" }, { modName = { "ManaCost", "Cost" }, cfg = "skill" }, }, },
	{ label = "Mana % per second", color = CC.STAT_MANA, haveOutput = "ManaPercentPerSecondHasCost", { format = "{2:output:ManaPercentPerSecondCost}", { breakdown = "ManaPercentPerSecondCost" }, { modName = { "ManaCost", "Cost" }, cfg = "skill" }, }, },
	{ label = "Life Cost", color = CC.STAT_LIFE, haveOutput = "LifeHasCost", { format = "{0:output:LifeCost}", { breakdown = "LifeCost" }, { modName = { "LifeCost", "Cost" }, cfg = "skill" }, }, },
	{ label = "Life % Cost", color = CC.STAT_LIFE, haveOutput = "LifePercentHasCost", { format = "{0:output:LifePercentCost}", { breakdown = "LifePercentCost" }, { modName = { "LifeCost", "Cost" }, cfg = "skill" }, }, },
	{ label = "Life per second", color = CC.STAT_LIFE, haveOutput = "LifePerSecondHasCost", { format = "{2:output:LifePerSecondCost}", { breakdown = "LifePerSecondCost" }, { modName = { "LifeCost", "Cost" }, cfg = "skill" }, }, },
	{ label = "Life % per second", color = CC.STAT_LIFE, haveOutput = "LifePercentPerSecondHasCost", { format = "{2:output:LifePercentPerSecondCost}", { breakdown = "LifePercentPerSecondCost" }, { modName = { "LifeCost", "Cost" }, cfg = "skill" }, }, },
	{ label = "ES Cost", color = CC.STAT_ES, haveOutput = "ESHasCost", { format = "{0:output:ESCost}", { breakdown = "ESCost" }, { modName = { "ESCost", "Cost" }, cfg = "skill" }, }, },
	{ label = "ES per second", color = CC.STAT_ES, haveOutput = "ESPerSecondHasCost", { format = "{2:output:ESPerSecondCost}", { breakdown = "ESPerSecondCost" }, { modName = { "ESCost", "Cost" }, cfg = "skill" }, }, },
	{ label = "ES % per second", color = CC.STAT_ES, haveOutput = "ESPercentPerSecondHasCost", { format = "{2:output:ESPercentPerSecondCost}", { breakdown = "ESPercentPerSecondCost" }, { modName = { "ESCost", "Cost" }, cfg = "skill" }, }, },
	{ label = "Rage Cost", color = CC.STAT_RAGE, haveOutput = "RageHasCost", { format = "{0:output:RageCost}", { breakdown = "RageCost" }, { modName = { "RageCost", "Cost" }, cfg = "skill" }, }, },
	{ label = "Rage per second", color = CC.STAT_RAGE, haveOutput = "RagePerSecondHasCost", { format = "{2:output:RagePerSecondCost}", { breakdown = "RagePerSecondCost" }, { modName = { "RageCost", "Cost" }, cfg = "skill" }, }, },
	{ label = "Soul Cost", color = CC.STAT_RAGE, haveOutput = "SoulHasCost", { format = "{0:output:SoulCost}", { breakdown = "SoulCost" }, { modName = { "SoulCost" }, cfg = "skill" }, }, },
...
{ 1, "HitChance", 1, CC.CALC_SECTION_BORDER_OFFENCE, {{ defaultCollapsed = false, label = "Accuracy", data = {
	extra = "{0:output:HitChance}%",
	flag = "attack",
	{ label = "MH Accuracy", bgCol = CC.BUILD_MAINHANDBG, flag = "weapon1Attack", { format = "{0:output:MainHand.Accuracy}", 
		{ breakdown = "MainHand.Accuracy" }, 
		{ modName = "Accuracy", cfg = "weapon1" }, 
	}, },
	{ label = "MH Chance to Hit", bgCol = CC.BUILD_MAINHANDBG, flag = "weapon1Attack", { format = "{0:output:MainHand.AccuracyHitChance}%",
	...
	{ label = "MH Chance to Hit", haveOutput = "MainHand.enemyBlockChance", bgCol = CC.BUILD_MAINHANDBG, flag = "weapon1Attack", { format = "{0:output:MainHand.HitChance}%",
	...
	{ label = "OH Accuracy", bgCol = CC.BUILD_OFFHANDBG, flag = "weapon2Attack", { format = "{0:output:OffHand.Accuracy}",
		{ breakdown = "OffHand.Accuracy" }, 
		{ modName = "Accuracy", cfg = "weapon2" },
	}, },
	{ label = "OH Chance to Hit", bgCol = CC.BUILD_OFFHANDBG, flag = "weapon2Attack", { format = "{0:output:OffHand.AccuracyHitChance}%",
		{ breakdown = "OffHand.AccuracyHitChance" },
		{ label = "Enemy Evasion modifiers", modName = { "Evasion", "CannotEvade" }, enemy = true },
		{ label = "Player modifiers", modName = { "HitChance", "CannotBeEvaded", "IgnoreBlindHitChance" } },
	}, },
	{ label = "OH Chance to Hit", haveOutput = "OffHand.enemyBlockChance", bgCol = CC.BUILD_OFFHANDBG, flag = "weapon2Attack", { format = "{0:output:OffHand.HitChance}%",
...
{ 1, "Bleed", 1, CC.CALC_SECTION_BORDER_OFFENCE, {{ defaultCollapsed = false, label = "Bleed", data = {
	...
	{ label = "MH Eff. DoT Multi", bgCol = CC.BUILD_MAINHANDBG, flag = "weapon1Attack", haveOutput = "MainHand.BleedDotMulti", { format = "x {2:output:MainHand.BleedDotMulti}", { breakdown = "MainHand.BleedDotMulti" }, { modName = { "DotMultiplier", "PhysicalDotMultiplier" }, modType = "BASE", cfg = "bleed" }, }, },
	{ label = "OH Eff. DoT Multi", bgCol = CC.BUILD_OFFHANDBG, flag = "weapon2Attack", haveOutput = "OffHand.BleedDotMulti", { format = "x {2:output:OffHand.BleedDotMulti}", { breakdown = "OffHand.BleedDotMulti" }, { modName = { "DotMultiplier", "PhysicalDotMultiplier" }, modType = "BASE", cfg = "OHbleed" }, }, },
	{ label = "MH Source Physical", bgCol = CC.BUILD_MAINHANDBG, textSize = 12, flag = "weapon1Attack", { format = "{0:output:MainHand.BleedPhysicalMin} to {0:output:MainHand.BleedPhysicalMax}", { breakdown = "MainHand.BleedPhysical" }, }, },
	{ label = "OH Source Physical", bgCol = CC.BUILD_OFFHANDBG, textSize = 12, flag = "weapon2Attack", { format = "{0:output:OffHand.BleedPhysicalMin} to {0:output:OffHand.BleedPhysicalMax}", { breakdown = "OffHand.BleedPhysical" }, }, },
...
{ 1, "Poison", 1, CC.CALC_SECTION_BORDER_OFFENCE, {{ defaultCollapsed = false, label = "Poison", data = {
	...
	{ label = "MH Eff. DoT Multi", bgCol = CC.BUILD_MAINHANDBG, flag = "weapon1Attack", haveOutput = "MainHand.PoisonDotMulti", { format = "x {2:output:MainHand.PoisonDotMulti}", { breakdown = "MainHand.PoisonDotMulti" }, { modName = { "DotMultiplier", "ChaosDotMultiplier" }, modType = "BASE", cfg = "poison" }, }, },
	{ label = "OH Eff. DoT Multi", bgCol = CC.BUILD_OFFHANDBG, flag = "weapon2Attack", haveOutput = "OffHand.PoisonDotMulti", { format = "x {2:output:OffHand.PoisonDotMulti}", { breakdown = "OffHand.PoisonDotMulti" }, { modName = { "DotMultiplier", "ChaosDotMultiplier" }, modType = "BASE", cfg = "OHpoison" }, }, },
	...
	{ label = "MH Source Physical", bgCol = CC.BUILD_MAINHANDBG, textSize = 12, flag = "weapon1Attack", haveOutput = "MainHand.PoisonPhysicalMax", { format = "{0:output:MainHand.PoisonPhysicalMin} to {0:output:MainHand.PoisonPhysicalMax}", { breakdown = "MainHand.PoisonPhysical" }, }, },
	{ label = "OH Source Physical", bgCol = CC.BUILD_OFFHANDBG, textSize = 12, flag = "weapon2Attack", haveOutput = "OffHand.PoisonPhysicalMax", { format = "{0:output:OffHand.PoisonPhysicalMin} to {0:output:OffHand.PoisonPhysicalMax}", { breakdown = "OffHand.PoisonPhysical" }, }, },
	...
	{ label = "MH Source Lightning", bgCol = CC.BUILD_MAINHANDBG, textSize = 12, flag = "weapon1Attack", haveOutput = "MainHand.PoisonLightningMax", { format = "{0:output:MainHand.PoisonLightningMin} to {0:output:MainHand.PoisonLightningMax}", { breakdown = "MainHand.PoisonLightning" }, }, },
	{ label = "OH Source Lightning", bgCol = CC.BUILD_OFFHANDBG, textSize = 12, flag = "weapon2Attack", haveOutput = "OffHand.PoisonLightningMax", { format = "{0:output:OffHand.PoisonLightningMin} to {0:output:OffHand.PoisonLightningMax}", { breakdown = "OffHand.PoisonLightning" }, }, },
	...
	{ label = "MH Source Cold", bgCol = CC.BUILD_MAINHANDBG, textSize = 12, flag = "weapon1Attack", haveOutput = "MainHand.PoisonColdMax", { format = "{0:output:MainHand.PoisonColdMin} to {0:output:MainHand.PoisonColdMax}", { breakdown = "MainHand.PoisonCold" }, }, },
	{ label = "OH Source Cold", bgCol = CC.BUILD_OFFHANDBG, textSize = 12, flag = "weapon2Attack", haveOutput = "OffHand.PoisonColdMax", { format = "{0:output:OffHand.PoisonColdMin} to {0:output:OffHand.PoisonColdMax}", { breakdown = "OffHand.PoisonCold" }, }, },
	...
	{ label = "MH Source Fire", bgCol = CC.BUILD_MAINHANDBG, textSize = 12, flag = "weapon1Attack", haveOutput = "MainHand.PoisonFireMax", { format = "{0:output:MainHand.PoisonFireMin} to {0:output:MainHand.PoisonFireMax}", { breakdown = "MainHand.PoisonFire" }, }, },
	{ label = "OH Source Fire", bgCol = CC.BUILD_OFFHANDBG, textSize = 12, flag = "weapon2Attack", haveOutput = "OffHand.PoisonFireMax", { format = "{0:output:OffHand.PoisonFireMin} to {0:output:OffHand.PoisonFireMax}", { breakdown = "OffHand.PoisonFire" }, }, },
	...
	{ label = "MH Source Chaos", bgCol = CC.BUILD_MAINHANDBG, textSize = 12, flag = "weapon1Attack", haveOutput = "MainHand.PoisonChaosMax", { format = "{0:output:MainHand.PoisonChaosMin} to {0:output:MainHand.PoisonChaosMax}", { breakdown = "MainHand.PoisonChaos" }, }, },
	{ label = "OH Source Chaos", bgCol = CC.BUILD_OFFHANDBG, textSize = 12, flag = "weapon2Attack", haveOutput = "OffHand.PoisonChaosMax", { format = "{0:output:OffHand.PoisonChaosMin} to {0:output:OffHand.PoisonChaosMax}", { breakdown = "OffHand.PoisonChaos" }, }, },
...
{ 1, "Ignite", 1, CC.CALC_SECTION_BORDER_OFFENCE, {{ defaultCollapsed = false, label = "Ignite", data = {	
	...
	{ label = "MH Eff. DoT Multi", bgCol = CC.BUILD_MAINHANDBG, flag = "weapon1Attack", haveOutput = "MainHand.IgniteDotMulti", { format = "x {2:output:MainHand.IgniteDotMulti}", { breakdown = "MainHand.IgniteDotMulti" }, { modName = { "DotMultiplier", "FireDotMultiplier" }, modType = "BASE", cfg = "ignite" }, }, },
	{ label = "OH Eff. DoT Multi", bgCol = CC.BUILD_OFFHANDBG, flag = "weapon2Attack", haveOutput = "OffHand.IgniteDotMulti", { format = "x {2:output:OffHand.IgniteDotMulti}", { breakdown = "OffHand.IgniteDotMulti" }, { modName = { "DotMultiplier", "FireDotMultiplier" }, modType = "BASE", cfg = "OHignite" }, }, },
	...
	{ label = "MH Source Physical", bgCol = CC.BUILD_MAINHANDBG, textSize = 12, flag = "weapon1Attack", haveOutput = "MainHand.IgnitePhysicalMax", { format = "{0:output:MainHand.IgnitePhysicalMin} to {0:output:MainHand.IgnitePhysicalMax}", { breakdown = "MainHand.IgnitePhysical" }, }, },
	{ label = "OH Source Physical", bgCol = CC.BUILD_OFFHANDBG, textSize = 12, flag = "weapon2Attack", haveOutput = "OffHand.IgnitePhysicalMax", { format = "{0:output:OffHand.IgnitePhysicalMin} to {0:output:OffHand.IgnitePhysicalMax}", { breakdown = "OffHand.IgnitePhysical" }, }, },
	...
	{ label = "MH Source Lightning", bgCol = CC.BUILD_MAINHANDBG, textSize = 12, flag = "weapon1Attack", haveOutput = "MainHand.IgniteLightningMax", { format = "{0:output:MainHand.IgniteLightningMin} to {0:output:MainHand.IgniteLightningMax}", { breakdown = "MainHand.IgniteLightning" }, }, },
	{ label = "OH Source Lightning", bgCol = CC.BUILD_OFFHANDBG, textSize = 12, flag = "weapon2Attack", haveOutput = "OffHand.IgniteLightningMax", { format = "{0:output:OffHand.IgniteLightningMin} to {0:output:OffHand.IgniteLightningMax}", { breakdown = "OffHand.IgniteLightning" }, }, },
	...
	{ label = "MH Source Cold", bgCol = CC.BUILD_MAINHANDBG, textSize = 12, flag = "weapon1Attack", haveOutput = "MainHand.IgniteColdMax", { format = "{0:output:MainHand.IgniteColdMin} to {0:output:MainHand.IgniteColdMax}", { breakdown = "MainHand.IgniteCold" }, }, },
	{ label = "OH Source Cold", bgCol = CC.BUILD_OFFHANDBG, textSize = 12, flag = "weapon2Attack", haveOutput = "OffHand.IgniteColdMax", { format = "{0:output:OffHand.IgniteColdMin} to {0:output:OffHand.IgniteColdMax}", { breakdown = "OffHand.IgniteCold" }, }, },
	...
	{ label = "MH Source Fire", bgCol = CC.BUILD_MAINHANDBG, textSize = 12, flag = "weapon1Attack", haveOutput = "MainHand.IgniteFireMax", { format = "{0:output:MainHand.IgniteFireMin} to {0:output:MainHand.IgniteFireMax}", { breakdown = "MainHand.IgniteFire" }, }, },
	{ label = "OH Source Fire", bgCol = CC.BUILD_OFFHANDBG, textSize = 12, flag = "weapon2Attack", haveOutput = "OffHand.IgniteFireMax", { format = "{0:output:OffHand.IgniteFireMin} to {0:output:OffHand.IgniteFireMax}", { breakdown = "OffHand.IgniteFire" }, }, },
	...
	{ label = "MH Source Chaos", bgCol = CC.BUILD_MAINHANDBG, textSize = 12, flag = "weapon1Attack", haveOutput = "MainHand.IgniteChaosMax", { format = "{0:output:MainHand.IgniteChaosMin} to {0:output:MainHand.IgniteChaosMax}", { breakdown = "MainHand.IgniteChaos" }, }, },
	{ label = "OH Source Chaos", bgCol = CC.BUILD_OFFHANDBG, textSize = 12, flag = "weapon2Attack", haveOutput = "OffHand.IgniteChaosMax", { format = "{0:output:OffHand.IgniteChaosMin} to {0:output:OffHand.IgniteChaosMax}", { breakdown = "OffHand.IgniteChaos" }, }, },
...
{ 1, "Decay", 1, CC.CALC_SECTION_BORDER_OFFENCE, {{ defaultCollapsed = false, label = "Decay", data = {
...
{ 1, "LeechGain", 1, CC.CALC_SECTION_BORDER_OFFENCE, {{ defaultCollapsed = false, label = "Leech & Gain on Hit", data = {
...
{ 1, "EleAilments", 1, CC.CALC_SECTION_BORDER_OFFENCE, {{ defaultCollapsed = false, label = "Non-Damaging Ailments", data = {
	{ label = "Scorch Effect Mod", bgCol = CC.SCORCHBG, flag = "scorch", { format = "x {2:output:ScorchEffectMod}",
	...
	{ label = "Chance to Scorch", bgCol = CC.SCORCHBG, flag = "scorch", { format = "{0:output:ScorchChance}%",
	...
	{ label = "Scorch Duration", bgCol = CC.SCORCHBG, flag = "scorch", { format = "{2:output:ScorchDuration}s",
	...
	{ label = "Maximum Scorch", bgCol = CC.SCORCHBG, flag = "scorch", { format = "{0:output:MaximumScorch}%",
		{ modName = "ScorchMax" },
	}, },
	{ label = "Current Scorch", bgCol = CC.SCORCHBG, haveOutput = "CurrentScorch", { format = "{0:output:CurrentScorch}%",
	...
	{ label = "Effect of Chill", bgCol = CC.CHILLBG, flag = "chill", haveOutput = "ChillSourceEffect", { format = "{0:output:ChillSourceEffect}%", { breakdown = "DotChill" }, }, },
	{ label = "Chill Effect Mod", bgCol = CC.CHILLBG, flag = "chill", { format = "x {2:output:ChillEffectMod}",
	...
	{ label = "Chill Duration", bgCol = CC.CHILLBG, flag = "chill", { format = "{2:output:ChillDuration}s",
	...
	{ label = "Maximum Chill", bgCol = CC.CHILLBG, flag = "chill", { format = "{0:output:MaximumChill}%",
		{ modName = "ChillMax" },
	}, },
	{ label = "Current Chill", bgCol = CC.CHILLBG, haveOutput = "CurrentChill", { format = "{0:output:CurrentChill}%",
	...
	{ label = "Chance to Freeze", bgCol = CC.FREEZEBG, flag = "freeze", { format = "{0:output:FreezeChance}%",
	...
	{ label = "Freeze Duration", bgCol = CC.FREEZEBG, flag = "freeze", { format = "x {2:output:FreezeDurationMod}",
	...
	{ label = "Brittle Effect Mod", bgCol = CC.BRITTLEBG, flag = "brittle", { format = "x {2:output:BrittleEffectMod}",
	...
	{ label = "Chance to Brittle", bgCol = CC.BRITTLEBG, flag = "brittle", { format = "{0:output:BrittleChance}%",
	...
	{ label = "Brittle Duration", bgCol = CC.BRITTLEBG, flag = "brittle", { format = "{2:output:BrittleDuration}s",
	...
	{ label = "Maximum Brittle", bgCol = CC.BRITTLEBG, flag = "brittle", { format = "{0:output:MaximumBrittle}%",
		{ modName = "BrittleMax" },
	}, },
	{ label = "Current Brittle", bgCol = CC.BRITTLEBG, haveOutput = "CurrentBrittle", { format = "{0:output:CurrentBrittle}%",
	...
	{ label = "Shock Effect Mod", bgCol = CC.SHOCKBG, flag = "shock", { format = "x {2:output:ShockEffectMod}",
	...
	{ label = "Chance to Shock", bgCol = CC.SHOCKBG, flag = "shock", { format = "{0:output:ShockChance}%",
	...
	{ label = "Shock Duration", bgCol = CC.SHOCKBG, flag = "shock", { format = "{2:output:ShockDuration}s",
	...
	{ label = "Maximum Shock", bgCol = CC.SHOCKBG, flag = "shock", { format = "{0:output:MaximumShock}%",
		{ modName = "ShockMax" },
	}, },
	{ label = "Current Shock", bgCol = CC.SHOCKBG, haveOutput = "CurrentShock", { format = "{0:output:CurrentShock}%",
	...
	{ label = "Sap Effect Mod", bgCol = CC.SAPBG, flag = "sap", { format = "x {2:output:SapEffectMod}",
	...
	{ label = "Chance to Sap", bgCol = CC.SAPBG, flag = "sap", { format = "{0:output:SapChance}%",
	...
	{ label = "Sap Duration", bgCol = CC.SAPBG, flag = "sap", { format = "{2:output:SapDuration}s",
	...
	{ label = "Maximum Sap", bgCol = CC.SAPBG, flag = "sap", { format = "{0:output:MaximumSap}%",
		{ modName = "SapMax" },
	}, },
	{ label = "Current Sap", bgCol = CC.SAPBG, haveOutput = "CurrentSap", { format = "{0:output:CurrentSap}%",
		{ label = "Configured Sap", modName = "SapVal", enemy = true, modType = "BASE" },
		{ label = "Guaranteed Saps", modName = "SapOverride", modType = "BASE" },
	}, },
} }
} },
{ 1, "MiscEffects", 1, CC.CALC_SECTION_BORDER_OFFENCE, {{ defaultCollapsed = false, label = "Other Effects", data = {
	...
	{ label = "MH Stun Threshold", bgCol = CC.BUILD_MAINHANDBG, flagList = {"hit","weapon1Attack"}, { format = "x {2:output:MainHand.EnemyStunThresholdMod}", { modName = "EnemyStunThreshold", cfg = "weapon1" }, }, },
	{ label = "MH Stun Duration", bgCol = CC.BUILD_MAINHANDBG, flagList = {"hit","weapon1Attack"}, { format = "{2:output:MainHand.EnemyStunDuration}s", 
	...
	{ label = "OH Stun Threshold", bgCol = CC.BUILD_OFFHANDBG, flagList = {"hit","weapon2Attack"}, { format = "x {2:output:OffHand.EnemyStunThresholdMod}", { modName = "EnemyStunThreshold", cfg = "weapon2" }, }, },
	{ label = "OH Stun Duration", bgCol = CC.BUILD_OFFHANDBG, flagList = {"hit","weapon2Attack"}, { format = "{2:output:OffHand.EnemyStunDuration}s", 
	...
	{ label = "MH K.B. Chance", bgCol = CC.BUILD_MAINHANDBG, haveOutput = "MainHand.KnockbackChance", { format = "{0:output:MainHand.KnockbackChance}%", 
		{ label = "Player modifiers", modName = "EnemyKnockbackChance", cfg = "weapon1" },
		{ label = "Enemy modifiers", modName = "SelfKnockbackChance", enemy = true },
	}, },
	{ label = "MH K.B. Dist.", bgCol = CC.BUILD_MAINHANDBG, haveOutput = "MainHand.KnockbackChance", { format = "{0:output:MainHand.KnockbackDistance}",
		{ breakdown = "MainHand.KnockbackDistance" },
		{ modName = "EnemyKnockbackDistance", cfg = "weapon1" },
	}, },
	{ label = "OH K.B. Chance", bgCol = CC.BUILD_OFFHANDBG, haveOutput = "OffHand.KnockbackChance", { format = "{0:output:OffHand.KnockbackChance}%", 
		{ label = "Player modifiers", modName = "EnemyKnockbackChance", cfg = "weapon2" },
		{ label = "Enemy modifiers", modName = "SelfKnockbackChance", enemy = true },
	}, },
	{ label = "OH K.B. Dist.", bgCol = CC.BUILD_OFFHANDBG, haveOutput = "OffHand.KnockbackChance", { format = "{0:output:OffHand.KnockbackDistance}",
...
-- attributes/resists
{ 1, "Attributes", 2, CC.CALC_SECTION_BORDER_ATTRIBUTES, {{ defaultCollapsed = false, label = "Attributes", data = {
	extra = c_format("{STAT_STRENGTH}{0:output:Str}{TEXT_PRIMARY}, {STAT_DEXTERITY}{0:output:Dex}{TEXT_PRIMARY}, {STAT_INTELLIGENCE}{0:output:Int}{TEXT_PRIMARY}, {STAT_OMNISCIENCE}{0:output:Omni}"),
...
-- primary defenses
{ 1, "Life", 2, CC.STAT_LIFE, {{ defaultCollapsed = false, label = "Life", data = {
...
{ 1, "Mana", 2, CC.STAT_MANA, {{ defaultCollapsed = false, label = "Mana", data = {
...
{ 1, "EnergyShield", 2, CC.STAT_ES, {{ defaultCollapsed = false, label = "Energy Shield", data = {
...
{ 1, "Ward", 2, CC.STAT_WARD, {{ defaultCollapsed = false, label = "Ward", data = {
	extra = "{0:output:Ward}",
...
-- secondary defenses
{ 1, "Resist", 3, CC.CALC_SECTION_BORDER_DEFENCE, {{ defaultCollapsed = false, label = "Resists", data = {
	extra = c_format("{STAT_FIRE}{0:output:FireResist}+{0:output:FireResistOverCap}{TEXT_PRIMARY}/{STAT_COLD}{0:output:ColdResist}+{0:output:ColdResistOverCap}{TEXT_PRIMARY}/{STAT_LIGHTNING}{0:output:LightningResist}+{0:output:LightningResistOverCap}"),
...
{ 1, "Armour", 3, CC.STAT_ARMOUR, {{ defaultCollapsed = false, label = "Armour", data = {
...
{ 1, "Evasion", 3, CC.STAT_EVASION, {{ defaultCollapsed = false, label = "Evasion", data = {
...
{ 1, "DamageAvoidance", 3, CC.CALC_SECTION_BORDER_DEFENCE, { { defaultCollapsed = false, label = "Damage Avoidance", data = {
...
-- misc resources
{ 1, "Flasks", 3, CC.ITEM_CRAFTED, {{ defaultCollapsed = false, label = "Flasks", data = {
...
} }, { defaultCollapsed = true, label = "Utility Flasks", color = CC.ITEM_RARITY_MAGIC, data = {
...
} }, { defaultCollapsed = true, label = "Life Flasks", color = CC.STAT_LIFE, data = {
	...
	{ label = "Charges/s", { format = "{2:output:LifeFlaskChargeGen}",
		...
		{ label = "Generic Flask Charges/s", modName = { "FlaskChargesGenerated", "FlaskChargesGeneratedPerEmptyFlask" }, modType = "BASE" }}, },
} }, { defaultCollapsed = true, label = "Mana Flasks", color = CC.STAT_MANA, data = {
...
{ 1, "Rage", 3, CC.STAT_RAGE, {{ defaultCollapsed = true, label = "Rage", data = {
	extra = "{0:output:Rage}",
...
-- misc defense
{ 1, "MiscDefences", 3, CC.CALC_SECTION_BORDER_DEFENCE, {{ defaultCollapsed = false, label = "Other Defences", data = {
...
-- damage taken
{ 3, "DamageTaken", 1, CC.CALC_SECTION_BORDER_DEFENCE, {{ defaultCollapsed = false, label = "Damage Taken", data = {
	colWidth = 95,
	{
		{ format = "Total:" },
		{ format = c_format("{STAT_PHYS}Physical{TEXT_PRIMARY}:") },
	...
	{ label = "Enemy Damage",
		{ format = "{2:output:totalEnemyDamage}", 
			{ breakdown = "totalEnemyDamage" }, 
			 ...
			 { label = "Enemy Conversion modifiers", modName = {"PhysicalDamageGainAsLightning", "PhysicalDamageGainAsCold", "PhysicalDamageGainAsFire"}, enemy = true },
		},
		...
		{ format = "{2:output:LightningEnemyDamage}",
			{ breakdown = "LightningEnemyDamage" }, 
			 ...
			 { label = "Enemy Conversion modifiers", modName = {"PhysicalDamageGainAsLightning"}, enemy = true },
		},
		{ format = "{2:output:ColdEnemyDamage}",
			{ breakdown = "ColdEnemyDamage" }, 
			 ...
			 { label = "Enemy Conversion modifiers", modName = {"PhysicalDamageGainAsCold"}, enemy = true },
		},
		{ format = "{2:output:FireEnemyDamage}", 
			{ breakdown = "FireEnemyDamage" },  
			 ...
			 { label = "Enemy Conversion modifiers", modName = {"PhysicalDamageGainAsFire"}, enemy = true },
		},
	...
	{ label = "Net Life Recovery", color = CC.STAT_LIFE, haveOutput = "NetLifeRegen", { format = "{1:output:NetLifeRegen}", { breakdown = "NetLifeRegen" }, }, },
	{ label = "Net Mana Recovery", color = CC.STAT_MANA, haveOutput = "NetManaRegen", { format = "{1:output:NetManaRegen}", { breakdown = "NetManaRegen" }, }, },
	{ label = "Net ES Recovery", color = CC.STAT_ES, haveOutput = "NetEnergyShieldRegen", { format = "{1:output:NetEnergyShieldRegen}", { breakdown = "NetEnergyShieldRegen" }, }, }
} }, { defaultCollapsed = true, label = "Recoup and Hit Taken Over Time", data = {
	colWidth = 190,
	extra = c_format("{STAT_LIFE}{0:output:netLifeRecoupAndLossLostOverTimeAvg}{TEXT_PRIMARY}, {STAT_MANA}{0:output:ManaRecoupRecoveryAvg}{TEXT_PRIMARY}, {STAT_ES}{0:output:EnergyShieldRecoupRecoveryAvg}"),
	{
		{ format = c_format("{STAT_LIFE}Life{TEXT_PRIMARY}:") },
		{ format = c_format("{STAT_MANA}Mana{TEXT_PRIMARY}:") },
		{ format = c_format("{STAT_ES}Energy Shield{TEXT_PRIMARY}:") },
	},
