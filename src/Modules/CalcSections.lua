...
{ 1, "Bleed", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Bleed", data = {
	...
	{ label = "Total More", { format = "{1:mod:1}%", { modName = { "Damage", "PhysicalDamage" }, modType = "MORE", cfg = "bleed" }, }, },
...
{ 1, "Poison", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Poison", data = {
	...
	{ label = "Total More", { format = "{1:mod:1}%", { modName = { "Damage", "ChaosDamage" }, modType = "MORE", cfg = "poison" }, }, },
...
{ 1, "Ignite", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Ignite", data = {	
	...
	{ label = "Total More", { format = "{1:mod:1}%", { modName = { "Damage", "FireDamage", "ElementalDamage" }, modType = "MORE", cfg = "ignite" }, }, },
...
{ 1, "Decay", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Decay", data = {
	...
	{ label = "Total More", { format = "{1:mod:1}%", { modName = { "Damage", "ChaosDamage" }, modType = "MORE", cfg = "decay" }, }, },
...
{ 1, "Life", 2, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "Life", data = {
	...
	{ label = "Total More", { format = "{1:mod:1}%", { modName = "Life", modType = "MORE", }, }, },
...
{ 1, "EnergyShield", 2, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "Energy Shield", data = {
	...
	{ label = "Total More", { format = "{1:mod:1}%", { modName = { "EnergyShield", "Defences" }, modType = "MORE" }, }, },
...
{ 1, "Ward", 2, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "Ward", data = {
	...
	{ label = "Total More", { format = "{1:mod:1}%", { modName = { "Ward", "Defences" }, modType = "MORE" }, }, },
...
{ 1, "Armour", 3, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "Armour", data = {
	...
	{ label = "Total More", { format = "{1:mod:1}%", { modName = { "Armour", "ArmourAndEvasion", "Defences" }, modType = "MORE" }, }, },
...
{ 1, "Evasion", 3, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "Evasion", data = {
	...
	{ label = "Total More", { format = "{1:mod:1}%", { modName = { "Evasion", "ArmourAndEvasion", "Defences" }, modType = "MORE" }, }, },
