...
{ 1, "EleAilments", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Elemental Ailments", data = {
	{ label = "Scorch Effect Mod", flag = "scorch", { format = "x {2:output:ScorchEffectMod}",
	...
	{ label = "Chance to Scorch", flag = "scorch", { format = "{0:output:ScorchChance}%",
	...
	{ label = "Scorch Duration", flag = "scorch", { format = "{2:output:ScorchDuration}s",
	...
	{ label = "Maximum Scorch", flag = "sap", { format = "{0:output:MaximumScorch}%",
		{ modName = "ScorchMax" },
	}, },
	{ label = "Current Scorch", haveOutput = "CurrentScorch", { format = "{0:output:CurrentScorch}%",
	...
	{ label = "Chill Effect Mod", flag = "chill", { format = "x {2:output:ChillEffectMod}",
	...
	{ label = "Chill Duration", flag = "chill", { format = "{2:output:ChillDuration}s",
	...
	{ label = "Maximum Chill", flag = "chill", { format = "{0:output:MaximumChill}%",
		{ modName = "ChillMax" },
	}, },
	{ label = "Current Chill", haveOutput = "CurrentChill", { format = "{0:output:CurrentChill}%",
	...
	{ label = "Freeze Duration", flag = "freeze", { format = "x {2:output:FreezeDurationMod}",
	...
	{ label = "Brittle Effect Mod", flag = "brittle", { format = "x {2:output:BrittleEffectMod}",
	...
	{ label = "Chance to Brittle", flag = "brittle", { format = "{0:output:BrittleChance}%",
	...
	{ label = "Brittle Duration", flag = "brittle", { format = "{2:output:BrittleDuration}s",
	...
	{ label = "Maximum Brittle", flag = "brittle", { format = "{0:output:MaximumBrittle}%",
		{ modName = "BrittleMax" },
	}, },
	{ label = "Current Brittle", haveOutput = "CurrentBrittle", { format = "{0:output:CurrentBrittle}%",
	...
	{ label = "Shock Duration", flag = "shock", { format = "{2:output:ShockDuration}s",
	...
	{ label = "Sap Effect Mod", flag = "sap", { format = "x {2:output:SapEffectMod}",
	...
	{ label = "Chance to Sap", flag = "sap", { format = "{0:output:SapChance}%",
	...
	{ label = "Sap Duration", flag = "sap", { format = "{2:output:SapDuration}s",
	...
	{ label = "Maximum Sap", flag = "sap", { format = "{0:output:MaximumSap}%",
		{ modName = "SapMax" },
	}, },
	{ label = "Current Sap", haveOutput = "CurrentSap", { format = "{0:output:CurrentSap}%",
