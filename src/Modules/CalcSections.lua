...
{ 1, "SkillTypeStats", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Skill type-specific Stats", data = {
	...
	{ label = "Mana Cost", color = colorCodes.MANA, haveOutput = "ManaPerSecondHasCost", { format = "{2:output:ManaPerSecondCost}/s", { breakdown = "ManaPerSecondCost" }, { modName = { "ManaCost", "Cost" }, cfg = "skill" }, }, },
	{ label = "Life Cost", color = colorCodes.LIFE, haveOutput = "LifePerSecondHasCost", { format = "{2:output:LifePerSecondCost}/s", { breakdown = "LifePerSecondCost" }, { modName = { "LifeCost", "Cost" }, cfg = "skill" }, }, },
	...
	{ label = "ES Cost", color = colorCodes.ES, haveOutput = "ESPerSecondHasCost", { format = "{2:output:ESPerSecondCost}/s", { breakdown = "ESPerSecondCost" }, { modName = { "ESCost", "Cost" }, cfg = "skill" }, }, },
...
{ 1, "Poison", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Poison", data = {
	...
	{ label = "Poison Duration", { format = "{2:output:PoisonDuration}s", 
		...
		{ label = "Enemy modifiers", modName = { "SelfPoisonDuration", "SelfPoisonFaster", "EffectExpiresFaster" }, enemy = true , cfg = {skillGrantsDebuff = true}},
	}, },
...
{ 1, "EleAilments", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Non-Damaging Ailments", data = {
	...
	{ label = "Scorch Duration", bgCol = colorCodes.SCORCHBG, flag = "scorch", { format = "{2:output:ScorchDuration}s",
		...
		{ label = "Enemy modifiers", modName = { "SelfScorchDuration", "EffectExpiresFaster" }, enemy = true, cfg = {skillGrantsDebuff = true} },
	}, },
	...
	{ label = "Chill Duration", bgCol = colorCodes.CHILLBG, flag = "chill", { format = "{2:output:ChillDuration}s",
		...
		{ label = "Enemy modifiers", modName = { "SelfChillDuration", "EffectExpiresFaster" }, enemy = true, cfg = {skillGrantsDebuff = true} },
	}, },
	...
	{ label = "Brittle Duration", bgCol = colorCodes.BRITTLEBG, flag = "brittle", { format = "{2:output:BrittleDuration}s",
		...
		{ label = "Enemy modifiers", modName = { "SelfBrittleDuration", "EffectExpiresFaster" }, enemy = true, cfg = {skillGrantsDebuff = true} },
	}, },
	...
	{ label = "Shock Duration", bgCol = colorCodes.SHOCKBG, flag = "shock", { format = "{2:output:ShockDuration}s",
		...
		{ label = "Enemy modifiers", modName = { "SelfShockDuration", "EffectExpiresFaster" }, enemy = true, cfg = {skillGrantsDebuff = true} },
	}, },
	...
	{ label = "Sap Duration", bgCol = colorCodes.SAPBG, flag = "sap", { format = "{2:output:SapDuration}s",
		...
		{ label = "Enemy modifiers", modName = { "SelfSapDuration", "EffectExpiresFaster" }, enemy = true, cfg = {skillGrantsDebuff = true} },
	}, },
...
{ 1, "MiscDefences", 3, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "Other Defences", data = {
	...
	{ label = "Freeze Duration", { format = "{1:output:SelfFreezeDuration}%", { modName = { "SelfFreezeDuration", "EffectExpiresFaster", "SelfFreezeDebuffExpirationRate" }, cfg = {skillGrantsDebuff = true}, }, }, },
	{ label = "Chill Duration", { format = "{1:output:SelfChillDuration}%", { modName = { "SelfChillDuration", "EffectExpiresFaster", "SelfChillDebuffExpirationRate" }, cfg = {skillGrantsDebuff = true}, }, }, },
	{ label = "Shock Duration", { format = "{1:output:SelfShockDuration}%", { modName = { "SelfShockDuration", "EffectExpiresFaster", "SelfShockDebuffExpirationRate" }, cfg = {skillGrantsDebuff = true}, }, }, },
	{ label = "Ignite Duration", { format = "{1:output:SelfIgniteDuration}%", { modName = { "SelfIgniteDuration", "EffectExpiresFaster", "SelfIgniteDebuffExpirationRate" }, cfg = {skillGrantsDebuff = true}, }, }, },
	{ label = "Sap Duration", { format = "{1:output:SelfSapDuration}%", { modName = { "SelfSapDuration", "EffectExpiresFaster", "SelfSapDebuffExpirationRate" }, cfg = {skillGrantsDebuff = true}, }, }, },
	{ label = "Brittle Duration", { format = "{1:output:SelfBrittleDuration}%", { modName = { "SelfBrittleDuration", "EffectExpiresFaster", "SelfBrittleDebuffExpirationRate" }, cfg = {skillGrantsDebuff = true}, }, }, },
	{ label = "Scorch Duration", { format = "{1:output:SelfScorchDuration}%", { modName = { "SelfScorchDuration", "EffectExpiresFaster", "SelfScorchDebuffExpirationRate" },cfg = {skillGrantsDebuff = true}, }, }, },
	{ label = "Bleed Duration", { format = "{1:output:SelfBleedDuration}%", { modName = { "SelfBleedDuration", "EffectExpiresFaster", "SelfBleedDebuffExpirationRate" }, cfg = {skillGrantsDebuff = true}, }, }, },
	{ label = "Poison Duration", { format = "{1:output:SelfPoisonDuration}%", { modName = { "SelfPoisonDuration", "EffectExpiresFaster", "SelfPoisonDebuffExpirationRate" }, cfg = {skillGrantsDebuff = true}, }, }, },
