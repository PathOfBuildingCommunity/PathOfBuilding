...
{ 1, "EleAilments", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Non-Damaging Ailments", data = {
	...
	{ label = "Scorch Duration", bgCol = colorCodes.SCORCHBG, flag = "scorch", { format = "{2:output:ScorchDuration}s",
		...
		{ label = "Enemy modifiers", modName = { "SelfScorchDuration", "DebuffExpireFaster" }, enemy = true },
	}, },
	...
	{ label = "Chill Duration", bgCol = colorCodes.CHILLBG, flag = "chill", { format = "{2:output:ChillDuration}s",
		...
		{ label = "Enemy modifiers", modName = { "SelfChillDuration", "DebuffExpireFaster" }, enemy = true },
	}, },
	...
	{ label = "Brittle Duration", bgCol = colorCodes.BRITTLEBG, flag = "brittle", { format = "{2:output:BrittleDuration}s",
		...
		{ label = "Enemy modifiers", modName = { "SelfBrittleDuration", "DebuffExpireFaster" }, enemy = true },
	}, },
	...
	{ label = "Shock Duration", bgCol = colorCodes.SHOCKBG, flag = "shock", { format = "{2:output:ShockDuration}s",
		...
		{ label = "Enemy modifiers", modName = { "SelfShockDuration", "DebuffExpireFaster" }, enemy = true },
	}, },
	...
	{ label = "Sap Duration", bgCol = colorCodes.SAPBG, flag = "sap", { format = "{2:output:SapDuration}s",
		...
		{ label = "Enemy modifiers", modName = { "SelfSapDuration", "DebuffExpireFaster" }, enemy = true },
	}, },
...
{ 1, "MiscDefences", 3, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "Other Defences", data = {
	...
	{ label = "Debuff Dur. Mult.", haveOutput = "showDebuffExpirationModifier", { format = "{1:output:DebuffExpirationModifier}%", {modName = "DebuffExpireFaster"} }, },
	{ label = "Buff Dur. Mult.", haveOutput = "showBuffExpirationModifier", { format = "{1:output:BuffExpirationModifier}%", {modName = "BuffExpireFaster"} }, },
	...
	{ label = "Freeze Duration", { format = "{1:output:SelfFreezeDuration}%", { modName = { "SelfFreezeDuration", "DebuffExpireFaster", "SelfFreezeDebuffExpirationRate" }, }, }, },
	{ label = "Chill Duration", { format = "{1:output:SelfChillDuration}%", { modName = { "SelfChillDuration", "DebuffExpireFaster", "SelfChillDebuffExpirationRate" }, }, }, },
	{ label = "Shock Duration", { format = "{1:output:SelfShockDuration}%", { modName = { "SelfShockDuration", "DebuffExpireFaster", "SelfShockDebuffExpirationRate" }, }, }, },
	{ label = "Ignite Duration", { format = "{1:output:SelfIgniteDuration}%", { modName = { "SelfIgniteDuration", "DebuffExpireFaster", "SelfIgniteDebuffExpirationRate" }, }, }, },
	{ label = "Sap Duration", { format = "{1:output:SelfSapDuration}%", { modName = { "SelfSapDuration", "DebuffExpireFaster", "SelfSapDebuffExpirationRate" }, }, }, },
	{ label = "Brittle Duration", { format = "{1:output:SelfBrittleDuration}%", { modName = { "SelfBrittleDuration", "DebuffExpireFaster", "SelfBrittleDebuffExpirationRate" }, }, }, },
	{ label = "Scorch Duration", { format = "{1:output:SelfScorchDuration}%", { modName = { "SelfScorchDuration", "DebuffExpireFaster", "SelfScorchDebuffExpirationRate" }, }, }, },
	{ label = "Bleed Duration", { format = "{1:output:SelfBleedDuration}%", { modName = { "SelfBleedDuration", "DebuffExpireFaster", "SelfBleedDebuffExpirationRate" }, }, }, },
	{ label = "Poison Duration", { format = "{1:output:SelfPoisonDuration}%", { modName = { "SelfPoisonDuration", "DebuffExpireFaster", "SelfPoisonDebuffExpirationRate" }, }, }, },
