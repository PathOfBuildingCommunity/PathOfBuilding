...
{ 1, "SkillTypeStats", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Skill type-specific Stats", data = {
	...
	{ label = "Wave Pulse Rate", haveOutput = "WavePulseRate", { format = "{2:output:WavePulseRate}", { breakdown = "WavePulseRate" }, }, },
	{ label = "Pulses Per Trap", haveOutput = "PulsesPerTrap", { format = "{2:output:PulsesPerTrap}", { breakdown = "PulsesPerTrap" }, }, },
