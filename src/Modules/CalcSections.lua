...
{ 1, "Mana", 2, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "Mana", data = {
	...
	{ label = "Regen", { format = "{1:output:ManaRegenRecovery} ({1:output:ManaRegenPercent}%)", 
		...
		{ label = "Sources", modName = { "ManaRegen", "ManaRegenPercent", "ManaDegen", "ManaDegenPercent" }, modType = "BASE" },
...
{ 1, "EnergyShield", 2, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "Energy Shield", data = {
	...
	{ label = "Regen", { format = "{1:output:EnergyShieldRegenRecovery} ({1:output:EnergyShieldRegenPercent}%)", 
		...
		{ label = "Sources", modName = { "EnergyShieldRegen", "EnergyShieldRecovery", "EnergyShieldRegenPercent", "EnergyShieldDegen", "EnergyShieldDegenPercent", "NoEnergyShieldRegen" } }, 
...
{ 1, "Rage", 2, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "Rage", data = {
	...
	{ label = "Regen", { format = "{1:output:RageRegenRecovery} ({1:output:RageRegenPercent}%)", 
		...
		{ label = "Sources", modName = { "RageRegen", "RageRegenPercent", "RageDegen", "RageDegenPercent" }, modType = "BASE" },
