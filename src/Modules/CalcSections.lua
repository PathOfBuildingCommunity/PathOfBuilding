...
{ 1, "EleAilments", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Non-Damaging Ailments", data = {
	...
	{ label = "Scorch Stacks", bgCol = colorCodes.SCORCHBG, haveOutput = "ScorchStacks", { format = "{0:output:ScorchStacks}",
		{ label = "Scorch Stacks", modName = "ScorchStacks", modType = "BASE" },
	}, },
	...
	{ label = "Shock Stacks", bgCol = colorCodes.SHOCKBG, haveOutput = "ShockStacks", { format = "{1:output:ShockStacks}",
		{ label = "Shock Stacks", modName = "ShockStacks", enemy = true, modType = "BASE" },
	}, },
