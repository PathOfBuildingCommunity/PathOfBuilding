...
{ 1, "Bleed", 1, colorCodes.BLEED, {{ defaultCollapsed = false, label = "Bleed", data = {
...
{ 1, "Poison", 1, colorCodes.POISON, {{ defaultCollapsed = false, label = "Poison", data = {
...
{ 1, "Ignite", 1, colorCodes.IGNITE, {{ defaultCollapsed = false, label = "Ignite", data = {	
