...
{ 1, "SpeedWithoutUptime", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Attack/Cast Rate", data = {
	extra = "{2:output:SpeedWithoutUptime}/s",
	...
	{ label = "Attacks per second", flag = "bothWeaponAttack", notFlag = "triggered", { format = "{2:output:SpeedWithoutUptime}", { breakdown = "Speed" }, }, },
	{ label = "Attack time", flag = "attack", notFlag = "triggered", { format = "{2:output:DisplayTime}s", { breakdown = "MainHand.Time" }, }, },
	...
	{ label = "Casts per second", flag = "spell", notFlag = "triggered", { format = "{2:output:SpeedWithoutUptime}", { breakdown = "Speed" }, }, },
	...
	{ label = "Eff. Trigger Rate", flag = "triggered", notFlag = "dontDisplay", { format = "{2:output:SpeedWithoutUptime}", { breakdown = "Speed" }, }, },
...
{ 1, "SkillTypeStats", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Skill type-specific Stats", data = {
	...
	{ label = "Trap Throw Rate", flag = "trap", { format = "{2:output:DisplayTrapThrowingSpeed}",
		{ breakdown = "TrapThrowingSpeed" },
		{ modName = "TrapThrowingSpeed", cfg = "skill" },
	}, },
	{ label = "Trap Throw Time", flag = "trap", { format = "{2:output:DisplayTrapThrowingTime}s", { breakdown = "TrapThrowingTime" }, }, },
	...
	{ label = "Mine Throw Rate", flag = "mine", { format = "{2:output:DisplayMineLayingSpeed}", 
		{ breakdown = "MineLayingTime" },
		{ modName = "MineLayingSpeed", cfg = "skill" }, 
	}, },
	{ label = "Mine Throw Time", flag = "mine", { format = "{2:output:DisplayMineLayingTime}s", { breakdown = "MineThrowingTime" }, }, },
	...
	{ label = "Totem Place Time", flag = "totem", { format = "{2:output:DisplayTotemPlacementTime}s", 
...
{ 1, "MiscDefences", 3, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "Other Defences", data = {
	...
	{ label = "Freeze Duration", { format = "{1:output:SelfFreezeDuration}%", { modName = { "SelfFreezeDuration", "SelfDebuffExpirationRate", "SelfFreezeDebuffExpirationRate", "SelfAilmentDuration", "SelfElementalAilmentDuration" }, }, }, },
	{ label = "Chill Duration", { format = "{1:output:SelfChillDuration}%", { modName = { "SelfChillDuration", "SelfDebuffExpirationRate", "SelfChillDebuffExpirationRate", "SelfAilmentDuration", "SelfElementalAilmentDuration" }, }, }, },
	{ label = "Shock Duration", { format = "{1:output:SelfShockDuration}%", { modName = { "SelfShockDuration", "SelfDebuffExpirationRate", "SelfShockDebuffExpirationRate", "SelfAilmentDuration", "SelfElementalAilmentDuration" }, }, }, },
	...
	{ label = "Sap Duration", { format = "{1:output:SelfSapDuration}%", { modName = { "SelfSapDuration", "SelfDebuffExpirationRate", "SelfSapDebuffExpirationRate", "SelfAilmentDuration", "SelfElementalAilmentDuration" }, }, }, },
	{ label = "Brittle Duration", { format = "{1:output:SelfBrittleDuration}%", { modName = { "SelfBrittleDuration", "SelfDebuffExpirationRate", "SelfBrittleDebuffExpirationRate", "SelfAilmentDuration", "SelfElementalAilmentDuration" }, }, }, },
	{ label = "Scorch Duration", { format = "{1:output:SelfScorchDuration}%", { modName = { "SelfScorchDuration", "SelfDebuffExpirationRate", "SelfScorchDebuffExpirationRate", "SelfAilmentDuration", "SelfElementalAilmentDuration" }, }, }, },
