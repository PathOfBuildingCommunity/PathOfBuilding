...
{ 3, "DamageTaken", 1, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "Damage Taken", data = {
	...
	{ label = "Enemy Damage",
		...
		{ format = "{2:output:LightningEnemyDamage}",
			{ breakdown = "LightningEnemyDamage" }, 
			 ...
			 { label = "Enemy Conversion modifiers", modName = {"PhysicalDamageGainAsLightning", "PhysicalDamageGainAsRandom", "PhysicalDamageSkillConvertToLightning", "PhysicalDamageConvertToLightning"}, enemy = true },
		},
		{ format = "{2:output:ColdEnemyDamage}",
			{ breakdown = "ColdEnemyDamage" }, 
			 ...
			 { label = "Enemy Conversion modifiers", modName = {"PhysicalDamageGainAsCold", "PhysicalDamageGainAsRandom", "PhysicalDamageSkillConvertToCold", "PhysicalDamageConvertToCold"}, enemy = true },
		},
		{ format = "{2:output:FireEnemyDamage}", 
			{ breakdown = "FireEnemyDamage" },  
			 ...
			 { label = "Enemy Conversion modifiers", modName = {"PhysicalDamageGainAsFire", "PhysicalDamageGainAsRandom", "PhysicalDamageSkillConvertToFire", "PhysicalDamageConvertToFire"}, enemy = true },
		},
	...
	{ label = "Hit taken Mult.",
		...
		{ format = "x {3:output:LightningTakenHitMult}",
			...
			{ label = "Enemy modifiers", modName = { "LightningPenetration", "ElementalPenetration" }, enemy = true },
		},
		{ format = "x {3:output:ColdTakenHitMult}",
			...
			{ label = "Enemy modifiers", modName = { "ColdPenetration", "ElementalPenetration" }, enemy = true },
		},
		{ format = "x {3:output:FireTakenHitMult}", 
			...
			{ label = "Enemy modifiers", modName = { "FirePenetration", "ElementalPenetration" }, enemy = true },
		},
		{ format = "x {3:output:ChaosTakenHitMult}",
			...
			{ label = "Enemy modifiers", modName = { "ChaosPenetration" }, enemy = true },
		},
	},
