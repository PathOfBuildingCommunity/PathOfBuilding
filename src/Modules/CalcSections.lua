...
{ 3, "DamageTaken", 1, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "Damage Taken", data = {
	...
	{ label = "CH. % dmg hit", { format = "{0:output:PhysicalProjectileDamageChance}%", { breakdown = "ProjectileNotHitChance" }, }, },
	{ label = "Ave. # hits given^", { format = "{2:output:NumberOfMitigatedDamagingHits}", }, },
	{ label = "CH. to not be hit", { format = "{0:output:ProjectileNotHitChance}%", { breakdown = "ProjectileNotHitChance" }, }, },
