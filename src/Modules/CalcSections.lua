...
{ 1, "Speed", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Attack/Cast Rate", data = {
	...
	{ label = "Hit Rate", haveOutput = "HitSpeed", notFlag = "recalledBrand", { format = "{2:output:HitSpeed}", { breakdown = "HitSpeed" } }, },
...
{ 1, "Impale", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Impale", data = {
	...
	{ label = "Impale Dur. Mod", { format = "x {4:output:ImpaleDurationMod}",
		{ breakdown = "ImpaleDurationMod" }, 
		{ modName = { "ImpaleDuration" }, cfg = "skill" }, 
	}, },
	{ label = "Impale Duration", { format = "{3:output:ImpaleDuration}s",
...
{ 1, "SkillTypeStats", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Skill type-specific Stats", data = {
	...
	{ label = "Mana Cost", color = colorCodes.MANA, haveOutput = "ManaHasCostTotal", { format = "{0:output:ManaCostTotal}", { breakdown = "ManaCostTotal" }, { modName = manaCost, cfg = "skill" }, }, },
	{ label = "Mana % Cost", color = colorCodes.MANA, haveOutput = "ManaPercentHasCostTotal", { format = "{0:output:ManaPercentCostTotal}", { breakdown = "ManaPercentCostTotal" }, { modName = manaCost, cfg = "skill" }, }, },
	...
	{ label = "Life Cost", color = colorCodes.LIFE, haveOutput = "LifeHasCostTotal", { format = "{0:output:LifeCostTotal}", { breakdown = "LifeCostTotal" }, { modName = lifeCost, cfg = "skill" }, }, },
	{ label = "Life % Cost", color = colorCodes.LIFE, haveOutput = "LifePercentHasCostTotal", { format = "{0:output:LifePercentCostTotal}", { breakdown = "LifePercentCostTotal" }, { modName = lifeCost, cfg = "skill" }, }, },
	...
	{ label = "ES Cost", color = colorCodes.ES, haveOutput = "ESHasCostTotal", { format = "{0:output:ESCostTotal}", { breakdown = "ESCostTotal" }, { modName = ESCost, cfg = "skill" }, }, },
	...
	{ label = "Rage Cost", color = colorCodes.RAGE, haveOutput = "RageHasCostTotal", { format = "{0:output:RageCostTotal}", { breakdown = "RageCostTotal" }, { modName = rageCost, cfg = "skill" }, }, },
	...
	{ label = "Total Recall Mana Cost/s", color = colorCodes.MANA, flag = "recalled", haveOutput = "TotalRecallManaHasCost", { format = "{2:output:TotalRecallManaCost}", { breakdown = "TotalRecallManaCost" }, }, },
	{ label = "Total Recall Mana % Cost/s", color = colorCodes.MANA, flag = "recalled", haveOutput = "TotalRecallManaPercentHasCost", { format = "{2:output:TotalRecallManaPercentCost}%", { breakdown = "TotalRecallManaPercentCost" }, }, },
	{ label = "Recall Life Cost/s", color = colorCodes.LIFE, flag = "recalled", haveOutput = "TotalRecallLifeHasCost", { format = "{2:output:TotalRecallLifeCost}", { breakdown = "TotalRecallLifeCost" }, }, },
	{ label = "Total Recall Life % Cost/s", color = colorCodes.LIFE, flag = "recalled", haveOutput = "TotalRecallLifePercentHasCost", { format = "{2:output:TotalRecallLifePercentCost}%", { breakdown = "TotalRecallLifePercentCost" }, }, },
	{ label = "Total Recall ES Cost/s", color = colorCodes.ES, flag = "recalled", haveOutput = "TotalRecallESHasCost", { format = "{2:output:TotalRecallESCost}", { breakdown = "TotalRecallESCost" }, }, },
	{ label = "Total Recall Rage Cost/s", color = colorCodes.RAGE, flag = "recalled", haveOutput = "TotalRecallRageHasCost", { format = "{2:output:TotalRecallRageCost}", { breakdown = "TotalRecallRageCost" }, }, },
	...
	{ label = "Recalled Brands", flag = "recalled", { format = "{0:output:RecalledBrandCount}" }, },
	{ label = "Recall Rate", flag = "recalled", { format = "{2:output:RecalledSkillRate}", { breakdown = "RecalledSkillRate" } }, },
