...
data.powerStatList = {
	...
	{ stat="Cooldown", label="Cooldown Recovery", transform=function(value) return -value end },
	{ stat="TotalDot", label="DoT DPS" },
	{ stat="BleedDPS", label="Bleed DPS" },
	{ stat="BleedDamage", label="Bleed Total Damage" },
	{ stat="BleedDuration", label="Bleed Duration" },
	{ stat="IgniteDPS", label="Ignite DPS" },
	{ stat="IgniteDamage", label="Ignite Total Damage" },
	{ stat="IgniteDuration", label="Ignite Duration" },
	{ stat="PoisonDPS", label="Poison DPS" },
	{ stat="PoisonDamage", label="Poison Total Damage" },
	{ stat="PoisonDuration", label="Poison Duration" },
	...
	{ stat="FireResistMax", label="Maximum Fire Resistance" },
	{ stat="ColdResistMax", label="Maximum Cold Resistance" },
	{ stat="LightningResistMax", label="Maximum Lightning Resistance" },
	{ stat="ChaosResistMax", label="Maximum Chaos Resistance" },
	...
	{ stat="ChillEffectMod", label="Chill Effect" },
	{ stat="ChillDuration", label="Chill Duration" },
	{ stat="ShockEffectMod", label="Shock Effect" },
	{ stat="ShockDuration", label="Shock Duration" },
	{ stat="ScorchEffectMod", label="Scorch Effect" },
	{ stat="ScorchDuration", label="Scorch Duration" },
	{ stat="BrittleEffectMod", label="Brittle Effect" },
	{ stat="BrittleDuration", label="Brittle Duration" },
	{ stat="SapEffectMod", label="Sap Effect" },
	{ stat="SapDuration", label="Sap Duration" },
