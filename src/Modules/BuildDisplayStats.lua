...
local displayStats = {
	...
	{ stat = "Speed", label = "Effective Trigger Rate", fmt = ".2f", compPercent = true, notFlag = { "skipEffectiveRate", "recalled" }, condFunc = function(v,o) return (o.TriggerTime or 0) ~= 0 end },
	{ stat = "RecalledSkillRate", label = "Recalled Activations/s", fmt = ".2f", flag = "recalled", breakdown = "RecalledSkillRate" },
	{ stat = "WarcryCastTime", label = "Cast Time", fmt = ".2fs", compPercent = true, lowerIsBetter = true, flag = "warcry" },
	{ stat = "HitSpeed", label = "Hit Rate", fmt = ".2f", compPercent = true, notFlag = "recalledBrand", condFunc = function(v,o) return not o.TriggerTime end },
	...
	{ stat = "ManaCostTotal", label = "Mana Cost", fmt = "d", color = colorCodes.MANA, pool = "ManaUnreserved", compPercent = true, lowerIsBetter = true, condFunc = function(v,o) return o.ManaHasCostTotal end },
	{ stat = "ManaPercentCostTotal", label = "Mana Cost", fmt = "d%%", color = colorCodes.MANA, pool = "ManaUnreservedPercent", compPercent = true, lowerIsBetter = true, condFunc = function(v,o) return o.ManaPercentHasCostTotal end },
	...
	{ stat = "LifeCostTotal", label = "Life Cost", fmt = "d", color = colorCodes.LIFE, pool = "LifeUnreserved", compPercent = true, lowerIsBetter = true, condFunc = function(v,o) return o.LifeHasCostTotal end },
	{ stat = "LifePercentCostTotal", label = "Life Cost", fmt = "d%%", color = colorCodes.LIFE, pool = "LifeUnreservedPercent", compPercent = true, lowerIsBetter = true, condFunc = function(v,o) return o.LifePercentHasCostTotal end },
	...
	{ stat = "ESCostTotal", label = "Energy Shield Cost", fmt = "d", color = colorCodes.ES, pool = "EnergyShield", compPercent = true, lowerIsBetter = true, condFunc = function(v,o) return o.ESHasCostTotal end },
	...
	{ stat = "RageCostTotal", label = "Rage Cost", fmt = "d", color = colorCodes.RAGE, pool = "Rage", compPercent = true, lowerIsBetter = true, condFunc = function(v,o) return o.RageHasCostTotal end },
	...
	{ stat = "TotalRecallManaCost", label = "Total Recall Mana Cost/s", fmt = ".2f", color = colorCodes.MANA, pool = "ManaUnreserved", compPercent = true, lowerIsBetter = true, flag = "recalled", breakdown = "TotalRecallManaCost", condFunc = function(v,o) return o.TotalRecallManaHasCost end },
	{ stat = "TotalRecallManaPercentCost", label = "Total Recall Mana Cost/s", fmt = ".2f%%", color = colorCodes.MANA, pool = "ManaUnreservedPercent", compPercent = true, lowerIsBetter = true, flag = "recalled", breakdown = "TotalRecallManaPercentCost", condFunc = function(v,o) return o.TotalRecallManaPercentHasCost end },
	{ stat = "TotalRecallLifeCost", label = "Total Recall Life Cost/s", fmt = ".2f", color = colorCodes.LIFE, pool = "LifeUnreserved", compPercent = true, lowerIsBetter = true, flag = "recalled", breakdown = "TotalRecallLifeCost", condFunc = function(v,o) return o.TotalRecallLifeHasCost end },
	{ stat = "TotalRecallLifePercentCost", label = "Total Recall Life Cost/s", fmt = ".2f%%", color = colorCodes.LIFE, pool = "LifeUnreservedPercent", compPercent = true, lowerIsBetter = true, flag = "recalled", breakdown = "TotalRecallLifePercentCost", condFunc = function(v,o) return o.TotalRecallLifePercentHasCost end },
	{ stat = "TotalRecallESCost", label = "Total Recall ES Cost/s", fmt = ".2f", color = colorCodes.ES, pool = "EnergyShield", compPercent = true, lowerIsBetter = true, flag = "recalled", breakdown = "TotalRecallESCost", condFunc = function(v,o) return o.TotalRecallESHasCost end },
	{ stat = "TotalRecallRageCost", label = "Total Recall Rage Cost/s", fmt = ".2f", color = colorCodes.RAGE, pool = "Rage", compPercent = true, lowerIsBetter = true, flag = "recalled", breakdown = "TotalRecallRageCost", condFunc = function(v,o) return o.TotalRecallRageHasCost end },
	{ },
