...
Huge sets the radius to 11.
	...
	{ var = "multiplierManaBurnStacks", type = "count", label = "Mana Burn Stacks", tooltip = "....", apply = function(val, modList, enemyModList)
		modList:NewMod("Multiplier:ManaBurnStacks", "BASE", val, "Config", { type = "Condition", var = "Combat" })
	end },
