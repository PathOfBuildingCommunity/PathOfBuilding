...
Huge sets the radius to 11.
	...
	{ var = "maniaDebuffsCount", type = "countAllowZero", label = "# of Mania Stacks", ifFlag = "InflictMania", defaultState = 15, tooltip = "Mania Stacks apply:\n\t4% inc Damage Taken\n\t2% reduced Action Speed and\n\t10% reduced ^xE05030Life ^7and ^x88FFFFEnergy Shield ^7Recovery Rate per stack", apply = function(val, modList, enemyModList)
		val = m_min(val, 15)
		if val > 0 then
			enemyModList:NewMod("Condition:AfflictedByMania", "FLAG", true, "Config")
		end
