...
function main:DrawBackground(viewPort)
	...
	local backgroundSprites = self.tree[latestTreeVersion].spriteMap.background
	local backgroundSprite = backgroundSprites.Background2 or backgroundSprites.Background1
	DrawImage(backgroundSprite.handle, viewPort.x, viewPort.y, viewPort.width, viewPort.height, 0, 0, viewPort.width / 100, viewPort.height / 100)
	SetDrawLayer(nil, 0)
end
