...
local specialModList = {
	...
	["placed banners also grant (%d+)%% increased attack damage to you and allies"] = function(num) return { mod("Damage", "INC", num, nil, ModFlag.Attack, { type = "GlobalEffect", effectType = "Buff" }, { type = "Condition", var = "BannerPlanted" }) } end,
