...
local specialModList = {
	...
	["(%d+)%% of damage taken recouped as life"] = function(num) return { mod("LifeRecoup", "BASE", num) } end,
	["(%d+)%% of damage taken recouped as energy shield"] = function(num) return { mod("EnergyShieldRecoup", "BASE", num) } end,
	["(%d+)%% of damage taken recouped as mana"] = function(num) return { mod("ManaRecoup", "BASE", num) } end,
	["(%d+)%% of damage taken while affected by clarity recouped as mana"] = function(num) return { mod("ManaRecoup", "BASE", num) } end,
	["(%d+)%% of damage taken recouped as life, mana and energy shield"] = function(num) return { mod("LifeRecoup", "BASE", num), mod("EnergyShieldRecoup", "BASE", num), mod("ManaRecoup", "BASE", num) } end,
