...
local specialModList = {
	...
	["warcries debilitate enemies for 1 second"] = { mod("DebilitateChance", "BASE", 100) },
	["debilitate enemies for 1 second when you suppress their spell damage"] = { mod("DebilitateChance", "BASE", 100) },
	["counterattacks have a (%d+)%% chance to debilitate on hit for 1 second"] = function (num) return { mod("DebilitateChance", "BASE", num) } end, 
