...
local specialModList = {
	...
	["gain adrenaline when stunned, for 2 seconds per (%d+)ms of stun duration"] = function(num) return { flag("Condition:Adrenaline", {type = "Condition", var = "StunnedRecently"}, { type = "StatThreshold", stat = "StunDuration", threshold = num / 1000 })} end,
