...
local specialModList = {
	...
	["([%+%-]%d+) to level of all elemental skill gems if the stars are aligned"] = function(num) return {	mod("GemProperty", "LIST", { keyword = "elemental", keyword = "grants_active_skill", key = "level", value = num, keyOfScaledMod = "value" }, { type = "Condition", var = "StarsAreAligned" })} end,
	["([%+%-]%d+) to level of all elemental support gems if the stars are aligned"] = function(num) return { mod("GemProperty", "LIST", { keyword = "elemental", keyword = "support", key = "level", value = num, keyOfScaledMod = "value" }, { type = "Condition", var = "StarsAreAligned" })} end,
