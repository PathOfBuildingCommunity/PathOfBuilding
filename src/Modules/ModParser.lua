...
local specialModList = {
	...
	["enemies in your chilling areas have damage taken increased by chill effect"] = { flag("ChillingAreaIncDamageTaken", { type = "ActorCondition", actor = "enemy", var = "InChillingArea" }) },
