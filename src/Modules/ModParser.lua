...
local specialModList = {
	...
	["tinctures have (%d+)%% increased effect while at or above (%d+) stacks of mana burn"] = function(num, _, threshold) return { mod("TinctureEffect", "INC", num, { type = "MultiplierThreshold", var = "ManaBurnStacks", threshold = tonumber(threshold) }) } end,
