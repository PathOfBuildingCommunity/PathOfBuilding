...
local specialModList = {
	...
	-- Hinder
	["enemies you curse are hindered, with (%d+)%% reduced movement speed"] = { mod("EnemyModifier", "LIST", { mod = flag("Condition:Hindered") }, { type = "ActorCondition", actor = "enemy", var = "Cursed" }) },
	-- Flasks
