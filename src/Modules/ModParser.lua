...
local modTagList = {
	...
	["if you were hit by an attack recently"] = { tag = { type = "Condition", var = "HitByAttackDamageRecently" } },
	...
	["if you have ?n[o']t been hit by an attack recently"] = { tag = { type = "Condition", var = "HitByAttackDamageRecently", neg = true } },
	...
	["if you[' ]h?a?ve taken attack damage recently"] = { tag = { type = "Condition", var = "HitByAttackDamageRecently" } },
