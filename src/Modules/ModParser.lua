...
local modTagList = {
	...
	["if your equipped staff has a (%a+) and (%a+) socket"] = function (_, colorA, colorB) return { tag = { type = "ItemCondition", itemSlot = "Weapon 1", socketCond = colorA:sub(1,1):upper() .. colorB:sub(1,1):upper() } } end,
