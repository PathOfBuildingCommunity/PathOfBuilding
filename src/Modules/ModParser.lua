...
local specialModList = {
	...
	["(%d+)%% arcane might with retaliation skills"] = function(num) return {
	...
	["arcane might while wielding a wand"] = { flag("SpellDamageAppliesToAttacks", { type = "Condition", var = "UsingWand" }) },
