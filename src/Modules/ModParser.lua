...
local modNameList = {
	...
	["life per enemy hit by spells"] = { "LifeOnHit", flags = ModFlag.Spell },
	["life per enemy hit with spells"] = { "LifeOnHit", flags = ModFlag.Spell },
	...
	["mana per enemy hit"] = "ManaOnHit",
	["mana gained for each enemy hit"] = "ManaOnHit",
	["mana gained for each enemy hit by attacks"] = { "ManaOnHit", flags = ModFlag.Attack },
	["mana per enemy hit by attacks"] = { "ManaOnHit", flags = ModFlag.Attack },
	["mana per enemy hit with attacks"] = { "ManaOnHit", flags = ModFlag.Attack },
	["mana per enemy hit by spells"] = { "ManaOnHit", flags = ModFlag.Spell },
	["mana per enemy hit with spells"] = { "ManaOnHit", flags = ModFlag.Spell },
	["mana gained for each enemy hit by your attacks"] = { "ManaOnHit", flags = ModFlag.Attack },
	["mana gained for each enemy hit by spells"] = { "ManaOnHit", flags = ModFlag.Spell },
	["mana gained for each enemy hit by your spells"] = { "ManaOnHit", flags = ModFlag.Spell },
	...
	["energy shield per enemy hit with attacks"] = { "EnergyShieldOnHit", flags = ModFlag.Attack },
	["energy shield per enemy hit by spells"] = { "EnergyShieldOnHit", flags = ModFlag.Spell },
	["energy shield per enemy hit with spells"] = { "EnergyShieldOnHit", flags = ModFlag.Spell },
	["energy shield gained for each enemy hit by your attacks"] = { "EnergyShieldOnHit", flags = ModFlag.Attack },
	["energy shield gained for each enemy hit by spells"] = { "EnergyShieldOnHit", flags = ModFlag.Spell },
	["energy shield gained for each enemy hit by your spells"] = { "EnergyShieldOnHit", flags = ModFlag.Spell },
...
local specialModList = {
	...
	["(%d+) life gained for each cursed enemy hit by your attacks"] = function(num) return { mod("LifeOnHit", "BASE", num, nil, ModFlag.Attack, { type = "ActorCondition", actor = "enemy", var = "Cursed"})} end,
	["gain (%d+) life per cursed enemy hit with attacks"] = function(num) return { mod("LifeOnHit", "BASE", num, nil, ModFlag.Attack, { type = "ActorCondition", actor = "enemy", var = "Cursed"})} end,
	["(%d+) mana gained for each cursed enemy hit by your attacks"] = function(num) return { mod("ManaOnHit", "BASE", num, nil, ModFlag.Attack, { type = "ActorCondition", actor = "enemy", var = "Cursed"})} end,
	["gain (%d+) mana per cursed enemy hit with attacks"] = function(num) return { mod("ManaOnHit", "BASE", num, nil, ModFlag.Attack, { type = "ActorCondition", actor = "enemy", var = "Cursed"})} end,
