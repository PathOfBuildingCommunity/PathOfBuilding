...
local modTagList = {
	...
	["per withered debuff on enemy"] = { tag = { type = "Multiplier", var = "WitheredStack", actor = "enemy" } },
	...
	["if you have suppressed spell damage recently"] = { tag = { type = "Condition", var = "SuppressedRecently" } },
	...
	["on hits? with spells?"] = { tag = { type = "Condition", var = "HitSpellRecently" } },
...
local specialModList = {
	...
	["prevent %+(%d+)%% of suppressed spell damage per hit suppressed recently"] = function(num) return { mod("SpellSuppressionEffect", "BASE", num, { type = "Multiplier", var = "HitsSuppressedRecently" }) } end,
