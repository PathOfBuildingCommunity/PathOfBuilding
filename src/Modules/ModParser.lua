...
local specialModList = {
	...
	["non%-projectile chaining lightning skills chain %+1 times"] = { mod("ChainCountMax", "BASE", 1, { type = "SkillType", skillType = SkillType.Projectile, neg = true }, { type = "SkillType", skillType = SkillType.Chaining }, { type = "SkillType", skillType = SkillType.LightningSkill }) },
	-- Leech/Gain on Hit
