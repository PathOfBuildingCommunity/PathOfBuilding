...
local modTagList = {
	...
	["for each (%d+) total mana spent recently"] = function(num) return { tag = { type = "Multiplier", var = "ManaSpentRecently", div = num } } end,
...
local specialModList = {
	...
	["your skills cost no mana during flask effect"] = { mod("ManaCost", "MORE", -100, { type = "Condition", var = "UsingFlask" }) },
