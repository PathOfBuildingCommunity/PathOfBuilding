...
local specialModList = {
	...
	["seismic trap releases an additional wave"] = { mod("MaximumWaves", "BASE", 1, { type = "SkillName", skillNameList = { "Seismic Trap" }, includeTransfigured = true) },
	["lightning spire trap strikes an additional area"] = { mod("MaximumWaves", "BASE", 1, { type = "SkillName", skillNameList = { "Lightning Spire Trap" }, includeTransfigured = true) },
...
local skillNameList = {
	[" corpse cremation " ] = { tag = { type = "SkillName", skillNameList = { "Cremation", "Cremation of Exhuming" }}}, -- Sigh.
}
