...
function buildMode:Init(dbFileName, buildName, buildXML, convertBuild)
	...
	self.displayStats = {
		...
		{ stat = "LifeCost", label = "Life Cost", fmt = "d", color = colorCodes.LIFE, pool = "Life", compPercent = true, lowerIsBetter = true, condFunc = function(v,o) return o.LifeHasCost end, warnFunc = function(v,o) return (o.LifeCostWarning or (v > o.LifeUnreserved)) and "You do not have enough Mana to use a Selected Skill" end },
