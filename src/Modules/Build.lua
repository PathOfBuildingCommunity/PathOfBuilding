...
function buildMode:Init(dbFileName, buildName, buildXML, convertBuild)
	...
	self.displayStats = {
		...
		{ stat = "ManaCost", label = "Mana Cost", fmt = "d", color = colorCodes.MANA, pool = "Mana", compPercent = true, lowerIsBetter = true, condFunc = function(v,o) return o.ManaHasCost end, warnFunc = function(v,o) return (not o.EnergyShieldProtectsMana and (v > o.ManaUnreserved) or (v > o.ManaUnreserved + o.EnergyShield)) and "You do not have enough "..(o.EnergyShieldProtectsMana and "Energy Shield and Mana" or "Mana").." to use a Selected Skill" end },
		...
		{ stat = "ESCost", label = "Energy Shield Cost", fmt = "d", color = colorCodes.ES, pool = "EnergyShield", compPercent = true, lowerIsBetter = true, condFunc = function(v,o) return o.ESHasCost end, warnFunc = function(v,o) return (v > o.EnergyShield) and "You do not have enough Energy Shield to use a Selected Skill" end },
