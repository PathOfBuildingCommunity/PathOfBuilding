...
function buildMode:Init(dbFileName, buildName, buildXML, convertBuild)
	...
	self.displayStats = {
		...
		{ stat = "ManaPerSecondCost", label = "Mana Cost per second", fmt = ".2f/s", color = colorCodes.MANA, compPercent = true, lowerIsBetter = true, condFunc = function(v,o) return o.ManaPerSecondHasCost end },
		...
		{ stat = "ESPerSecondCost", label = "ES Cost per second", fmt = ".2f/s", color = colorCodes.ES, compPercent = true, lowerIsBetter = true, condFunc = function(v,o) return o.ESPerSecondHasCost end },
