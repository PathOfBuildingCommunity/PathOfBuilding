...
function buildMode:Init(dbFileName, buildName, buildXML, convertBuild)
	...
	self.displayStats = {
		...
		{ stat = "BleedDuration", label = "Bleed duration", fmt = ".1fs", compPercent = true},
		...
		{ stat = "IgniteDuration", label = "Ignite duration", fmt = ".1fs", compPercent = true},
		...
		{ stat = "PoisonDuration", label = "Poison duration", fmt = ".1fs", compPercent = true},
