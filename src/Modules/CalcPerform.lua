...
local function doActorAttribsConditions(env, actor)
	...
	if env.mode_combat then
		...
		if modDB:Flag(nil, "BloodShrineOfCrows") then
			...
			modDB:NewMod("ElementalDamageTakenAsChaos", "BASE", m_floor(10 * shrineEffectMod), "Blood Shrine of Crows")
			modDB:NewMod("PhysicalDamageTakenAsChaos", "BASE", m_floor(10 * shrineEffectMod), "Blood Shrine of Crows")
		end
