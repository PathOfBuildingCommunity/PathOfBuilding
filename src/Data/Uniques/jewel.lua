...
Radius: Small
Implicits: 0
{variant:1}Passives in radius of Acrobatics can be allocated without being connected to your tree
{variant:2}Passives in radius of Ancestral Bond can be allocated without being connected to your tree
{variant:3}Passives in radius of Arrow Dancing can be allocated without being connected to your tree
{variant:4}Passives in radius of Avatar of Fire can be allocated without being connected to your tree
{variant:5}Passives in radius of Blood Magic can be allocated without being connected to your tree
{variant:6}Passives in radius of Call to Arms can be allocated without being connected to your tree
{variant:7}Passives in radius of Chaos Inoculation can be allocated without being connected to your tree
{variant:8}Passives in radius of Conduit can be allocated without being connected to your tree
{variant:9}Passives in radius of Crimson Dance can be allocated without being connected to your tree
{variant:10}Passives in radius of Doomsday can be allocated without being connected to your tree
{variant:11}Passives in radius of Eldritch Battery can be allocated without being connected to your tree
{variant:12}Passives in radius of Elemental Equilibrium can be allocated without being connected to your tree
{variant:13}Passives in radius of Elemental Overload can be allocated without being connected to your tree
{variant:14}Passives in radius of Eternal Youth can be allocated without being connected to your tree
{variant:15}Passives in radius of Ghost Reaver can be allocated without being connected to your tree
{variant:16}Passives in radius of Glancing Blows can be allocated without being connected to your tree
{variant:17}Passives in radius of Imbalanced Guard can be allocated without being connected to your tree
{variant:18}Passives in radius of Iron Grip can be allocated without being connected to your tree
{variant:19}Passives in radius of Iron Reflexes can be allocated without being connected to your tree
{variant:20}Passives in radius of Mind Over Matter can be allocated without being connected to your tree
{variant:21}Passives in radius of Minion Instability can be allocated without being connected to your tree
{variant:22}Passives in radius of Mortal Conviction can be allocated without being connected to your tree
{variant:23}Passives in radius of Necromantic Aegis can be allocated without being connected to your tree
{variant:24}Passives in radius of Pain Attunement can be allocated without being connected to your tree
{variant:25}Passives in radius of Perfect Agony can be allocated without being connected to your tree
{variant:26}Passives in radius of Phase Acrobatics can be allocated without being connected to your tree
{variant:27}Passives in radius of Point Blank can be allocated without being connected to your tree
{variant:28}Passives in radius of Resolute Technique can be allocated without being connected to your tree
{variant:29}Passives in radius of Runebinder can be allocated without being connected to your tree
{variant:30}Passives in radius of Supreme Ego can be allocated without being connected to your tree
{variant:31}Passives in radius of The Agnostic can be allocated without being connected to your tree
{variant:32}Passives in radius of The Impaler can be allocated without being connected to your tree
{variant:33}Passives in radius of Unwavering Stance can be allocated without being connected to your tree
{variant:34}Passives in radius of Vaal Pact can be allocated without being connected to your tree
{variant:35}Passives in radius of Wicked Ward can be allocated without being connected to your tree
{variant:36}Passives in radius of Wind Dancer can be allocated without being connected to your tree
{variant:37}Passives in radius of Zealot's Oath can be allocated without being connected to your tree
Corrupted
]],
}
