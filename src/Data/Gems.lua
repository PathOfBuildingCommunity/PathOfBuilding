...
return {
	...
	["Metadata/Items/Gems/SkillGemVaalPowerSiphon"] = {
		...
		tagString = "Critical, Vaal, Attack, Projectile",
		reqStr = 0,
		reqDex = 0,
		reqInt = 100,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemVaalLightningTrap"] = {
		...
		tagString = "Trap, Critical, Vaal, Spell, Projectile, Duration, Lightning",
		reqStr = 0,
		reqDex = 40,
		reqInt = 60,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemVaalBladeVortex"] = {
		...
		tagString = "Critical, Vaal, Spell, AoE, Duration, Physical",
		reqStr = 0,
		reqDex = 100,
		reqInt = 0,
		defaultLevel = 20,
