...
skills["SupportAutomation"] = {
	name = "Automation",
	description = "Supports spell skills that are instant and have no reservation. Cannot support Vaal skills or skills used by totems, traps or mines. Cannot modify the skills of minions.",
	color = 3,
	support = true,
...
skills["SupportDecay"] = {
	...
	description = "Supports any skill that hits enemies.",
	color = 3,
	baseEffectiveness = 2.0355999469757,
...
skills["SupportInfusedChannelling"] = {
	...
	constantStats = {
		{ "support_storm_barrier_damage_taken_when_hit_+%_final_while_channelling", -8 },
	},
	stats = {
		"support_storm_barrier_damage_+%_final",
	},
