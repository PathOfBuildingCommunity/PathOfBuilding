...
skills["BloodOffering"] = {
	...
	statMap = {
		...
		["blood_offering_%_of_lost_life_to_regenerate_as_life_per_second"] = {
			mod("LifeRegen", "BASE", nil, 0, 0, { type = "GlobalEffect", effectType = "Buff" }, { type = "PerStat", stat = "LifeUnreserved", actor = "parent" }),
			mod("Multiplier:BloodOfferingSacrificedLife", "BASE", nil, 0, 0, { type = "GlobalEffect", effectType = "Buff", unscalable=true }, { type = "PerStat", stat = "LifeUnreserved", actor = "parent" }),
			div = 500,
		},
		["blood_offering_life_regenerated_+%_final_per_corpse"] = {
			mod("LifeRegen", "BASE", nil, 0, 0, { type = "GlobalEffect", effectType = "Buff" }, { type = "Multiplier", var = "BloodOfferingSacrificedLife"},  { type = "Multiplier", var = "CorpseConsumedRecently", limit = 5 }),
			mod("LifeRegen", "BASE", nil, 0, 0, { type = "GlobalEffect", effectType = "Buff" }, { type = "Multiplier", var = "BloodOfferingSacrificedLife"},  { type = "Multiplier", var = "CorpseConsumedRecently", limit = 5, actor="parent" }),
			div = 100,
		}
	},
	baseFlags = {
