...
return {
	["CRUEL"] = {
		...
		"You take 6% reduced Extra Damage from Critical Strikes if you've taken a Critical Strike Recently",
	...
	["MERCILESS"] = {
		...
		"You take 8% reduced Extra Damage from Critical Strikes if you've taken a Critical Strike Recently",
