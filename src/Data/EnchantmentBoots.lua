...
return {
	["CRUEL"] = {
		...
		"6% reduced Extra Damage taken from Critical Strikes if you've taken a Critical Strike Recently",
	...
	["MERCILESS"] = {
		...
		"Regenerate 1.5% of Life per second if you were Hit Recently",
		...
		"0.5% of Damage Leeched as Life if you've Killed Recently",
		"8% reduced Extra Damage taken from Critical Strikes if you've taken a Critical Strike Recently",
	...
	["ENDGAME"] = {
		...
		"10% reduced Extra Damage taken from Critical Strikes if you've taken a Critical Strike Recently",
