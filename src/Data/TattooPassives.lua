...
return {
	...
	["nodes"] = {
		...
		["Bitter Frost"] = {
			...
			["activeEffectImage"] = "Art/2DArt/UIImages/InGame/AncestralTrial/PassiveTreeTattoos/KeystoneHinekoraPassiveBG.png", 
			["dn"] = "Bitter Frost", 
			["icon"] = "Art/2DArt/SkillIcons/passives/ColdPureElementalCasterKeystone.png", 
			["id"] = "elementalist_cold_keystone_2990", 
			["isTattoo"] = true, 
			["ks"] = true, 
			["m"] = false, 
			["not"] = false, 
			["overrideType"] = "KeystoneTattoo", 
			["sd"] = {
				[1] = "Enemies Chilled by your Hits have Cold Damage taken increased by Chill Effect", 
				[2] = "Enemies in your Chilling Areas have Cold Damage taken increased by Chill Effect", 
				[3] = "Cannot deal non-Cold Damage", 
				[4] = "Limited to 1 Keystone Tattoo", 
			}, 
			["stats"] = {
				["keystone_cold_purist"] = {
					["fmt"] = "d", 
					["index"] = 1, 
					["max"] = 1, 
					["min"] = 1, 
		...
		["Roiling Tempest"] = {
			...
			["activeEffectImage"] = "Art/2DArt/UIImages/InGame/AncestralTrial/PassiveTreeTattoos/KeystoneHinekoraPassiveBG.png", 
			["dn"] = "Roiling Tempest", 
			["icon"] = "Art/2DArt/SkillIcons/passives/LightningPureElementalCasterKeystone.png", 
			["id"] = "elementalist_lightning_keystone_2991", 
			["isTattoo"] = true, 
			["ks"] = true, 
			["m"] = false, 
			["not"] = false, 
			["overrideType"] = "KeystoneTattoo", 
			["sd"] = {
				[1] = "25% more Maximum Lightning Damage", 
				[2] = "50% less Minimum Lightning Damage", 
				[3] = "Cannot deal non-Lightning Damage", 
				[4] = "Limited to 1 Keystone Tattoo", 
			}, 
			["stats"] = {
				["keystone_lightning_purist"] = {
					["fmt"] = "d", 
					["index"] = 1, 
					["max"] = 1, 
					["min"] = 1, 
		...
		["Voracious Flame"] = {
			...
			["activeEffectImage"] = "Art/2DArt/UIImages/InGame/AncestralTrial/PassiveTreeTattoos/KeystoneHinekoraPassiveBG.png", 
			["dn"] = "Voracious Flame", 
			["icon"] = "Art/2DArt/SkillIcons/passives/FirePureElementalCasterKeystone.png", 
			["id"] = "elementalist_fire_keystone_2989_", 
			["isTattoo"] = true, 
			["ks"] = true, 
			["m"] = false, 
			["not"] = false, 
			["overrideType"] = "KeystoneTattoo", 
			["sd"] = {
				[1] = "You can inflict an additional Ignite on each Enemy", 
				[2] = "Base Ignite Duration is 1 second", 
				[3] = "25% less Damage with Ignite", 
				[4] = "Cannot deal non-Fire Damage", 
				[5] = "Limited to 1 Keystone Tattoo", 
			}, 
			["stats"] = {
				["keystone_fire_purist"] = {
					["fmt"] = "d", 
					["index"] = 1, 
					["max"] = 1, 
					["min"] = 1, 
