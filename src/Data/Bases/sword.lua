...
itemBases["Rusted Spike"] = {
	...
	influenceTags = { shaper = "rapier_shaper", elder = "rapier_elder", adjudicator = "rapier_adjudicator", basilisk = "rapier_basilisk", crusader = "rapier_crusader", eyrie = "rapier_eyrie", cleansing = "rapier_cleansing", tangle = "rapier_tangle" },
