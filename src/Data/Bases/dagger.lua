...
itemBases["Carving Knife"] = {
	...
	subType = "Rune",
	socketLimit = 3,
	tags = { onehand = true, one_hand_weapon = true, weapon = true, dagger = true, rune_dagger = true, default = true, },
	implicit = "30% increased Global Critical Strike Chance",
	implicitModTypes = { { "critical" }, },
...
itemBases["Flickerflame Blade"] = {
	...
	subType = "Rune",
	socketLimit = 3,
	tags = { onehand = true, not_for_sale = true, one_hand_weapon = true, weapon = true, rune_dagger = true, dagger = true, default = true, },
...
itemBases["Flashfire Blade"] = {
	...
	subType = "Rune",
	socketLimit = 3,
	tags = { onehand = true, not_for_sale = true, one_hand_weapon = true, weapon = true, dagger = true, rune_dagger = true, default = true, },
