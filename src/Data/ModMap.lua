...
return {
	...
	Prefix = {
		...
		{ val = "Savage", label = "Enemy increased Damage" .. "                                                                ".."Savage", range = true },
		...
		{ val = "Profane", label = "Enemy Physical As Extra Chaos                                                                 Monsters deal to Damage Inflict Withered for seconds on Hit Profane", range = true },
	...
	Suffix = {
		...
		{ val = "of Exposure", label = "-X% maximum Resistances" .. "                                                                ".."of Exposure", range = true },
		...
		{ val = "of Toughness", label = "Enemy takes red. Extra Crit Damage:" .. "                                                                ".."of Toughness", range = true },
		...
		{ val = "of Deadliness", label = "Enemy Critical Strike                                                                 Monsters have to increased Chance Monster Multiplier".."of Deadliness", range = true },
	},
}