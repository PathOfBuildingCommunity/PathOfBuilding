...
return {
	...
	Prefix = {
		{ val = "Armoured", label = "Enemy Physical Damage Reduction" .. "                                                                ".."Armoured" },
		{ val = "Hexproof", label = "Enemy is Hexproof?" .. "                                                                ".."Hexproof" },
		{ val = "Hexwarded", label = "Less effect of Curses on enemy" .. "                                                                ".."Hexwarded" },
		{ val = "Resistant", label = "Enemy has Elemental / Chaos Resistances" .. "                                                                ".."Resistant" },
		{ val = "Unstoppable", label = "Enemy Cannot Be Slowed                                                                 Monsters Taunted Action Speed modified below base value".."Unstoppable" },
		{ val = "Impervious", label = "Enemy chance to avoid Poison and Bleed:" .. "                                                                 ".."Impervious" },
		{ val = "Savage", label = "Enemy increased Damage" .. "                                                                ".."Savage" },
		{ val = "Burning", label = "Enemy Physical As Extra Fire                                                                 Monsters deal to  Damage".."Burning" },
		{ val = "Freezing", label = "Enemy Physical As Extra Cold                                                                 Monsters deal to Damage".."Freezing" },
		{ val = "Shocking", label = "Enemy Physical As Extra Lightning                                                                 Monsters deal to Damage".."Shocking" },
		{ val = "Profane", label = "Enemy Physical As Extra Chaos                                                                 Monsters deal to Damage Inflict Withered for seconds on Hit Profane" },
		{ val = "Fleet", label = "Enemy increased Speed                                                                 to  Monster Movement Attack Cast".."Fleet" },
		{ val = "Impaling", label = "Enemy chance to Impale                                                                 Monsters have with Attacks Impaling" },
	...
	Suffix = {
		...
		{ val = "of Exposure", label = "-X% maximum Resistances" .. "                                                                ".."of Exposure" },
		{ val = "of Impotence", label = "Less Area of Effect:" .. "                                                                ".."of Impotence" },
		{ val = "of Insulation", label = "Enemy chance to avoid Elemental Ailments:" .. "                                                                ".."of Impotence" },
		...
		{ val = "of Stasis", label = "Cannot Regenerate Life, Mana or ES" .. "                                                                ".."of Stasis" },
		...
		{ val = "of Doubt", label = "Reduced Non-Curse Aura Effect                                                                 Players have Auras from Skills".."of Doubt" },
