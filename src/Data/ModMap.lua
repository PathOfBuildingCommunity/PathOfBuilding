...
return {
	...
	Prefix = {
		...
		{ val = "Unstoppable", label = "Enemy Cannot Be Slowed                                 Monsters cannot be Taunted Monsters' Action Speed cannot be modified below base value Unstoppable" },
		...
		{ val = "Burning", label = "Enemy Phys As Fire                                 Monsters deal to extra Physical Damage as Burning" },
		{ val = "Freezing", label = "Enemy Phys As Cold                                 Monsters deal to extra Physical Damage as Freezing" },
		{ val = "Shocking", label = "Enemy Phys As Lightning                                 Monsters deal to extra Physical Damage as Shocking" },
