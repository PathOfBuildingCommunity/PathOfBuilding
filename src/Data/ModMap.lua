...
return {
	...
	Prefix = {
		...
		{ val = "Resistant", label = "Enemy has Elemental / ^xD02090Chaos ^7Resist                                                                  Resistances Resistant" },
		...
		{ val = "Profane", label = "Enemy Physical As Extra Chaos                                                                  Monsters gain to their Damage Inflict Withered for seconds on Hit Profane", range = true },
		...
		{ val = "Impaling", label = "Enemy chance to Impale                                                                  Monsters' Attacks have on Hit Impaling" },
