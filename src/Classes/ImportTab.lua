...
You can get this from your web browser's cookies while logged into the Path of Exile website.
	...
	self.controls.importCodeIn = new("EditControl", {"TOPLEFT",self.controls.importCodeHeader,"BOTTOMLEFT"}, 0, 4, 250, 20, "", nil, "^%w_%-=:/.%s", nil, function(buf)
		if #buf == 0 then
...
function ImportTabClass:OpenImportFromWebsitePopup(str)
	...
	if str then
		...
		controls.edit.dontSelectOnFocus = true
	end
