--- # TimeSpan
--- https://raw.githubusercontent.com/ProphetLamb/PathOfBuilding/0d0b16ed98694de30ab5327f4bcc2208be54987f/src/Modules/TimeSpan.lua
---
...
function TimeSpan:getDays()
  return math.floor(self.ticks / TimeSpan.DAY.ticks)
end
