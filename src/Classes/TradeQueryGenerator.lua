...
function TradeQueryGeneratorClass:ExecuteQuery()
	...
	if eldritchOption and eldritchOption:find("^Keep") and
		...
		(isIgnoredSelection(self.calcContext.options.influence1) or isNoInfluenceSelection(self.calcContext.options.influence1)) and
		(isIgnoredSelection(self.calcContext.options.influence2) or isNoInfluenceSelection(self.calcContext.options.influence2)) then
