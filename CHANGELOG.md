### 1.4.110 - 2019/10/26
As of this update I am once again able to add and update minions, which hasn't been possible since 3.0:
 * Added the following minions:
    * Agony Crawler (Herald of Agony)
 * Added proper DPS calculation for Summoned Phantasm
