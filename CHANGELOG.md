...
- Add support for deal 10% less damage on Indomitable Resolve [\#4688](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4688) ([Regisle](https://github.com/Regisle))
- Add support for used Life flask in the past 10 seconds [\#4687](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4687) ([Regisle](https://github.com/Regisle))
...
- Add support for some modifiers to enemy damage [\#4685](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4685) ([Regisle](https://github.com/Regisle))
...
- Add support for Non-Vaal gem modifiers [\#4711](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4711) ([Nostrademous](https://github.com/Nostrademous))
...
- Add support for armour applies to ele damage [\#4673](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4673) ([Regisle](https://github.com/Regisle))
...
- Add support for Arrow Dancing [\#4779](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4779) ([QuickStick123](https://github.com/QuickStick123))
- Add new uniques [\#4774](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4774) ([QuickStick123](https://github.com/QuickStick123))
- Add support for counting Mastery Type allocations [\#4746](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4746) ([Nostrademous](https://github.com/Nostrademous))
...
- Support for inverted reflection stats [\#4756](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4756) ([Nostrademous](https://github.com/Nostrademous))
...
- Add support for stacking max shock [\#4750](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4750) ([Lilylicious](https://github.com/Lilylicious))
- Add support for new trickster [\#4749](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4749) ([Lilylicious](https://github.com/Lilylicious))
- Add support for action speed caps [\#4749](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4749) ([Lilylicious](https://github.com/Lilylicious))
...
- Add support for Lightning Conduit's New Trigger Flag [\#4802](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4802) ([Nostrademous](https://github.com/Nostrademous))
- Add support for enemy overwhelm and correct minor issues with damage reduction [\#4705](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4705) ([QuickStick123](https://github.com/QuickStick123))
### User Interface
...
- Fix Node power sorting at infinite values [\#4617](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4617) ([Regisle](https://github.com/Regisle))
...
- Fix imported items variable percentages [\#4735](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4735) ([Wires77](https://github.com/Wires77))
- Batch of unique update. All remaining from M to O [\#4767](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4767) ([Sinured](https://github.com/Sinured))
- Batch of uniques update. All missing starting with T [\#4763](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4763) ([Sinured](https://github.com/Sinured))
- Batch of uniques update. All missing starting with R [\#4760](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4760) ([Sinured](https://github.com/Sinured))
- Batch of uniques update. All missingfrom D to L [\#4769](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4769) ([Sinured](https://github.com/Sinured))
- Batch of uniques update. All missing starting with S [\#4753](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4753) ([Sinured](https://github.com/Sinured))
- Update Blood of the Karui Life recovered and wording  [\#4729](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4729) ([Sinured](https://github.com/Sinured))
...
- Update brittle values [\#4696](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4696) ([Lexy](https://github.com/learn2draw))
- Update batch 1 of uniques. [\#4747](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4747) ([QuickStick123](https://github.com/QuickStick123))
- Update batch 2 of uniques. [\#4751](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4751) ([QuickStick123](https://github.com/QuickStick123))
- Update batch 3 of Uniques [\#4754](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4754) ([QuickStick123](https://github.com/QuickStick123))
- No longer obtainable uniques [\#4748](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4748) ([QuickStick123](https://github.com/QuickStick123))
- Update batch 4 of uniques. [\#4757](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4757) ([QuickStick123](https://github.com/QuickStick123))
- Update Replica Bitterdream [\#4775](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4775) ([QuickStick123](https://github.com/QuickStick123))
- Update Ngamahu's Sign [\#4755](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4755) ([Nightblade](https://github.com/Nightblade))
- Update Bitterdream [\#4702](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4702) ([Lexy](https://github.com/learn2draw))
- Added Thrusting as a base subType [\#4720](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4720) ([Nostrademous](https://github.com/Nostrademous))
...
- Update cloak of defiance [\#4700](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4700) ([Lexy](https://github.com/learn2draw))
- Update Omniscience [\#4699](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4699) ([Lexy](https://github.com/learn2draw))
- Update melding of the flesh [\#4698](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4698) ([Lexy](https://github.com/learn2draw))
...
### Other changes
- Fix various typos in "safe" text [\#4668](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4668) ([Nightblade](https://github.com/Nightblade))
...
- Update Manastorm and Kongming's Stratagem to new bases. [\#4783](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4783) ([QuickStick123](https://github.com/QuickStick123))
