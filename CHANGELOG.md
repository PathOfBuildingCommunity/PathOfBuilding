...
[Full Changelog](https://github.com/PathOfBuildingCommunity/PathOfBuilding/compare/v2.21.1...v2.23.0)

<!-- Release notes generated using configuration in .github/release.yml at dev -->

## What's Changed
### New to Path of Building
- Add support for Frostblink CDR from nearby enemy [\#4986](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4986) ([Nostrademous](https://github.com/Nostrademous))
- Add support for "nearby allies have culling strike" [\#4921](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4921) ([Sinured](https://github.com/Sinured))
- Add button to filter unique source [\#4920](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4920) ([QuickStick123](https://github.com/QuickStick123))
- Improve avoidance calcs [\#4883](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4883) ([Regisle](https://github.com/Regisle))
- Add reservation scaling with stages for blood sacrament [\#4583](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4583) ([QuickStick123](https://github.com/QuickStick123))
- Fix: Add support for Cold Conduction cluster jewel notable [\#5021](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5021) ([Nostrademous](https://github.com/Nostrademous))
- Re-order the leagues dropdown in the import menu [\#5015](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5015) ([Schroedi](https://github.com/Schroedi))
- Implement parsing for some currently unsupported reflected mods. [\#5014](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5014) ([Paliak](https://github.com/Paliak))
- Add google sheets parsing to build import [\#4899](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4899) ([JadedCricket](https://github.com/JadedCricket))
...
- Fix Barrage and Barrage Support ambiguity [\#5029](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5029) ([Paliak](https://github.com/Paliak))
- Add build pricing and item optimization to Items Tab [\#3885](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/3885) ([Nostrademous](https://github.com/Nostrademous))
- Add support for "chance for flasks you use to not consume charges" [\#4766](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4766) ([Lothrik](https://github.com/Lothrik))
- Extend default gem level functionality [\#4724](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4724) ([Lothrik](https://github.com/Lothrik))
- Add breakdown for Boneshatter self damage [\#4734](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4734) ([Lilylicious](https://github.com/Lilylicious))
- Add support for Soul Eater stack limit [\#5137](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5137) ([TPlant](https://github.com/PJacek))
- Add support for Anomalous Predator [\#5135](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5135) ([TPlant](https://github.com/PJacek))
- Add 3.20 Tree [\#5188](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5188) ([Regisle](https://github.com/Regisle))
- Add support for Hex Master [\#5193](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5193) ([QuickStick123](https://github.com/QuickStick123))
- Add support for some more eldritch boss mods. [\#5227](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5227) ([QuickStick123](https://github.com/QuickStick123))
- Feat: update Data/QueryMods.lua for Finding Best Items via Trader [\#5226](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5226) ([Nostrademous](https://github.com/Nostrademous))
- Display resource costs per second [\#5199](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5199) ([Lilylicious](https://github.com/Lilylicious))
- Implement 'Your Blessing Skills are Disabled' for Essence Worm [\#5121](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5121) ([Paliak](https://github.com/Paliak))
- Add spectre Deadly Tarantula [\#5216](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5216) ([fialhoFabio](https://github.com/fialhoFabio))
...
- Implement Seismic / Lightning Spire Trap DPS [\#5212](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5212) ([Edvinas-Smita](https://github.com/Edvinas-Smita))
- Max hit improvement [\#5196](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5196) ([Edvinas-Smita](https://github.com/Edvinas-Smita))
- Implement ring reflection from Kalandra's Touch. [\#5120](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5120) ([Paliak](https://github.com/Paliak))
- Add Armour Cruncher Spectre [\#5201](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5201) ([fialhoFabio](https://github.com/fialhoFabio))
- Add max calculcated fuses for Expl Arrow to calcs [\#5209](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5209) ([dbronkalla06](https://github.com/dbronkalla06))
- Added Mod Tooltip [\#5203](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5203) ([QuickStick123](https://github.com/QuickStick123))
- fix: Fix Kalisa's Grace crit chance modifier not working. [\#5124](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5124) ([michelrtm](https://github.com/michelrtm))
- Add support for several curse mods [\#5197](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5197) ([QuickStick123](https://github.com/QuickStick123))
- update timeless jewels to 3.20 tree [\#5218](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5218) ([Regisle](https://github.com/Regisle))
- New uniques 3.20 [\#5185](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5185) ([QuickStick123](https://github.com/QuickStick123))
- Calculate maximum sustainable trauma stacks [\#5049](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5049) ([QuickStick123](https://github.com/QuickStick123))
- Automatically apply Energy Blade buff [\#5016](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5016) ([QuickStick123](https://github.com/QuickStick123))
...
- Implement  "Quicksilver Flasks you Use also apply to nearby Allies" mod on Victario's Flight [\#5095](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5095) ([Paliak](https://github.com/Paliak))
- Make socket group sort order persistent [\#4804](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4804) ([Lothrik](https://github.com/Lothrik))
- Add support for low tolerance [\#4792](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4792) ([Regisle](https://github.com/Regisle))
- Remove overkill damage and fix some bugs in eHP [\#4915](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4915) ([QuickStick123](https://github.com/QuickStick123))
- Add Reaper's Consume buff [\#3088](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/3088) ([Wires77](https://github.com/Wires77))
- Add  Dawnstrider [\#5235](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5235) ([QuickStick123](https://github.com/QuickStick123))
- Add support for burning ground from Essence of Hysteria [\#4825](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4825) ([Regisle](https://github.com/Regisle))
- Add warnings if skill cost exceeds avilable resource [\#5019](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5019) ([Paliak](https://github.com/Paliak))
- Add initial support for enemy block chance [\#4648](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4648) ([Regisle](https://github.com/Regisle))
- Add support for socketed in specific socket color mods found on Dialla's Malefaction, Malachai's Artifice, Doomsower [\#4981](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4981) ([Paliak](https://github.com/Paliak))
...
- Add variants for the Monkey Paw and Avian Twins Talismans [\#4876](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4876) ([moojustice1](https://github.com/moojustice1))
### Fixed Crashes
- Use Life/EnergyShieldRegenRecovery for power builder [\#4945](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4945) ([deathbeam](https://github.com/deathbeam))
- fix crash for pvp when checking support gems [\#5036](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5036) ([Regisle](https://github.com/Regisle))
- FIX crash when generating fall back weights caused by missing source [\#5055](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5055) ([Paliak](https://github.com/Paliak))
- Fix: crash on crafting certain quirky items [\#5204](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5204) ([Nostrademous](https://github.com/Nostrademous))
- Fix jewel implict button crashing [\#5211](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5211) ([QuickStick123](https://github.com/QuickStick123))
- Fix arcanist brand giving brand skill flag to gems breaking stuff. [\#4966](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4966) ([QuickStick123](https://github.com/QuickStick123))
- Fix a crash when loading spectres with discontinous levels [\#4230](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4230) ([Wires77](https://github.com/Wires77))
### User Interface
...
- Fix incorrect timeless jewel ring colors when searching a node on the passive tree [\#5142](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5142) ([Wires77](https://github.com/Wires77))
...
- Adjust sample Brittle effects [\#5136](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5136) ([TPlant](https://github.com/PJacek))
- Correct Fanaticism tooltip [\#5103](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5103) ([MeDott29](https://github.com/MeDott29))
- Add missing poison multiplier breakdown for spells [\#5090](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5090) ([Wires77](https://github.com/Wires77))
...
- Fix UI spacing on Items tab [\#5222](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5222) ([Wires77](https://github.com/Wires77))
- Relabel "Total DPS" to "Hit DPS" [\#5172](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5172) ([raylu](https://github.com/raylu))
- Add button to go to privacy settings [\#5171](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5171) ([raylu](https://github.com/raylu))
### Fixed Bugs
- fix watchers eye export [\#4935](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4935) ([Regisle](https://github.com/Regisle))
- Fix parsing of Grand Spectrum for minions [\#4965](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4965) ([deathbeam](https://github.com/deathbeam))
- Fix energy blade applying each iteration. [\#4919](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4919) ([QuickStick123](https://github.com/QuickStick123))
- Fix Cluster Jewels not showing DPS stats in item crafter [\#5022](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5022) ([LocalIdentity](https://github.com/LocalIdentity))
- Fix count being nil when importing a build and add default altQu… [\#5047](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5047) ([Paliak](https://github.com/Paliak))
- Fix "tag" being used in place of "tagList" causing only the first tag to be added [\#5039](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5039) ([Paliak](https://github.com/Paliak))
- Show Increased Global Energy Shield on Calcs [\#5061](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5061) ([randomflyingtaco](https://github.com/randomflyingtaco))
...
- Fix: Fetching Search Query via HTML is no longer allowed [\#5210](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5210) ([Nostrademous](https://github.com/Nostrademous))
- Fix: Weighted Search Category fix Jewels [\#5205](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5205) ([Nostrademous](https://github.com/Nostrademous))
...
- Fix influence modifers not behaving correctly and rune daggers missing rune dagger tag. [\#4975](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4975) ([QuickStick123](https://github.com/QuickStick123))
- Fix dps comparison not working correctly when using the saviour and using overrides [\#4635](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4635) ([Paliak](https://github.com/Paliak))
- Fix parsing for some pobb.in links [\#5078](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5078) ([Dullson](https://github.com/Dullson))
### Other changes
- Clean up "Aul's Uprising (Intelligence)" mod-list  [\#4989](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4989) ([Torchery](https://github.com/Torchery))
- Change Vorana's March to be auto generated [\#4979](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4979) ([LocalIdentity](https://github.com/LocalIdentity))
...
- fix spelling in ItemsTab.lua [\#4960](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4960) ([Nightblade](https://github.com/Nightblade))
- Update stormfire and add support for mod. [\#4950](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4950) ([QuickStick123](https://github.com/QuickStick123))
- FIX: fix jewels applying to the same node twice if overlapping [\#4948](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4948) ([Paliak](https://github.com/Paliak))
- Remove Dot Ground incorrect caps [\#4934](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4934) ([Regisle](https://github.com/Regisle))
- Fix Lucky Attack Damage Applying to spells [\#5059](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5059) ([QuickStick123](https://github.com/QuickStick123))
- Fix ice spear enchant not applying to all projectiles skill part. [\#5045](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5045) ([Paliak](https://github.com/Paliak))
- Fix some stats with bloodstorm conditionals being considered a buff [\#5046](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5046) ([QuickStick123](https://github.com/QuickStick123))
- Shock effect should apply to shocked ground [\#5038](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5038) ([Paliak](https://github.com/Paliak))
- Add rage generation flag to chains of empacipation [\#5035](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5035) ([QuickStick123](https://github.com/QuickStick123))
...
- FIX: Ailement mods from skill active skill gems not applying [\#5003](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5003) ([Paliak](https://github.com/Paliak))
...
- Revert "FIX: fix jewels applying to the same node twice if overlapping" [\#5065](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5065) ([Paliak](https://github.com/Paliak))
- Fix Thread of Hope allowing you to allocate ascendancy nodes [\#5067](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5067) ([LocalIdentity](https://github.com/LocalIdentity))
- Improve handling of unscalable mods and fix some mods from alternate qualities not applying. [\#4906](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4906) ([Paliak](https://github.com/Paliak))
- Fix support gems not adding their flags if they themselves require a flag added by a support gem lower in the supportList [\#4886](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4886) ([Paliak](https://github.com/Paliak))
- Fix mistake in ModParser. [\#5088](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5088) ([Paliak](https://github.com/Paliak))
- Fix Lightning Conduit More damaging with hits missing hit tag. [\#5099](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5099) ([QuickStick123](https://github.com/QuickStick123))
...
- Fix Devotion not working with minion mods [\#5133](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5133) ([TPlant](https://github.com/PJacek))
...
- Truncate resistances. [\#5115](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5115) ([Paliak](https://github.com/Paliak))
- fix punctuation [\#5082](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5082) ([Nightblade](https://github.com/Nightblade))
...
- Remove curse effect on bosses [\#5187](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5187) ([QuickStick123](https://github.com/QuickStick123))
- fixes non-curse hex skills treated as curse skills #5170 [\#5182](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5182) ([kolhell](https://github.com/kolhell))
...
- fix spelling/punctuation [\#5147](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5147) ([Nightblade](https://github.com/Nightblade))
...
- untying chill from frozen PathOfBuildingCommunity/PathOfBuilding#4144 [\#5189](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5189) ([kolhell](https://github.com/kolhell))
...
- Fix "no reservation" mods affecting cost of blessings. [\#5159](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5159) ([Paliak](https://github.com/Paliak))
- Fixes weapon range on weapons not counting towards cyclone aoe [\#5192](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5192) ([QuickStick123](https://github.com/QuickStick123))
...
- Fix PobTrader HTML parsing for search queries [\#5217](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5217) ([Dullson](https://github.com/Dullson))
...
- Correctly apply elemental hits area radius mod [\#5225](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5225) ([QuickStick123](https://github.com/QuickStick123))
- Fix: make URL update to league selection [\#5224](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5224) ([Nostrademous](https://github.com/Nostrademous))
- Fix: Icenova interaction with GreaterSpellEcho and AwakenedSpellecho on Casting on Frostbolt [\#4733](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4733) ([Sinured](https://github.com/Sinured))
- Fix shav's revelation removing life recharge. [\#5165](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5165) ([Paliak](https://github.com/Paliak))
- Correctly apply mod precision in item editor and fix assassian's mark scaling. [\#5050](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5050) ([QuickStick123](https://github.com/QuickStick123))
- Fix Skill Costs [\#5009](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5009) ([QuickStick123](https://github.com/QuickStick123))
- Stop support gems from using minionTypes to determine compatibility with minion attack skills [\#4628](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4628) ([Paliak](https://github.com/Paliak))
- Fix dagger mastery and radius jewels applying to masteries. [\#5089](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5089) ([Paliak](https://github.com/Paliak))
- Fix Varunastra not working with Nightblade support [\#5158](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5158) ([Paliak](https://github.com/Paliak))
- Update pledge of hands and atzri's disfavour sources [\#5234](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5234) ([QuickStick123](https://github.com/QuickStick123))
- Update Unique wording differences [\#4952](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4952) ([QuickStick123](https://github.com/QuickStick123))
...
- Fix Absolution spell hit counted multiple times in the Total DPS [\#4653](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4653) ([APXEOLOG](https://github.com/APXEOLOG))
- Fix spelling errors [\#5237](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5237) ([Nightblade](https://github.com/Nightblade))
...
- Fix Scorching Ray exposure not applying when using calculate maximum sustainable stages option [\#5164](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5164) ([Paliak](https://github.com/Paliak))
