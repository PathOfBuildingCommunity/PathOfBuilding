...
- Fix Voltaxic Burst enchant [\#3016](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/3016) ([LocalIdentity](https://github.com/LocalIdentity))

**Merged pull requests:**

- Prevent build code from being interpreted as markdown [\#3019](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/3019) ([ppoelzl](https://github.com/ppoelzl))
- updated dendrobate with new gem name [\#3013](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/3013) ([pundm](https://github.com/pundm))
- Added new Expedition uniques [\#3012](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/3012) ([Wires77](https://github.com/Wires77))
