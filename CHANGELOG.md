...
[Full Changelog](https://github.com/PathOfBuildingCommunity/PathOfBuilding/compare/v2.42.0...v2.44.0)

<!-- Release notes generated using configuration in .github/release.yml at dev -->

## What's Changed
### New to Path of Building
- Add and update new 3.24 uniques [\#7528](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7528) ([LocalIdentity](https://github.com/LocalIdentity))
- Implement Call to Arms gem [\#7632](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7632) ([Paliak](https://github.com/Paliak))
- Added flasks on template list #4990 [\#7618](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7618) ([n1tr0xs](https://github.com/n1tr0xs))
- Implement wisps support [\#7532](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7532) ([Paliak](https://github.com/Paliak))
- Implement Automation support/skill [\#7558](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7558) ([Paliak](https://github.com/Paliak))
- New Notable Support - Incorporeal [\#7677](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7677) ([Nostrademous](https://github.com/Nostrademous))
- New Notable - Mixed Munitions [\#7676](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7676) ([Nostrademous](https://github.com/Nostrademous))
- Add support for inc brand aoe after 50% attached duration mastery [\#7683](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7683) ([Nerotox](https://github.com/Nerotox))
...
- Add support for unholy might on block staff mastery [\#7669](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7669) ([Nerotox](https://github.com/Nerotox))
- Add support for stun cull mace mastery [\#7668](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7668) ([Nerotox](https://github.com/Nerotox))
- Add support for additional strike targets mod & Ancestral Call Support [\#7689](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7689) ([Nerotox](https://github.com/Nerotox))
- Add support for conditional Quantity/Rarity modifiers & Bisco's [\#7688](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7688) ([Nerotox](https://github.com/Nerotox))
...
- Add support for Maim, Hinder, Impale, CB, Silence, Blind, Knockback Immunity [\#7686](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7686) ([Nerotox](https://github.com/Nerotox))
- Adds support for the "%d more recovery if used while on low life" Life flask mod [\#7477](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7477) ([Nerotox](https://github.com/Nerotox))
- Make Custom Modifiers input resizable + Add reusable component [\#7509](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7509) ([Yoshiitsune](https://github.com/Yoshiitsune))
- Add 3.25 passive tree [\#7693](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7693) ([Regisle](https://github.com/Regisle))
- Add 3.25 Ruthless Tree [\#7694](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7694) ([Regisle](https://github.com/Regisle))
- Update endurance charges and jugg [\#7698](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7698) ([Regisle](https://github.com/Regisle))
- cannibalistic rite Life Cost [\#7702](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7702) ([Regisle](https://github.com/Regisle))
- 3 25 unique changes [\#7700](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7700) ([Regisle](https://github.com/Regisle))
- Chance To Ignore Enemy Physical Damage Reduction [\#7709](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7709) ([Regisle](https://github.com/Regisle))
- Add support for linking sets through Loadouts [\#7672](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7672) ([Peechey](https://github.com/Peechey))
- Add parsing for new dead eye far shot notable [\#7713](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7713) ([Paliak](https://github.com/Paliak))
- 3 25 new uniques [\#7708](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7708) ([Regisle](https://github.com/Regisle))
- Gladiator rework [\#7704](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7704) ([Regisle](https://github.com/Regisle))
...
- Add support for removing all Tattoos [\#7346](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7346) ([Peechey](https://github.com/Peechey))
- Improve power calculator speed [\#6828](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/6828) ([Regisle](https://github.com/Regisle))
- Improve power report speed when culling by distance [\#6829](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/6829) ([Regisle](https://github.com/Regisle))
- Implement handling for double exerts mod from berserker ascendancy [\#7745](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7745) ([Paliak](https://github.com/Paliak))
- Add support for banner modifiers and valour on tree [\#7746](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7746) ([Regisle](https://github.com/Regisle))
- Update Wand Crit Chance and Attack Speed [\#7753](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7753) ([HashBR](https://github.com/HashBR))
- EHP lucky and unlucky rework [\#7730](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7730) ([Regisle](https://github.com/Regisle))
- Update perfect agony keystone [\#7725](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7725) ([Paliak](https://github.com/Paliak))
- Implement support for new anointable nodes [\#7712](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7712) ([Paliak](https://github.com/Paliak))
- Retaliation skills [\#7696](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7696) ([Regisle](https://github.com/Regisle))
- Rage Rework [\#7695](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7695) ([Regisle](https://github.com/Regisle))
- Add support for spark maximum hits mode [\#7690](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7690) ([Nerotox](https://github.com/Nerotox))
...
- [3.25] Vaal Pact implementation [\#7732](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7732) ([Nostrademous](https://github.com/Nostrademous))
- Support Warden [\#7707](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7707) ([Nerotox](https://github.com/Nerotox))
- added Ynda's Stand belt's Armour Evasion to Ward Conversion mod [\#7742](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7742) ([acoudray](https://github.com/acoudray))
...
- QoL Enums Data file was added, Trade Data relative was added [\#7275](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7275) ([justjuangui](https://github.com/justjuangui))
- Add a tooltip stat-diff toggle to Items tab [\#7269](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7269) ([Nightblade](https://github.com/Nightblade))
- Add supports for Multi mine/trap throws [\#7662](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7662) ([NL908](https://github.com/NL908))
...
- Enemy dot skills [\#6809](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/6809) ([Regisle](https://github.com/Regisle))
- Tinctures [\#7749](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7749) ([Regisle](https://github.com/Regisle))
...
- Champion foritfy [\#7773](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7773) ([Regisle](https://github.com/Regisle))
- Use pre-armour physical damage as base damage for impale damage calculation [\#7779](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7779) ([bdemolder](https://github.com/bdemolder))
...
### Fixed Crashes
- Fix breakdown crash when using Crit Chance Perandus Pact [\#7617](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7617) ([n1tr0xs](https://github.com/n1tr0xs))
- Fix error when toggling 'Include Enchants' checkbox in trader [\#7572](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7572) ([teroshan](https://github.com/teroshan))
...
- Redesigned the Import Chararacter menu to improve readability [\#7492](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7492) ([ryuukk](https://github.com/ryuukk))
- Correct subsection layouting for calcs tab [\#7661](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7661) ([trimbe](https://github.com/trimbe))
- Allow children of PopupDialogs to process input events first [\#7655](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7655) ([trimbe](https://github.com/trimbe))
- Beautify gem filtering buttons [\#7488](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7488) ([ryuukk](https://github.com/ryuukk))
- Always show max ignite stacks [\#7630](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7630) ([n1tr0xs](https://github.com/n1tr0xs))
...
- Preselect current loadout based on currently selected tree [\#7762](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7762) ([deathbeam](https://github.com/deathbeam))
...
### Fixed Calculations
- Use less damage mod for Elemancer instead of resistance overrides [\#7652](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7652) ([Paliak](https://github.com/Paliak))
...
- Fix spellsinger triggered skill trigger rate not being capped by spellslinger cooldown [\#7631](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7631) ([Paliak](https://github.com/Paliak))
- Fix adorned multiplying implicit and explicit mods individually [\#7647](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7647) ([KaoXinRei](https://github.com/KaoXinRei))
- Fix Ngamahu, Flame's Advance working correctly with Timeless jewels [\#7611](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7611) ([NL908](https://github.com/NL908))
...
- Show Trap Cooldown for Trap Supported Spell in Black Zenith [\#7595](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7595) ([NL908](https://github.com/NL908))
- Use duration as pseudo cooldown for shattershard [\#7637](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7637) ([Paliak](https://github.com/Paliak))
- Support Cold Snap more chill effect quality [\#7566](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7566) ([0xjc](https://github.com/0xjc))
- Fix exclude anoint mod lines for item cond match [\#7552](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7552) ([Paliak](https://github.com/Paliak))
...
- Fix "Deal 10% more Chaos Damage to enemies which have Energy Shield" chaos mastery should be limited to hits and ailments #7582 [\#7620](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7620) ([n1tr0xs](https://github.com/n1tr0xs))
- Update bandit rewards and Fellshrine Reward [\#7682](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7682) ([Paliak](https://github.com/Paliak))
...
- Fix for Determined Survivor Block Chance [\#7733](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7733) ([dicsantana](https://github.com/dicsantana))
- Fix chieftain's damage conversion [\#7750](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7750) ([Paliak](https://github.com/Paliak))
...
- correct The Light of Meaning crit chance [\#7724](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7724) ([Regisle](https://github.com/Regisle))
- fix(7622): store widowhail multiplier & apply to clones [\#7623](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7623) ([FWidm](https://github.com/FWidm))
- fixed modifiers to "[Any Damage] with melee skills" not working for DoT [\#7735](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7735) ([DieMango](https://github.com/DieMango))
...
- Fix incorrect calculation of effecive crit/hit chance for triggers when using skills that hit with both weapons at the same time [\#7758](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7758) ([Paliak](https://github.com/Paliak))
- Fix trigger chance apping to self triggers that assume max rate [\#7760](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7760) ([Paliak](https://github.com/Paliak))
...
- Fix kalandra's touch implicits and mult interactions [\#7634](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7634) ([Paliak](https://github.com/Paliak))
- Fix Forbidden Flesh&Flame (Duellist) Impact doesn't update required class. [\#7628](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7628) ([n1tr0xs](https://github.com/n1tr0xs))
...
- Fix tree pathing [\#7723](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7723) ([Regisle](https://github.com/Regisle))
- Fix Degger mastery not working with Varunastra [\#7738](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7738) ([Paliak](https://github.com/Paliak))
- Apply Strength of Blood PDR only while leeching [\#7783](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7783) ([Nerotox](https://github.com/Nerotox))
...
- Fix Curtain Call PoB description does not match with in-game. [\#7660](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7660) ([n1tr0xs](https://github.com/n1tr0xs))
- Fix the stats of "The Dark Seer" unique sceptre [\#7685](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7685) ([Nerotox](https://github.com/Nerotox))
- Fix mod missing from current verison. Move mod line [\#7736](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7736) ([Paliak](https://github.com/Paliak))
...
- Generate keystone items from tree data [\#7770](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7770) ([trimbe](https://github.com/trimbe))
- Update Settlers uniques [\#7776](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7776) ([Regisle](https://github.com/Regisle))
...
- update trees [\#7701](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7701) ([Regisle](https://github.com/Regisle))
- Update DualWielding block chance [\#7697](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7697) ([Regisle](https://github.com/Regisle))
- Update quality multiplicative [\#7699](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7699) ([NL908](https://github.com/NL908))
- Improve Elemental DR mods list [\#7710](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7710) ([Regisle](https://github.com/Regisle))
- Seething Fury incorrectly has a Medium Radius Modifier set [\#7716](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7716) ([Tandrial](https://github.com/Tandrial))
- Release SimpleGraphic v2.0.3 [\#7717](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7717) ([Wires77](https://github.com/Wires77))
- Correctly generate dependencies for nodes affected by intuitive leap-like jewels [\#7719](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7719) ([trimbe](https://github.com/trimbe))
- Added support for Ambush skill [\#7757](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7757) ([DieMango](https://github.com/DieMango))
- update Taming [\#7767](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7767) ([Regisle](https://github.com/Regisle))
- Fix Mine and Trap Throw Count [\#7769](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7769) ([Regisle](https://github.com/Regisle))
- updateBarkskin [\#7782](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7782) ([Regisle](https://github.com/Regisle))
- Fix Scourge Arrow damage effectiveness [\#7778](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7778) ([deathbeam](https://github.com/deathbeam))
- If there is only 1 set, assign it to all loadouts [\#7781](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/7781) ([deathbeam](https://github.com/deathbeam))
