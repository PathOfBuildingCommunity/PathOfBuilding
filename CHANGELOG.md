...
* Add all new uniques in game patch 3.13.0 (Nostrademous, Cinnabarit)
...
* Add support for Goblinedge Power/Frenzy charge interaction (Cinnabarit)
* Add limit cap to Replica Nebulis unique (Wires77)
* Add parsing support for Anomalous Minion Life (ALT-F-X)
* Updated Max Awakening Level for Sirus to scale to 9 achievable through Atlas Passives (Quotae)
...
* Add support for automatic chill from Summon Skitterbots (Quotae)
