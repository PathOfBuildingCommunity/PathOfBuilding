...
## [v2.24.1](https://github.com/PathOfBuildingCommunity/PathOfBuilding/tree/v2.24.1) (2023/01/06)

[Full Changelog](https://github.com/PathOfBuildingCommunity/PathOfBuilding/compare/v2.24.0...v2.24.1)

<!-- Release notes generated using configuration in .github/release.yml at dev -->

## What's Changed
### New to Path of Building
- Add rotting legion missing zombie mod [\#5385](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5385) ([andrewbelu](https://github.com/andrewbelu))
- Use default item affix quality rather than 50% [\#5388](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5388) ([Regisle](https://github.com/Regisle))
...
- Query Options Improvements [\#5379](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5379) ([Dolmur](https://github.com/Dolmur))
...
- Critical cull chance uses hit rate [\#5378](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5378) ([andrewbelu](https://github.com/andrewbelu))
- Support for Frozen Sweep DPS and burst damage [\#5296](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5296) ([Lilylicious](https://github.com/Lilylicious))
- Feat: add realm support; no support for currency conversion [\#5372](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5372) ([Nostrademous](https://github.com/Nostrademous))
- Add Original Sin [\#5426](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5426) ([QuickStick123](https://github.com/QuickStick123))
- Add button to copy the trade link for timeless jewels [\#5402](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5402) ([meepen](https://github.com/meepen))
- Add option for any conqueror for Timeless jewels search [\#5490](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5490) ([Regisle](https://github.com/Regisle))
- Feat: sort Trade league name dropdown; Synthesis mods [\#5351](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5351) ([Nostrademous](https://github.com/Nostrademous))
- Implement Progenesis and show amount recouped [\#5386](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5386) ([Regisle](https://github.com/Regisle))
- PoB Trader: No Session Mode, private leagues support and some more [\#5511](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5511) ([Dullson](https://github.com/Dullson))
- PoB Trader: add self adjusting weighted search to prevent result clipping [\#5510](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5510) ([Dullson](https://github.com/Dullson))
- PoB Trader: add dynamic sorting and fall back from price sorting [\#5500](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5500) ([Dullson](https://github.com/Dullson))
- Support magic utility flask effect for silver flasks [\#5519](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5519) ([deathbeam](https://github.com/deathbeam))
### Fixed Crashes
- Fix: Deleting gem level causing a crash [\#5479](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5479) ([Paliak](https://github.com/Paliak))
- Fix issue with SelectIndex not returning proper value [\#5504](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5504) ([meepen](https://github.com/meepen))
...
- FIX: whispering ice crash if triggered [\#5547](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5547) ([Paliak](https://github.com/Paliak))
...
### User Interface
- Fix odd edit behavior with protected inputs [\#5358](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5358) ([Wires77](https://github.com/Wires77))
...
- Fix Timeless Jewel tree radius effect not appearing sometimes [\#5440](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5440) ([LocalIdentity](https://github.com/LocalIdentity))
- Change obtainable filter to default obtainable instead of any source [\#5491](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5491) ([Regisle](https://github.com/Regisle))
### Fixed Bugs
- Fix session IDs not saving separately per imported account [\#5357](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5357) ([Wires77](https://github.com/Wires77))
- Fix sort by full dps not working on anoints and appearing in other locations [\#5421](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5421) ([QuickStick123](https://github.com/QuickStick123))
- Fix kalandra's touch not working [\#5442](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5442) ([QuickStick123](https://github.com/QuickStick123))
- Fix modCache not being used during startup causing long loading times [\#5461](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5461) ([QuickStick123](https://github.com/QuickStick123))
- Fix Trader memoryleak caused by OnFrame functions [\#5473](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5473) ([Dullson](https://github.com/Dullson))
- Fix issue parsing certain item bases [\#5452](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5452) ([Paliak](https://github.com/Paliak))
- Fix unique armour/evasion/es/dps being different to added item [\#5499](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5499) ([QuickStick123](https://github.com/QuickStick123))
- Fix timeless jewel trade search when changing jewel [\#5502](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5502) ([Regisle](https://github.com/Regisle))
- Item pricing mod calculation does now use dps instead of damage [\#5400](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5400) ([Urganot](https://github.com/Urganot))
- Fixing missing radius on timeless jewels and missing variant on millitant faith when adding via double click on results. [\#5522](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5522) ([QuickStick123](https://github.com/QuickStick123))
### Other changes
- Correct max fuse calculation [\#5349](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5349) ([Lilylicious](https://github.com/Lilylicious))
- Fix energy blade not getting disabled [\#5359](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5359) ([QuickStick123](https://github.com/QuickStick123))
- Fix for minion mods not being considered for "Find Best" tool [\#5355](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5355) ([Dolmur](https://github.com/Dolmur))
- Fix minion specific mod no longer apply to specific minion [\#5394](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5394) ([QuickStick123](https://github.com/QuickStick123))
- Fix Divergent Cast while Channeling adding "More" damage [\#5409](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5409) ([LocalIdentity](https://github.com/LocalIdentity))
- Fix Rotgut mods [\#5410](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5410) ([LocalIdentity](https://github.com/LocalIdentity))
- Adjusted seismic and spire wave count calculation [\#5395](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5395) ([Edvinas-Smita](https://github.com/Edvinas-Smita))
- Fix unarmed sandstorm visage not setting spell crit to zero [\#5415](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5415) ([QuickStick123](https://github.com/QuickStick123))
...
- Add missing physical tag to Heartbound Loop [\#5416](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5416) ([ProphetLamb](https://github.com/ProphetLamb))
- Update wording on sandstorm visage [\#5425](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5425) ([QuickStick123](https://github.com/QuickStick123))
- +Flask effect works with silver flask [\#5407](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5407) ([Fabere456](https://github.com/Fabere456))
...
- Remove legacy Crystalised Omniscience that no longer exists [\#5447](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5447) ([QuickStick123](https://github.com/QuickStick123))
- FIX: exerts applying to triggered skills [\#5446](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5446) ([Paliak](https://github.com/Paliak))
...
- Fix more than 100% reduced resistances causing negative res to turn postive. [\#5458](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5458) ([QuickStick123](https://github.com/QuickStick123))
- Militant Faith update skill cost to mana cost [\#5460](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5460) ([Regisle](https://github.com/Regisle))
- Fix Implicit mods on Kalandra's Touch not applying. [\#5445](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5445) ([Paliak](https://github.com/Paliak))
- Update other Militant Faith cost mod [\#5469](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5469) ([Regisle](https://github.com/Regisle))
- Fix singular element modes not working with phys as random element. [\#5465](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5465) ([QuickStick123](https://github.com/QuickStick123))
- Add name to elemental damage Grand Spectrum variant [\#5481](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5481) ([deathbeam](https://github.com/deathbeam))
...
- Fix Frenzy Charges and Onslaught using one stat for Wilma's Requital [\#5498](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5498) ([LocalIdentity](https://github.com/LocalIdentity))
- Fix level requirement for United in Dream [\#5497](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5497) ([LocalIdentity](https://github.com/LocalIdentity))
- Add missing skilltype tags to minion skills. [\#5325](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5325) ([Paliak](https://github.com/Paliak))
- Fix wither on hit from balance of terror [\#5514](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5514) ([deathbeam](https://github.com/deathbeam))
- Fix Atziri's Mirror's source [\#5524](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5524) ([pHiney](https://github.com/pHiney))
- removing per stage multiplier on blood sacrament [\#5551](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5551) ([dreais](https://github.com/dreais))
- Fix spell supression mastery not working with Acrobatics. [\#5528](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/5528) ([Paliak](https://github.com/Paliak))
