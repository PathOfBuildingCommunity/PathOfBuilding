...
- Add full support for Vorana's March [\#4613](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4613) ([LocalIdentity](https://github.com/LocalIdentity))
- Timeless jewel search improvements [\#4622](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4622) ([Regisle](https://github.com/Regisle))
...
- Support for non critical strikes deal less damage [\#4701](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4701) ([Regisle](https://github.com/Regisle))
- Add support for more Ailment effect [\#4707](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4707) ([Regisle](https://github.com/Regisle))
...
- Add support for deal 10% less damage on IndomitableResolve [\#4688](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4688) ([Regisle](https://github.com/Regisle))
- Condition used Life flask in the past 10 seconds [\#4687](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4687) ([Regisle](https://github.com/Regisle))
- Add support for Debuff expiration rate [\#4703](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4703) ([Regisle](https://github.com/Regisle))
- Add support for recoup [\#4706](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4706) ([Regisle](https://github.com/Regisle))
- Add more sources of modifiers to enemy damage [\#4685](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4685) ([Regisle](https://github.com/Regisle))
- Add basic support to show skill PvP scaling [\#4664](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4664) ([Regisle](https://github.com/Regisle))
- Feat: add support for Non-Vaal gems [\#4711](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4711) ([Nostrademous](https://github.com/Nostrademous))
- Add support for Debilitate [\#4710](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4710) ([deathbeam](https://github.com/deathbeam))
- Jugg armour applies to ele damage [\#4673](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4673) ([Regisle](https://github.com/Regisle))
- Add 3.19 Tree [\#4744](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4744) ([Regisle](https://github.com/Regisle))
- Add support for minions have unholy might [\#4780](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4780) ([QuickStick123](https://github.com/QuickStick123))
- [Kalandra] Add support for Arrow Dancing [\#4779](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4779) ([QuickStick123](https://github.com/QuickStick123))
- [Kalandra] Add new uniques [\#4774](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4774) ([QuickStick123](https://github.com/QuickStick123))
- [Kalandra] Add support for counting Mastery Type allocations [\#4746](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4746) ([Nostrademous](https://github.com/Nostrademous))
- Add support for piecewise parsing triple damage mods. [\#4727](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4727) ([Paliak](https://github.com/Paliak))
- [Kalandra] Support for inverted reflection stats [\#4756](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4756) ([Nostrademous](https://github.com/Nostrademous))
- [Kalandra] Add new chainbreaker wording and displays Rage Regeneration [\#4786](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4786) ([Sinured](https://github.com/Sinured))
- [Kalandra] Add support for stacking max shock [\#4750](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4750) ([Lilylicious](https://github.com/Lilylicious))
- [Kalandra] Trickster mods and action speed [\#4749](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4749) ([Lilylicious](https://github.com/Lilylicious))
- Add support for trickster node Heartstopper [\#4782](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4782) ([Regisle](https://github.com/Regisle))
- Add support for PvP hit taken [\#4718](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4718) ([Regisle](https://github.com/Regisle))
- Improve stun on you calcs [\#4715](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4715) ([Regisle](https://github.com/Regisle))
- Add support for Ryslatha life flask charge generation [\#4721](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4721) ([deathbeam](https://github.com/deathbeam))
- Fix Blood offering stats not calculated #744 [\#4638](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4638) ([talkmill](https://github.com/talkmill))
- Add warning for full dot DPS cap [\#4808](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4808) ([deathbeam](https://github.com/deathbeam))
- Feat: add support for Lightning Conduit's New Trigger Flag [\#4802](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4802) ([Nostrademous](https://github.com/Nostrademous))
- Add support for enemy overwhelm and fixes some issues. [\#4705](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4705) ([QuickStick123](https://github.com/QuickStick123))
### User Interface
...
- Node power sorting [\#4617](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4617) ([Regisle](https://github.com/Regisle))
- Fix config tab being 1 change behind enemy level [\#4624](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4624) ([Regisle](https://github.com/Regisle))
- FIX: Add an emtpy stat to remove confusing red text on incinerate [\#4681](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4681) ([Paliak](https://github.com/Paliak))
- Fix bottom bar wrapping in the tree tab [\#4693](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4693) ([talkmill](https://github.com/talkmill))
- Fix Sidebar always showing Culling DPS and Recoverable ES [\#4646](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4646) ([LocalIdentity](https://github.com/LocalIdentity))
...
- Display effect of active gem variant when mousing over the "Variant" drop-down selector and small behaviour change to gemSelectControl [\#4633](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4633) ([talkmill](https://github.com/talkmill))
### Accuracy Improvements
- Fix evasion to armour conversion calculation not including "armour and evasion" base stats [\#4600](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4600) ([MrCoolTheCucumber](https://github.com/MrCoolTheCucumber))
- Fix Trypanon crit chance calculations [\#4610](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4610) ([LocalIdentity](https://github.com/LocalIdentity))
- Fix total more multipliers not being round to nearest percent as done ingame. [\#4641](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4641) ([QuickStick123](https://github.com/QuickStick123))
- Fix Evasion as Extra Armour with Iron Reflexes [\#4643](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4643) ([LocalIdentity](https://github.com/LocalIdentity))
- Fix buff stages on Scorching Ray, Frost Shield, and Sigil of Power [\#4645](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4645) ([Wires77](https://github.com/Wires77))
- Fix veiled mod pool on autogenerated unique weapons [\#4651](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4651) ([LocalIdentity](https://github.com/LocalIdentity))
- Fix Bleed DPS when using multiple totems [\#4650](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4650) ([LocalIdentity](https://github.com/LocalIdentity))
- Fix alternate ailments not working with anomalous grace. [\#4656](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4656) ([QuickStick123](https://github.com/QuickStick123))
- Update a wide variety of unique items [\#4602](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4602) ([Lothrik](https://github.com/Lothrik))
...
- Fix spelling in code [\#4690](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4690) ([Nightblade](https://github.com/Nightblade))
...
- Imported items were getting incorrect variable percentages because of default quality coming in as 20 [\#4735](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4735) ([Wires77](https://github.com/Wires77))
- [Kalandra] Batch of unique update. All remaining from M to O [\#4767](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4767) ([Sinured](https://github.com/Sinured))
- [Kalandra]Batch of uniques update. All missing starting with T [\#4763](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4763) ([Sinured](https://github.com/Sinured))
- [Kalandra]Batch of uniques update. All missing starting with R [\#4760](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4760) ([Sinured](https://github.com/Sinured))
- [Kalandra] Batch of uniques update. All missingfrom D to L [\#4769](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4769) ([Sinured](https://github.com/Sinured))
- [Kalandra] Batch of uniques update. All missing starting with S [\#4753](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4753) ([Sinured](https://github.com/Sinured))
- Fix: Blood of the Karui Life recovered and wording  [\#4729](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4729) ([Sinured](https://github.com/Sinured))
- [Kalandra] update ward recharge speed [\#4697](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4697) ([Lexy](https://github.com/learn2draw))
- [Kalandra] Update brittle values [\#4696](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4696) ([Lexy](https://github.com/learn2draw))
- [Kalandra] Update batch 1 of uniques. [\#4747](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4747) ([QuickStick123](https://github.com/QuickStick123))
- [Kalandra] Update batch 2 of uniques. [\#4751](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4751) ([QuickStick123](https://github.com/QuickStick123))
- [Kalandra] Update batch 3 of Uniques [\#4754](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4754) ([QuickStick123](https://github.com/QuickStick123))
- [Kalandra] No longer obtainable uniques [\#4748](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4748) ([QuickStick123](https://github.com/QuickStick123))
- [Kalandra] Update batch 4 of uniques. [\#4757](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4757) ([QuickStick123](https://github.com/QuickStick123))
- [Kalandra] Update replica bitterdream [\#4775](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4775) ([QuickStick123](https://github.com/QuickStick123))
- [Kalandra] Update Ngamahu's Sign [\#4755](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4755) ([Nightblade](https://github.com/Nightblade))
- [Kalandra] update bitterdream [\#4702](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4702) ([Lexy](https://github.com/learn2draw))
- Fix: Thrusting should be a base subType [\#4720](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4720) ([Nostrademous](https://github.com/Nostrademous))
- Update uniques for 3.19.0 Kalandra [\#4745](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4745) ([Paliak](https://github.com/Paliak))
- [Kalandra] Minion charges and ailments work like players [\#4694](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4694) ([Lilylicious](https://github.com/Lilylicious))
- [Kalandra] removal of 10% taken from mana before life [\#4700](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4700) ([Lexy](https://github.com/learn2draw))
- [Kalandra] nerf to omniscience [\#4699](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4699) ([Lexy](https://github.com/learn2draw))
- [Kalandra] add minus max res for 3.19 melding of the flesh [\#4698](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4698) ([Lexy](https://github.com/learn2draw))
- Cap of dot dps [\#4649](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4649) ([Regisle](https://github.com/Regisle))
- Update unique changes from patch note updates [\#4814](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4814) ([Wires77](https://github.com/Wires77))
### Fixed Bugs
- Fix Vaal Discipline not counting towards Aura count [\#4608](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4608) ([LocalIdentity](https://github.com/LocalIdentity))
- Fix enable skill tooltip visibility for non-vaal active skill gems [\#4606](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4606) ([Lothrik](https://github.com/Lothrik))
- Fix default level for pinnacles [\#4604](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4604) ([Lilylicious](https://github.com/Lilylicious))
...
- Fix catalysts visually not scaling certain mods. [\#4603](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4603) ([QuickStick123](https://github.com/QuickStick123))
- Fix placeholder physical damage applying to bosses [\#4612](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4612) ([Lothrik](https://github.com/Lothrik))
...
- Removes parsing off an unimplemented line [\#4732](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4732) ([Lilylicious](https://github.com/Lilylicious))
- Fix: Selected Mastery Tree Upconversion Error [\#4765](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4765) ([Nostrademous](https://github.com/Nostrademous))
...
- Fix "save" on generate #4619 [\#4623](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4623) ([talkmill](https://github.com/talkmill))
### Other changes
- fixes various typos in "safe" text [\#4668](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4668) ([Nightblade](https://github.com/Nightblade))
- Add warning not to edit file manually [\#4677](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4677) ([Nightblade](https://github.com/Nightblade))
- Fix spell and correct tooltip [\#4712](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4712) ([Regisle](https://github.com/Regisle))
- [Kalandra] Lifetap & Blessing interaction [\#4752](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4752) ([Sinured](https://github.com/Sinured))
- Fix: Multistrike damage calculation with skills which have bow and melee Tag [\#4740](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4740) ([Sinured](https://github.com/Sinured))
- Fix spelling in ring.lua [\#4773](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4773) ([Nightblade](https://github.com/Nightblade))
- [Kalandra] Update Manastorm and Kongming's Stratagem to new bases. [\#4783](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4783) ([QuickStick123](https://github.com/QuickStick123))
- Fix base ailment calcs [\#4790](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4790) ([Lilylicious](https://github.com/Lilylicious))
...
- reverted changes to escape/onfocuslost in gemselectcontrol [\#4784](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4784) ([talkmill](https://github.com/talkmill))
- Add support for Burning and Caustic ground and Flame Surge [\#4801](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4801) ([deathbeam](https://github.com/deathbeam))
...
- Revert Elementalist highest ignite change [\#4810](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4810) ([Regisle](https://github.com/Regisle))
- Prevent differnt types of burning/caustic ground from stacking [\#4820](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4820) ([Regisle](https://github.com/Regisle))
- Add burning and caustic ground to total dot dps and thus also combined [\#4815](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4815) ([Regisle](https://github.com/Regisle))
- Temp multistrike fix for shield crush [\#4824](https://github.com/PathOfBuildingCommunity/PathOfBuilding/pull/4824) ([Regisle](https://github.com/Regisle))
