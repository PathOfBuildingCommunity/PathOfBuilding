...
<PathOfBuilding>
	<Build level="93" targetVersion="3_0" pantheonMajorGod="None" bandit="None" className="Marauder" ascendClassName="Berserker" mainSocketGroup="3" viewMode="TREE" pantheonMinorGod="None">
		...
		<PlayerStat stat="Speed" value="0.52631578947368"/>
		<PlayerStat stat="Speed" value="0.52631578947368"/>
		<PlayerStat stat="Speed" value="0.52631578947368"/>
		<PlayerStat stat="WarcryCastTime" value="0"/>
		<PlayerStat stat="PreEffectiveCritChance" value="11.2054"/>
		<PlayerStat stat="CritChance" value="21.1551901084"/>
		<PlayerStat stat="CritMultiplier" value="3.3"/>
		...
		<PlayerStat stat="Cooldown" value="1.9"/>
		<PlayerStat stat="AreaOfEffectRadius" value="68"/>
		<PlayerStat stat="ManaCost" value="20"/>
		...
		<PlayerStat stat="ManaUnreserved" value="84"/>
		<PlayerStat stat="ManaUnreservedPercent" value="12.5"/>
	...
	<Skills sortGemsByDPSField="CombinedDPS" sortGemsByDPS="true" defaultGemQuality="nil" defaultGemLevel="nil" showSupportGemTypes="ALL" showAltQualityGems="false">
		<Skill mainActiveSkillCalcs="1" label="" enabled="true" slot="Gloves" mainActiveSkill="1">
			<Gem enableGlobal2="false" level="21" gemId="Metadata/Items/Gems/SkillGemPrecision" skillId="AccuracyAndCritsAura" enableGlobal1="true" qualityId="Default" quality="0" enabled="true" nameSpec="Precision"/>
			<Gem enableGlobal2="false" level="20" gemId="Metadata/Items/Gems/SkillGemDreadBanner" skillId="PuresteelBanner" enableGlobal1="true" qualityId="Default" quality="20" enabled="true" nameSpec="Dread Banner"/>
			<Gem enableGlobal2="false" level="20" gemId="Metadata/Items/Gems/SkillGemPride" skillId="PhysicalDamageAura" enableGlobal1="true" qualityId="Default" quality="0" enabled="true" nameSpec="Pride"/>
			<Gem enableGlobal2="false" level="4" gemId="Metadata/Items/Gems/SupportGemAdditionalXP" skillId="SupportAdditionalXP" enableGlobal1="true" qualityId="Default" quality="0" enabled="true" nameSpec="Enlighten"/>
		</Skill>
		<Skill mainActiveSkillCalcs="1" label="" enabled="true" slot="Weapon 1" mainActiveSkill="1">
			<Gem enableGlobal2="false" level="20" gemId="Metadata/Items/Gems/SkillGemDash" skillId="QuickDodge" enableGlobal1="true" qualityId="Default" quality="0" enabled="true" nameSpec="Dash"/>
			...
			<Gem enableGlobal2="false" level="2" gemId="Metadata/Items/Gems/SkillGemPortal" skillId="Portal" enableGlobal1="true" qualityId="Default" quality="20" enabled="true" nameSpec="Portal"/>
		</Skill>
		<Skill mainActiveSkillCalcs="1" label="" enabled="true" slot="Body Armour" mainActiveSkill="1">
			<Gem enableGlobal2="false" skillMinionSkillCalcs="1" skillMinionCalcs="SummonedPhantasm" level="21" gemId="Metadata/Items/Gems/SkillGemChargedAttack" skillId="ChargedAttack" skillPart="3" enableGlobal1="true" qualityId="Default" quality="23" skillPartCalcs="3" enabled="false" nameSpec="Blade Flurry" skillMinion="SummonedPhantasm"/>
			<Gem enableGlobal2="false" level="2" gemId="Metadata/Items/Gems/SupportGemMeleePhysicalDamagePlus" skillId="SupportMeleePhysicalDamagePlus" enableGlobal1="true" qualityId="Default" quality="20" enabled="true" nameSpec="Awakened Melee Physical Damage"/>
			<Gem enableGlobal2="false" level="2" gemId="Metadata/Items/Gems/SupportGemBrutalityPlus" skillId="SupportBrutalityPlus" enableGlobal1="true" qualityId="Default" quality="20" enabled="true" nameSpec="Awakened Brutality"/>
			<Gem enableGlobal2="false" level="21" gemId="Metadata/Items/Gems/SkillGemGeneralsCry" skillId="GeneralsCry" enableGlobal1="true" qualityId="Default" quality="23" enabled="true" nameSpec="General&apos;s Cry"/>
			<Gem enableGlobal2="false" level="20" gemId="Metadata/Items/Gems/SupportGemImpale" skillId="SupportImpale" enableGlobal1="true" qualityId="Default" quality="20" enabled="true" nameSpec="Impale"/>
			<Gem enableGlobal2="false" level="20" gemId="Metadata/Items/Gems/SupportGemPulverise" skillId="SupportPulverise" enableGlobal1="true" qualityId="Alternate2" quality="20" enabled="true" nameSpec="Pulverise"/>
			<Gem enableGlobal2="false" level="21" gemId="Metadata/Items/Gems/SkillGemPerforate" skillId="BloodSpears" skillPart="1" enableGlobal1="true" qualityId="Alternate3" quality="14" enabled="true" nameSpec="Perforate"/>
		</Skill>
		<Skill mainActiveSkillCalcs="1" label="" enabled="true" slot="Weapon 2" mainActiveSkill="1">
			<Gem enableGlobal2="false" level="20" gemId="Metadata/Items/Gems/SkillGemBerserk" skillId="Berserk" enableGlobal1="true" qualityId="Default" quality="23" enabled="true" nameSpec="Berserk"/>
		</Skill>
		<Skill mainActiveSkillCalcs="1" label="" enabled="true" slot="Weapon 2" mainActiveSkill="1">
			<Gem enableGlobal2="false" level="5" gemId="Metadata/Items/Gems/SkillGemBloodAndSand" skillId="BloodSandStance" enableGlobal1="true" qualityId="Default" quality="0" enabled="true" nameSpec="Blood and Sand"/>
		</Skill>
		<Skill mainActiveSkillCalcs="1" label="" enabled="true" slot="Weapon 2" mainActiveSkill="2">
			<Gem enableGlobal2="true" level="20" gemId="Metadata/Items/Gems/VaalAncestralWarchief" skillId="VaalAncestralWarchief" enableGlobal1="true" qualityId="Default" quality="11" enabled="true" nameSpec="Vaal Ancestral Warchief"/>
		</Skill>
		<Skill mainActiveSkillCalcs="1" label="" enabled="true" slot="Boots" mainActiveSkill="1">
			<Gem enableGlobal2="false" level="20" gemId="Metadata/Items/Gems/SkillGemDesecrate" skillId="Desecrate" enableGlobal1="true" qualityId="Default" quality="0" enabled="true" nameSpec="Desecrate"/>
			<Gem enableGlobal2="false" level="16" gemId="Metadata/Items/Gems/SupportGemStormBarrier" skillId="SupportStormBarrier" enableGlobal1="true" qualityId="Default" quality="0" enabled="true" nameSpec="Infused Channelling"/>
			<Gem enableGlobal2="false" level="20" gemId="Metadata/Items/Gems/SupportGemCastWhileChannelling" skillId="SupportCastWhileChannelling" enableGlobal1="true" qualityId="Default" quality="0" enabled="true" nameSpec="Cast while Channelling"/>
			<Gem enableGlobal2="false" level="20" gemId="Metadata/Items/Gems/SkillGemCyclone" skillId="Cyclone" skillPart="1" enableGlobal1="true" qualityId="Default" quality="0" enabled="true" nameSpec="Cyclone"/>
		</Skill>
		<Skill mainActiveSkillCalcs="1" label="" enabled="true" slot="Helmet" mainActiveSkill="1">
			<Gem enableGlobal2="false" level="10" gemId="Metadata/Items/Gems/SkillGemMoltenShell" skillId="MoltenShell" enableGlobal1="true" qualityId="Default" quality="0" enabled="true" nameSpec="Molten Shell"/>
			...
			<Gem enableGlobal2="false" level="2" gemId="Metadata/Items/Gems/SupportGemCastOnDamageTaken" skillId="SupportCastOnDamageTaken" enableGlobal1="true" qualityId="Default" quality="0" enabled="true" nameSpec="Cast when Damage Taken"/>
			<Gem enableGlobal2="false" skillMinionSkillCalcs="1" level="3" gemId="Metadata/Items/Gems/SkillGemSummonIceGolem" skillId="SummonIceGolem" skillMinionSkill="1" enableGlobal1="true" qualityId="Default" quality="0" enabled="true" nameSpec="Summon Ice Golem" skillMinion="SummonedIceGolem"/>
		</Skill>
		<Skill source="Item:22:The Hidden Blade, Ambusher" mainActiveSkillCalcs="1" label="" enabled="true" slot="Weapon 1 Swap" mainActiveSkill="1">
			<Gem enableGlobal2="false" level="20" skillId="HiddenBlade" enableGlobal1="true" qualityId="Default" quality="0" enabled="true" nameSpec="Unseen Strike"/>
		</Skill>
		<Skill source="Item:13:Hands of the High Templar, Crusader Gloves" mainActiveSkillCalcs="1" label="" enabled="true" slot="Gloves" mainActiveSkill="1">
			<Gem enableGlobal2="false" level="1" gemId="Metadata/Items/Gems/SkillGemNewVulnerability" skillId="Vulnerability" enableGlobal1="true" qualityId="Default" quality="0" enabled="true" nameSpec="Vulnerability"/>
		</Skill>
	</Skills>
	<Tree activeSpec="1">
		<Spec ascendClassId="2" nodes="25367,66771,14001,31080,37501,49178,29294,25933,65680,7082,24970,66752,65701,61050,63282,46578,47175,16380,65762,13714,55190,66706,66714,66777,65760,32251,65706,65744,2225,65682,50024,65698,30691,15868,34400,39023,31257,65690,10532,49080,33287,65754,57839,62429,5865,36047,24383,23984,50515,65702,10594,61198,44169,5152,14993,12795,55485,66768,65770,43374,20551,6289,18901,30380,3644,32739,5233,48807,9271,57992,24914,18302,47426,22627,48438,34009,34191,37647,2491,43833,62319,59928,53118,50904,23090,48287,14056,29353,56460,46519,49412,56370,26725,65746,66704,63723,18552,35053,58831,28475,33582,55166,26712,58449,476,59494,60529,65696,30733,63673,224,61666,64024,59920,63048,38999,14930,55676,49415,38664,53987,35288,8592,1340,22703,56355" treeVersion="3_13" classId="1">
			<EditedNodes>
...
Gain 50 Life when you Stun an Enemy
    ...
    ["FireMeleeDamageChance"] = 30,
    ["PhysicalGuardEffectiveLife"] = 9647.4,
    ["PhysicalAegis"] = 0,
    ["EnergyShieldRegen"] = 0,
    ["LightningAegis"] = 0,
    ["SiphoningCharges"] = 0,
    ...
    ["IgniteChanceOnHit"] = 0,
    ["PowerChargesMax"] = 3,
    ["FireGuardAbsorb"] = 4686.4,
    ["PhysicalDamageReduction"] = 78,
    ["Str"] = 422,
    ["KnockbackChance"] = 0,
    ...
    ["CritEffect"] = 1.4865693724932,
    ["ArmourOnHelmet"] = 775,
    ["EnemyCurseLimit"] = 1,
    ["PreEffectiveCritChance"] = 11.2054,
    ["LightningEnergyShieldBypass"] = 0,
    ["CritChance"] = 21.1551901084,
    ["FistOfWarCooldown"] = 0,
    ["ColdTotalPool"] = 9733.4,
    ...
    ["ChaosGuardEffectiveLife"] = 9647.4,
    ...
    ["BlockChance"] = 30,
    ["FireGuardAbsorbRate"] = 75,
    ["ChaosPoisonChance"] = 0,
    ["ChaosManaEffectiveLife"] = 9647.4,
