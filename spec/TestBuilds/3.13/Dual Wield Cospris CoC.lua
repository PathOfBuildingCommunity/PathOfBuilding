...
22% chance to lose a Power Charge when you gain Elusive
    ...
    ["HitChance"] = 100,
    ["LightningDotEHP"] = 24945.833333333,
    ["CrabBarriersMax"] = 0,
    ...
    ["ReqInt"] = 257,
    ["ProjectileNotHitChance"] = 26.0125,
    ["ColdMinBase"] = 669.2,
    ["MaxManaLeechRate"] = 189.2,
    ["PhysicalTakenReflectMult"] = 0.99,
    ...
    ["PhysicalGuardEffectiveLife"] = 256,
    ["PhysicalAegis"] = 0,
    ["EnergyShieldRegen"] = 0,
    ["LightningAegis"] = 0,
    ["SiphoningCharges"] = 0,
    ["RuthlessBlowEffect"] = 1,
    ["Cooldown"] = 0.13333333333333,
    ...
    ["MaxEnergyShieldLeechRate"] = 286.55,
    ["EnergyShieldLeechInstanceRate"] = 114.62,
    ...
    ["LightningManaEffectiveLife"] = 256,
    ...
    ["ChaosMaxBase"] = 0,
    ["WithIgniteDPS"] = 372408.52275,
    ["WithPoisonDPS"] = 372408.52275,
    ["CombinedDPS"] = 372408.52275,
    ...
    ["SpellProjectileNotHitChance"] = 25,
    ...
    ["PhysicalMaximumHitTaken"] = 6047.4747474747,
    ["SapChanceOnCrit"] = 0,
    ["WarcryPower"] = 20,
    ["ProjectileEvadeChance"] = 1.35,
    ["Speed"] = 3.5814285714286,
    ["FireMaxBase"] = 0,
    ["LightningCritAverage"] = 0,
    ["ColdHitAverage"] = 56901.24,
    ["MaxEnergyShieldLeechInstance"] = 573.1,
    ["HexDoomLimit"] = 30,
    ["PhysicalSpellDamageChance"] = 0,
    ["EnergyShieldLeechInstances"] = 196.97857142857,
    ...
    ["LifeLeechGainPerHit"] = 134.8,
    ["LightningTakenReflectMult"] = 0.24,
    ["AvoidChaosDamageChance"] = 0,
    ["ManaLeechRate"] = 0,
    ["ManaLeechInstanceRate"] = 18.92,
    ["EnergyShieldLeechPerHit"] = 573.1,
    ["EnergyShieldLeechRate"] = 286.55,
    ["LifeLeechInstances"] = 196.97857142857,
    ["LifeLeechRate"] = 269.6,
    ["ColdDotEHP"] = 23948,
    ["Armour"] = 164,
    ["PierceCountString"] = 0,
    ["TotalDPS"] = 14671299.759824,
    ["AverageHit"] = 372408.52275,
    ...
    ["LifeUnreservedPercent"] = 18.991097922849,
    ["ScorchChanceOnCrit"] = 0,
    ["OffensiveWarcryEffect"] = 1,
    ["FistOfWarHitEffect"] = 1,
    ["ChaosCritAverage"] = 25310.95875,
    ["FireCritAverage"] = 0,
    ["IgniteDotMulti"] = 1,
    ["BlockChanceMax"] = 75,
    ...
    ["EnergyShieldLeechGainPerHit"] = 573.1,
    ...
    ["LightningTotalPool"] = 5987,
    ["ColdMaximumHitTaken"] = 23948,
    ["LightningMaximumHitTaken"] = 24945.833333333,
    ["ColdCritAverage"] = 347097.564,
    ...
    ["ManaOnBlock"] = 0,
    ["EnergyShieldLeech"] = 573.1,
    ["ChaosMinBase"] = 0,
    ["FireMindOverMatter"] = 0,
    ["EvadeChance"] = 1.35,
    ["ChaosHitAverage"] = 4149.3375,
    ["GhostShrouds"] = 0,
    ["LifeUnreserved"] = 256,
    ...
    ["FireGuardEffectiveLife"] = 256,
    ["ColdManaEffectiveLife"] = 256,
    ...
    ["ColdGuardEffectiveLife"] = 256,
    ["ColdSpellDamageChance"] = 0,
    ["ManaRegenInc"] = 78,
    ["FireManaEffectiveLife"] = 256,
    ["LightningTakenDotMult"] = 0.24,
    ["TotalMin"] = 47412.09,
    ["ChaosTakenReflect"] = 1,
    ["BlitzCharges"] = 0,
    ["ColdGuardEffectivePool"] = 0,
    ["LifeReservedPercent"] = 81.008902077151,
    ["PhysicalPhysicalBaseTakenHitMult"] = 0.99,
    ["ManaLeechGainPerHit"] = 0,
    ["ChaosResistOverCap"] = 0,
    ["BlindAvoidChance"] = 0,
    ["FireMaximumHitTaken"] = 29935,
    ["FrenzyChargesMax"] = 6,
