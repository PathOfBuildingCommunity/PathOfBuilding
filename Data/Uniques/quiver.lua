...
Requires Level 10
(20 to 30)% increased Accuracy Rating
...
Requires Level 10
+(3 to 4) Life gained for each Enemy hit by your Attacks
+(15 to 25) to Strength
+(35 to 45) to Dexterity
+(15 to 25) to Intelligence
(7 to 10)% increased Attack Speed
+(2 to 3) Life gained for each Enemy hit by your Attacks
10% increased Radius of Area Skills
]],[[
Maloney's Nightfall
Blunt Arrow Quiver
Requires Level 55
(25 to 35)% increased Stun Duration on Enemies
...
(30 to 50)% increased Projectile Damage
Projectiles Fork
]],[[
Saemus' Gift
