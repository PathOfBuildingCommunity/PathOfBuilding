...
itemBases["Iron Staff"] = {
	...
	subType = "Warstaff",
	socketLimit = 6,
	tags = { default = true, weapon = true, twohand = true, two_hand_weapon = true, attack_staff = true, staff = true, warstaff = true, },
	implicit = "+18% Chance to Block Attack Damage while wielding a Staff",
	implicitModTypes = { { "block" }, },
...
itemBases["Capacity Rod"] = {
	...
	subType = "Warstaff",
	socketLimit = 6,
	tags = { default = true, weapon = true, twohand = true, two_hand_weapon = true, attack_staff = true, staff = true, not_for_sale = true, },
