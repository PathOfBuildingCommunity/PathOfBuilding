...
skills["HeraldOfAsh"] = {
	...
	gemInt = 40,
	color = 1,
	description = "Grants a buff adding fire to your physical damage. While you have this buff, if you kill an enemy with an attack, other enemies near them will be burned based on the overkill damage.",
