...
skills["SupportCastOnDamageTaken"] = {
	...
	gemDex = 0,
	gemInt = 40,
	description = "Each supported spell skill will track damage you take, and be triggered when the total damage taken reaches a threshold. Cannot support totems, traps, or mines. Vaal skills and skills that reserve mana cannot be triggered.",
	color = 1,
	support = true,
...
skills["SupportChanceToBleed"] = {
	...
	gemDex = 0,
	gemInt = 0,
	description = "Supports attack skills. Cannot support minions",
	color = 1,
	support = true,
	requireSkillTypes = { 1, },
	addSkillTypes = { },
...
skills["SupportGenerosity"] = {
	...
	gemDex = 0,
	gemInt = 40,
	description = "Supports aura skills that affect you and allies, increasing the aura's effect on allies, but preventing if from affecting you at all. Cannot support curse auras, or other auras that only affect enemies. Cannot support Totems.",
	color = 1,
	support = true,
...
skills["SupportIronGrip"] = {
	...
	gemDex = 0,
	gemInt = 0,
	description = "Supports attack skills that fire projectiles, making the increase to physical melee damage from strength also increse their physical projectile damage.",
	color = 1,
	support = true,
...
skills["SupportMeleeSplash"] = {
	...
	gemDex = 0,
	gemInt = 0,
	description = "Supports single-target melee attack skills, causing their melee strike to deal spash damage around the target.",
	color = 1,
	support = true,
...
skills["SupportRuthless"] = {
	...
	gemDex = 0,
	gemInt = 0,
	description = "Supports melee attack skills. Every third time you use a supported attack, that use of the skill will be more powerful.",
	color = 1,
	support = true,
	requireSkillTypes = { 24, },
	addSkillTypes = { },
