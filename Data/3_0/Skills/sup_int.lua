...
skills["SupportArcaneSurge"] = {
	...
	baseMods = {
		...
		mod("Speed", "INC", 10, ModFlag.Cast, 0, { type = "GlobalEffect", effectType = "Buff", effectName = "Arcane Surge" }), --"support_arcane_surge_cast_speed_+%" = 10
		mod("ManaRegenPercent", "BASE", 0.5, 0, 0, { type = "GlobalEffect", effectType = "Buff", effectName = "Arcane Surge" }), --"support_arcane_surge_mana_regeneration_rate_per_minute_%" = 30
	},
	qualityMods = {
	...
	levelMods = {
		[1] = nil, 
		--[2] = "support_arcane_surge_%_chance_to_gain_buff_on_spell_cast"
...
skills["SupportAilments"] = {
	...
	levelMods = {
		...
		[3] = mod("AilmentEffect", "INC", nil), --"support_ailments_effect_+%"
	},
	levels = {
		[1] = { 8, 30, 20, },
		[2] = { 10, 31, 21, },
