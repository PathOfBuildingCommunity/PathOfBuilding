return {
			...
			lang={
				English={
					[1]={
						...
						text="Projectiles have {2}% chance to Return to you from final Target"
					},
					[2]={
						limit={
							[1]={
			...
			lang={
				English={
					[1]={
						...
						text="Projectiles travel {0}% increased distance before changing forms"
					},
					[2]={
						[1]={
							k="negate",
						...
						text="Projectiles travel {0}% reduced distance before changing forms"
					}
				}
			},
			...
			lang={
				English={
					[1]={
						...
						text="First Impact deals {0}% more damage"
					},
					[2]={
						[1]={
							k="negate",
						...
						text="First Impact deals {0}% less damage"
					}
				}
			},
			...
			lang={
				English={
					[1]={
						...
						text="Projectiles Chain when impacting the ground"
					}
				}
			},
			...
			lang={
				English={
					[1]={
						...
						text="Projectiles deal {0}% increased Damage for each remaining Chain"
					},
					[2]={
						[1]={
							k="negate",
						...
						text="Projectiles deal {0}% reduced Damage for each remaining Chain"
					}
				}
			},
			...
			lang={
				English={
					[1]={
						...
						text="{0}% chance for Projectiles to Return"
					}
				}
			},
			...
			lang={
				English={
					[1]={
						...
						text="{0}% increased Projectile Damage to nearby Enemies"
					},
					[2]={
						[1]={
							k="negate",
						...
						text="{0}% reduced Projectile Damage to nearby Enemies"
					}
				}
			},
			...
			lang={
				English={
					[1]={
						...
						text="Nearby Enemies take Chaos Damage equal to {0}% of granted Life Regeneration per second"
					}
				}
			},
			...
			lang={
				English={
					[1]={
						...
						text="{0}% chance to gain Onslaught for 3 seconds when you Hit a Unique Enemy"
					}
				}
			},
			...
			lang={
				English={
					[1]={
						...
						text="{0}% chance to grant Onslaught for {1} seconds on\ndealing a Killing Blow"
					}
				}
			},
			...
			lang={
				English={
					[1]={
						...
						text="%1%%% chance to Trigger this skill when you Kill a Frozen Enemy"
					},
					[2]={
						limit={
							[1]={
		...
		["%_chance_to_gain_frenzy_charge_on_mine_detonated_targeting_an_enemy"]=826,
		["%_chance_to_gain_frenzy_charge_on_trap_triggered_by_an_enemy"]=827,
		["%_chance_to_gain_power_charge_on_mine_detonated_targeting_an_enemy"]=828,
		["%_chance_to_gain_power_charge_on_trap_triggered_by_an_enemy"]=829,
		...
		["active_skill_area_damage_+%_final"]=392,
		["active_skill_area_of_effect_+%_final"]=62,
		["active_skill_area_of_effect_+%_final_per_endurance_charge"]=393,
		["active_skill_area_of_effect_+%_final_when_cast_on_frostbolt"]=394,
		["active_skill_attack_speed_+%_final"]=270,
		["active_skill_base_area_length_+"]=395,
		["active_skill_base_radius_+"]=56,
		["active_skill_chill_as_though_damage_+%_final"]=396,
		["active_skill_cooldown_bypass_type_override_to_power_charge"]=508,
		["active_skill_damage_+%_when_cast_on_frostbolt"]=397,
		["active_skill_damage_over_time_from_projectile_hits_+%_final"]=369,
		["active_skill_display_aegis_variation"]=410,
		["active_skill_ground_consecration_radius_+"]=57,
		["active_skill_if_used_through_frostbolt_damage_+%_final"]=398,
		["active_skill_ignite_damage_+%_final"]=399,
		["active_skill_minion_energy_shield_+%_final"]=119,
		["active_skill_minion_life_+%_final"]=118,
		["active_skill_minion_movement_velocity_+%_final"]=115,
		["active_skill_poison_duration_+%_final"]=400,
		["active_skill_projectile_damage_+%_final"]=364,
		["active_skill_returning_projectile_damage_+%_final"]=365,
		["active_skill_shock_as_though_damage_+%_final"]=401,
		["add_endurance_charge_on_skill_hit_%"]=402,
		["add_frenzy_charge_on_kill"]=102,
		["add_frenzy_charge_on_kill_%_chance"]=103,
		["add_frenzy_charge_on_skill_hit_%"]=403,
		["add_power_charge_on_critical_strike_%"]=230,
		["additional_base_critical_strike_chance"]=352,
		["additional_block_chance_against_projectiles_%_per_steel_charge"]=404,
		["additional_burning_debuff_%_of_ignite_damage"]=830,
		["additional_chain_chance_%"]=405,
		["additional_chance_to_freeze_chilled_enemies_%"]=331,
		["additional_critical_strike_chance_permyriad_while_affected_by_elusive"]=407,
		["additional_critical_strike_chance_permyriad_while_dead"]=406,
		["additional_projectiles_per_intensity"]=408,
		["additive_arrow_speed_modifiers_apply_to_area_of_effect"]=409,
		["aegis_unique_shield_max_value"]=410,
		["ailment_damage_+%_per_frenzy_charge"]=411,
		["all_damage_can_freeze"]=412,
		["all_damage_can_ignite"]=413,
		["all_damage_can_shock"]=414,
		["already_split_if_no_steel_shards"]=415,
		["always_freeze"]=84,
		["always_stun"]=124,
		["always_stun_enemies_that_are_on_full_life"]=416,
		["ancestor_totem_buff_effect_+%"]=417,
		["ancestor_totem_parent_activation_range_+%"]=418,
		["ancestral_cry_empowered_attacks_strike_X_additional_enemies"]=1084,
		["ancestral_cry_exerted_attack_damage_+%"]=419,
		["ancestral_cry_max_physical_damage_reduction_rating"]=1077,
		["ancestral_cry_physical_damage_reduction_rating_per_5_MP"]=1077,
		["ancestral_cry_x_melee_range_per_5_monster_power"]=1078,
		["ancestral_slam_interval_duration"]=387,
		["ancestral_slam_stun_threshold_reduction_+%"]=420,
		["animate_item_maximum_level_requirement"]=247,
		["animate_weapon_chance_to_create_additional_copy_%"]=421,
		["apply_linked_curses_on_hit_%"]=236,
		["apply_linked_curses_with_dark_ritual"]=422,
		["apply_overpowered_on_enemy_block_reduced_block_and_spell_block_%"]=423,
		["arc_damage_+%_final_for_each_remaining_chain"]=424,
		["arc_damage_+%_final_per_chain"]=425,
		["arcane_cloak_consume_%_of_mana"]=426,
		["arcane_cloak_damage_absorbed_%"]=427,
		["arcane_cloak_gain_%_of_consumed_mana_as_life_regenerated_per_second"]=428,
		["arcane_cloak_gain_%_of_consumed_mana_as_lightning_damage"]=429,
		["arctic_armour_chill_when_hit_duration"]=430,
		["arctic_armour_freeze_enemies_when_you_are_hit_%_chance"]=431,
		["arctic_breath_maximum_number_of_skulls_allowed"]=432,
		["area_of_effect_+%_per_frost_fury_stage"]=433,
		["area_of_effect_+%_per_removable_power_frenzy_or_endurance_charge"]=434,
		["area_of_effect_+%_when_cast_on_frostbolt"]=435,
		["area_of_effect_+%_while_dead"]=61,
		["area_of_effect_+%_while_not_dual_wielding"]=436,
		["arrow_number_of_targets_to_pierce"]=81,
		["arrows_always_pierce"]=81,
		["attack_and_cast_speed_+%"]=437,
		["attack_damage_+%"]=438,
		["attack_damage_taken_+%_final_from_enemies_unaffected_by_sand_armour"]=439,
		["attack_repeat_count"]=229,
		["attack_skill_mana_leech_from_any_damage_permyriad"]=440,
		["attack_speed_+%"]=39,
		["attack_speed_+%_granted_from_skill"]=40,
		["attack_speed_+%_when_on_low_life"]=41,
		["attack_trigger_on_hit_%"]=266,
		["attack_trigger_on_hitting_bleeding_enemy_%"]=441,
		["attack_trigger_on_kill_%"]=248,
		["attack_trigger_on_melee_hit_%"]=267,
		["attack_trigger_when_critically_hit_%"]=244,
		["attack_unusable_if_triggerable"]=246,
		["attacks_impale_on_hit_%_chance"]=442,
		["aura_effect_+%"]=65,
		["avoid_damage_%"]=443,
		["avoid_interruption_while_using_this_skill_%"]=444,
		["backstab_damage_+%"]=125,
		["ball_lightning_superball_%_chance"]=445,
		["barrage_support_projectile_spread_+%"]=446,
		["base_actor_scale_+%"]=1,
		["base_arrow_speed_+%"]=303,
		["base_attack_speed_+%_per_frenzy_charge"]=66,
		["base_aura_area_of_effect_+%"]=64,
		["base_buff_duration_ms_+_per_removable_endurance_charge"]=154,
		["base_cast_speed_+%"]=48,
		["base_chance_to_deal_triple_damage_%"]=447,
		["base_chance_to_destroy_corpse_on_kill_%_vs_ignited"]=448,
		["base_chance_to_freeze_%"]=84,
		["base_chance_to_ignite_%"]=86,
		["base_chance_to_poison_on_hit_%"]=342,
		["base_chance_to_shock_%"]=85,
		["base_chance_to_shock_%_from_skill"]=449,
		["base_chaos_damage_%_of_maximum_life_to_deal_per_minute"]=99,
		["base_chaos_damage_taken_per_minute_per_viper_strike_orb"]=128,
		["base_cold_damage_resistance_%"]=198,
		["base_cooldown_speed_+%"]=450,
		["base_critical_strike_multiplier_+"]=106,
		["base_damage_taken_+%"]=451,
		["base_deal_no_chaos_damage"]=452,
		["base_energy_shield_leech_from_spell_damage_permyriad"]=453,
		["base_inflict_cold_exposure_on_hit_%_chance"]=454,
		["base_life_leech_from_chaos_damage_permyriad"]=455,
		["base_life_regeneration_rate_per_minute"]=195,
		["base_mana_regeneration_rate_per_minute"]=322,
		["base_movement_velocity_+%"]=93,
		["base_nonlethal_fire_damage_%_of_maximum_energy_shield_taken_per_minute"]=166,
		["base_nonlethal_fire_damage_%_of_maximum_life_taken_per_minute"]=165,
		["base_number_of_effigies_allowed"]=817,
		["base_number_of_projectiles_in_spiral_nova"]=38,
		["base_physical_damage_%_of_maximum_energy_shield_to_deal_per_minute"]=101,
		["base_physical_damage_%_of_maximum_life_to_deal_per_minute"]=100,
		["base_physical_damage_%_to_convert_to_cold"]=311,
		["base_physical_damage_reduction_rating"]=170,
		["base_poison_damage_+%"]=347,
		["base_poison_duration_+%"]=348,
		["base_projectile_speed_+%"]=83,
		["base_reduce_enemy_cold_resistance_%"]=205,
		["base_reduce_enemy_fire_resistance_%"]=204,
		["base_reduce_enemy_lightning_resistance_%"]=206,
		["base_resist_all_elements_%"]=162,
		["base_righteous_fire_%_of_max_energy_shield_to_deal_to_nearby_per_minute"]=164,
		["base_righteous_fire_%_of_max_life_to_deal_to_nearby_per_minute"]=163,
		["base_skill_area_of_effect_+%"]=58,
		["base_stun_duration_+%"]=123,
		["base_stun_recovery_+%"]=150,
		["base_stun_threshold_reduction_+%"]=55,
		["base_use_life_in_place_of_mana"]=175,
		["berserk_attack_damage_+%_final"]=381,
		["berserk_attack_speed_+%_final"]=382,
		["berserk_base_damage_taken_+%_final"]=384,
		["berserk_minimum_rage"]=380,
		["berserk_movement_speed_+%_final"]=383,
		["berserk_rage_loss_+%_per_second"]=386,
		["blackhole_damage_taken_+%"]=457,
		["blackhole_hinder_%"]=458,
		["blackhole_tick_rate_ms"]=459,
		["blade_blast_detonated_blades_not_removed_%_chance"]=460,
		["blade_burst_area_of_effect_+%_final_per_blade_vortex_blade_detonated"]=461,
		["blade_flurry_elemental_damage_+%_while_channeling"]=462,
		["blade_flurry_final_flurry_area_of_effect_+%"]=463,
		["blade_vortex_additional_blade_chance_%"]=464,
		["blade_vortex_ailment_damage_+%_per_blade_final"]=222,
		["blade_vortex_critical_strike_chance_+%_per_blade"]=465,
		["blade_vortex_damage_+%_per_blade_final"]=221,
		["blade_vortex_damage_+%_with_5_or_fewer_blades"]=466,
		["blade_vortex_hit_rate_+%_per_blade"]=220,
		["blade_vortex_hit_rate_ms"]=467,
		["bladefall_critical_strike_chance_+%_per_stage"]=468,
		["bladefall_damage_per_stage_+%_final"]=345,
		["bladefall_volley_gap_distance_+%"]=469,
		["bladefall_volleys_needed_per_vestige_blade"]=470,
		["bladestorm_attack_speed_+%_final_while_in_bloodstorm"]=471,
		["bladestorm_blood_stance_ailment_damage_+%"]=472,
		["bladestorm_create_alternate_stance_storm_%_chance"]=473,
		["bladestorm_maximum_number_of_storms_allowed"]=474,
		["bladestorm_movement_speed_+%_while_in_sandstorm"]=475,
		["bladestorm_sandstorm_movement_speed_+%"]=476,
		["bladestorm_storm_damage_+%_final"]=477,
		["blast_rain_area_of_effect_+%"]=478,
		["blast_rain_damage_+%_vs_distant_enemies"]=479,
		["bleed_on_hit_with_attacks_%"]=480,
		["bleeding_damage_+%"]=481,
		["bleeding_skill_effect_duration"]=73,
		["blind_duration_+%"]=203,
		["blood_rage_life_leech_from_elemental_damage_permyriad"]=482,
		["blood_sand_stance_melee_skills_area_damage_+%_final_in_blood_stance"]=355,
		["blood_sand_stance_melee_skills_area_damage_+%_final_in_sand_stance"]=358,
		["blood_sand_stance_melee_skills_area_of_effect_+%_final_in_blood_stance"]=356,
		["blood_sand_stance_melee_skills_area_of_effect_+%_final_in_sand_stance"]=357,
		["bodyswap_damage_+%_when_not_consuming_corpse"]=483,
		["bone_golem_damage_+%_final_per_non_golem_minion_nearby"]=484,
		["bone_golem_damage_per_non_golem_minion_nearby_maximum_%"]=484,
		["bone_golem_grants_minion_maximum_added_physical_damage"]=485,
		["bone_golem_grants_minion_minimum_added_physical_damage"]=485,
		["brand_detonate_faster_activation_%_per_second"]=486,
		["brand_detonate_faster_duration_%_per_second"]=487,
		["brand_recall_spend_%_of_recalled_brands_cost"]=488,
		["buff_effect_duration"]=68,
		["buff_effect_duration_+%_per_removable_endurance_charge"]=155,
		["buff_effect_duration_+%_per_removable_endurance_charge_limited_to_5"]=156,
		["burn_damage_+%"]=92,
		["call_of_steel_reload_amount"]=489,
		["call_of_steel_reload_time"]=489,
		["cannot_cause_bleeding"]=480,
		["cannot_inflict_status_ailments"]=174,
		["cannot_knockback"]=490,
		["cast_linked_spells_on_attack_crit_%"]=240,
		["cast_linked_spells_on_melee_kill_%"]=241,
		["cast_on_any_damage_taken_%"]=255,
		["cast_on_attack_use_%"]=249,
		["cast_on_crit_%"]=491,
		["cast_on_damage_taken_%"]=268,
		["cast_on_damage_taken_threshold"]=268,
		["cast_on_death_%"]=257,
		["cast_on_flask_use_%"]=492,
		["cast_on_gain_avians_flight_or_avians_might_%"]=261,
		["cast_on_gain_skill"]=493,
		["cast_on_hit_%"]=262,
		["cast_on_hit_against_rare_or_unique"]=494,
		["cast_on_hit_if_cursed_%"]=263,
		["cast_on_lose_cats_stealth"]=264,
		["cast_on_melee_hit_if_cursed_%"]=265,
		["cast_on_skill_use_%"]=250,
		["cast_on_stunned_%"]=259,
		["cast_speed_+%_granted_from_skill"]=6,
		["cast_speed_+%_when_on_low_life"]=47,
		["cast_when_hit_%"]=256,
		["cast_while_channelling_time_ms"]=273,
		["chain_hook_range_+%"]=495,
		["chain_strike_cone_radius_+_per_x_rage"]=496,
		["chain_strike_gain_x_rage_if_attack_hits"]=497,
		["chaining_range_+%"]=498,
		["chance_%_when_poison_to_also_poison_another_enemy"]=501,
		["chance_for_extra_damage_roll_%"]=499,
		["chance_for_melee_skeletons_to_summon_as_archer_skeletons_%"]=500,
		["chance_to_bleed_on_hit_%_chance_in_blood_stance"]=502,
		["chance_to_bleed_on_hit_%_vs_maimed"]=503,
		["chance_to_cast_on_kill_%"]=251,
		["chance_to_cast_on_kill_%_target_self"]=252,
		["chance_to_cast_on_rampage_tier_%"]=258,
		["chance_to_cast_when_your_trap_is_triggered_%"]=269,
		["chance_to_deal_double_damage_%"]=504,
		["chance_to_deal_double_damage_%_vs_bleeding_enemies"]=505,
		["chance_to_double_stun_duration_%"]=506,
		["chance_to_fork_extra_projectile_%"]=507,
		["chance_to_fortify_on_melee_hit_+%"]=309,
		["chance_to_freeze_shock_ignite_%"]=330,
		["chance_to_gain_frenzy_charge_on_killing_enemy_affected_by_cold_snap_ground_%"]=508,
		["chance_to_gain_power_charge_on_rare_or_unique_enemy_hit_%"]=509,
		["chance_to_ignore_hexproof_%"]=510,
		["chance_to_inflict_additional_impale_%"]=511,
		["chance_to_scorch_%"]=512,
		["chance_to_summon_support_ghost_on_hitting_rare_or_unique_%"]=513,
		["chance_to_summon_support_ghost_on_killing_blow_%"]=514,
		["chance_to_trigger_on_animate_guardian_kill_%"]=515,
		["chance_to_trigger_on_animate_weapon_kill_%"]=516,
		["chance_to_unnerve_on_hit_%"]=517,
		["chaos_damage_resisted_by_lowest_resistance"]=518,
		["chaos_damage_taken_+%"]=341,
		["chaos_golem_grants_additional_physical_damage_reduction_%"]=317,
		["charged_attack_damage_per_stack_+%_final"]=519,
		["charged_blast_spell_damage_+%_final_per_stack"]=271,
		["charged_dash_channelling_damage_at_full_stacks_+%_final"]=520,
		["charged_dash_damage_+%_final_per_stack"]=521,
		["charged_dash_skill_inherent_movement_speed_+%_final"]=522,
		["chill_duration_+%"]=88,
		["chill_effect_+%"]=89,
		["chilled_ground_base_magnitude_override"]=523,
		["chilling_area_movement_velocity_+%"]=524,
		["circle_of_power_enemy_damage_+%_final_at_max_stages"]=525,
		["circle_of_power_mana_spend_per_upgrade"]=526,
		["circle_of_power_max_added_lightning_per_stage"]=528,
		["circle_of_power_max_stages"]=527,
		["circle_of_power_min_added_lightning_per_stage"]=528,
		["cleave_+1_base_radius_per_nearby_enemy_up_to_10"]=529,
		["cluster_burst_spawn_amount"]=304,
		["cold_ailment_duration_+%"]=530,
		["cold_ailment_effect_+%"]=531,
		["cold_damage_+%"]=298,
		["cold_projectile_mine_enemy_critical_strike_chance_+%_against_self"]=1102,
		["combat_rush_effect_+%"]=532,
		["consecrated_ground_area_+%"]=536,
		["consecrated_ground_effect_+%"]=533,
		["consecrated_ground_enemy_damage_taken_+%"]=534,
		["consecrated_ground_immune_to_curses"]=535,
		["conversation_trap_converted_enemy_damage_+%"]=537,
		["conversion_trap_converted_enemies_chance_to_taunt_on_hit_%"]=538,
		["corpse_consumption_life_to_gain"]=216,
		["corpse_consumption_mana_to_gain"]=217,
		["corpse_erruption_maximum_number_of_geyers"]=539,
		["corpse_explosion_monster_life_%"]=22,
		["corpse_explosion_monster_life_%_chaos"]=23,
		["corpse_warp_area_of_effect_+%_final_when_consuming_corpse"]=540,
		["corrosive_shroud_%_of_stored_poison_damage_to_deal_per_second"]=362,
		["corrosive_shroud_gains_%_of_damage_from_inflicted_poisons"]=360,
		["corrosive_shroud_maximum_stored_poison_damage"]=361,
		["corrosive_shroud_poison_damage_+%_final_while_accumulating_poison"]=359,
		["corrosive_shroud_poison_dot_multiplier_+_while_aura_active"]=363,
		["cover_in_ash_on_hit_%"]=541,
		["create_herald_of_thunder_storm_on_shocking_enemy"]=542,
		["created_slipstream_action_speed_+%"]=543,
		["cremation_chance_to_explode_nearby_corpse_when_firing_projectiles"]=544,
		["critical_ailment_dot_multiplier_+"]=546,
		["critical_poison_dot_multiplier_+"]=547,
		["critical_strike_chance_+%"]=104,
		["critical_strike_chance_+%_per_power_charge"]=548,
		["critical_strike_chance_+%_per_righteous_charge"]=549,
		["critical_strike_chance_+%_vs_blinded_enemies"]=550,
		["critical_strike_chance_+%_vs_shocked_enemies"]=545,
		["critical_strike_multiplier_+_per_blade"]=551,
		["critical_strike_multiplier_+_per_power_charge"]=552,
		["critical_strike_multiplier_+_while_affected_by_elusive"]=107,
		["crush_for_2_seconds_on_hit_%_chance"]=553,
		["curse_effect_+%"]=274,
		["curse_effect_+%_final_vs_players"]=276,
		["curse_effect_+%_vs_players"]=275,
		["curse_effect_duration"]=67,
		["cyclone_area_of_effect_+%_per_additional_melee_range"]=59,
		["cyclone_first_hit_damage_+%_final"]=350,
		["cyclone_gain_stage_every_x_ms_while_channelling"]=554,
		["cyclone_max_number_of_stages"]=555,
		["cyclone_melee_weapon_range_+_per_stage"]=556,
		["cyclone_movement_speed_+%_final"]=223,
		["cyclone_stage_decay_time_ms"]=557,
		["damage_+%"]=323,
		["damage_+%_if_lost_endurance_charge_in_past_8_seconds"]=558,
		["damage_+%_per_200_mana_spent_recently"]=559,
		["damage_+%_per_chain"]=560,
		["damage_+%_vs_burning_enemies"]=290,
		["damage_+%_vs_chilled_enemies"]=561,
		["damage_+%_vs_enemies_on_full_life"]=562,
		["damage_+%_vs_enemies_per_freeze_shock_ignite"]=563,
		["damage_+%_while_es_leeching"]=564,
		["damage_+%_while_life_leeching"]=565,
		["damage_+%_while_mana_leeching"]=566,
		["damage_cannot_be_reflected"]=293,
		["damage_infusion_%"]=37,
		["damage_over_time_+%"]=344,
		["damage_vs_cursed_enemies_per_enemy_curse_+%"]=567,
		["damage_vs_enemies_on_low_life_+%"]=568,
		["damaging_ailments_deal_damage_+%_faster"]=569,
		["dark_ritual_damage_+%_final_per_curse_applied"]=570,
		["dark_ritual_skill_effect_duration_+%_per_curse_applied"]=571,
		["dash_grants_phasing_after_use_ms"]=572,
		["deal_no_elemental_damage"]=573,
		["death_wish_attack_speed_+%"]=574,
		["death_wish_cast_speed_+%"]=575,
		["death_wish_hit_and_ailment_damage_+%_final_per_stage"]=576,
		["death_wish_max_stages"]=577,
		["death_wish_movement_speed_+%"]=578,
		["debilitate_enemies_for_1_second_on_hit_%_chance"]=579,
		["degen_effect_+%"]=153,
		["desecrate_chance_for_additional_corpse_%"]=580,
		["desecrate_chance_for_special_corpse_%"]=581,
		["desecrate_corpse_level"]=281,
		["desecrate_maximum_number_of_corpses"]=582,
		["desecrate_number_of_corpses_to_create"]=280,
		["destroy_corpses_on_kill_%_chance"]=583,
		["detonate_dead_damage_+%_if_corpse_ignited"]=584,
		["detonate_mines_recover_permyriad_of_life_per_mine_detonated"]=585,
		["disable_mine_detonation_cascade"]=586,
		["discharge_chance_not_to_consume_charges_%"]=587,
		["discharge_damage_+%_if_3_charge_types_removed"]=588,
		["disintegrate_base_radius_+_per_intensify"]=589,
		["disintegrate_damage_+%_final_per_intensity"]=590,
		["disintegrate_secondary_beam_angle_+%"]=591,
		["display_additional_projectile_per_2_mines_in_detonation_sequence"]=592,
		["display_additional_projectile_per_4_mines_in_detonation_sequence"]=593,
		["display_additional_projectile_per_mine_in_detonation_sequence"]=594,
		["display_brand_deonate_tag_conversion"]=595,
		["display_disable_melee_weapons"]=35,
		["display_herald_of_thunder_storm"]=542,
		["display_hide_projectile_chain_num"]=1056,
		["display_linked_curse_effect_+%"]=596,
		["display_max_blight_stacks"]=597,
		["display_max_fire_beam_stacks"]=598,
		["display_mine_deontation_mechanics_detonation_speed_+%_final_per_sequence_mine"]=599,
		["display_mirage_warriors_no_spirit_strikes"]=600,
		["display_modifiers_to_melee_attack_range_apply_to_skill_radius"]=601,
		["display_removes_and_grants_elusive_when_used"]=602,
		["display_skill_fixed_duration_buff"]=603,
		["display_storm_burst_jump_time_ms"]=604,
		["display_this_skill_cooldown_does_not_recover_during_buff"]=605,
		["display_vaal_breach_no_drops_xp"]=606,
		["display_vaal_molten_shell_alternate_description"]=800,
		["display_what_freezing_pulse_does"]=5,
		["distance_before_form_change_+%"]=607,
		["divine_tempest_ailment_damage_+%_final_per_stage"]=608,
		["divine_tempest_beam_width_+%"]=609,
		["divine_tempest_damage_+%_final_while_channelling"]=610,
		["divine_tempest_hit_damage_+%_final_per_stage"]=611,
		["divine_tempest_stage_on_hitting_normal_magic_%_chance"]=612,
		["divine_tempest_stage_on_hitting_rare_unique"]=613,
		["doom_blast_damage_+%_final_per_5_doom_on_hex"]=614,
		["double_slash_bleeding_damage_+%_final_in_blood_stance"]=615,
		["doubles_have_movement_speed_+%"]=111,
		["dual_strike_critical_strike_chance_+%_final_against_enemies_on_full_life"]=616,
		["dual_strike_damage_+%_final_against_enemies_on_full_life"]=617,
		["earthquake_aftershock_maximum_added_physical_damage"]=618,
		["earthquake_aftershock_minimum_added_physical_damage"]=618,
		["earthquake_initial_slam_area_of_effect_+%"]=619,
		["elemental_damage_+%_final_per_righteous_charge"]=620,
		["elemental_hit_area_of_effect_+100%_final_vs_enemy_with_associated_ailment"]=621,
		["elemental_hit_damage_+10%_final_per_enemy_elemental_ailment"]=622,
		["elemental_hit_no_physical_chaos_damage"]=301,
		["elemental_status_effect_aura_radius"]=172,
		["elemental_strike_physical_damage_%_to_convert"]=332,
		["elusive_effect_+%"]=623,
		["embrace_madness_amount_of_cooldown_to_gain_ms"]=624,
		["empowered_attack_damage_+%"]=625,
		["endurance_charge_granted_per_X_monster_power_during_endurance_warcry"]=1080,
		["enduring_cry_grants_x_additional_endurance_charges"]=626,
		["enemies_taunted_by_your_warcies_are_intimidated"]=627,
		["enemies_you_shock_take_%_increased_physical_damage"]=628,
		["enemy_aggro_radius_+%"]=337,
		["enemy_phys_reduction_%_penalty_vs_hit"]=629,
		["energy_shield_delay_-%"]=151,
		["energy_shield_leech_from_any_damage_permyriad"]=52,
		["energy_shield_recharge_rate_+%"]=152,
		["energy_shield_regeneration_rate_+%"]=630,
		["ensnaring_arrow_enemy_spell_damage_taken_+%"]=631,
		["ethereal_knives_projectiles_needed_per_vestige_blade"]=632,
		["evasion_and_physical_damage_reduction_rating_+%"]=633,
		["exerted_attack_knockback_chance_%"]=634,
		["exerted_attacks_overwhelm_%_physical_damage_reduction"]=635,
		["expanding_fire_cone_angle_+%_per_stage"]=636,
		["expanding_fire_cone_final_wave_always_ignite"]=637,
		["expanding_fire_cone_maximum_number_of_stages"]=638,
		["expanding_fire_cone_radius_+_per_stage"]=639,
		["expanding_fire_cone_radius_limit"]=639,
		["expanding_fire_cone_release_hit_damage_+%_final"]=640,
		["explosive_arrow_explosion_base_damage_+permyriad"]=145,
		["explosive_arrow_explosion_maximum_added_fire_damage"]=146,
		["explosive_arrow_explosion_minimum_added_fire_damage"]=146,
		["explosive_arrow_hit_and_ailment_damage_+%_final_per_stack"]=641,
		["explosive_arrow_maximum_bonus_explosion_radius"]=148,
		["explosive_arrow_stack_limit"]=642,
		["extra_target_targeting_distance_+%"]=643,
		["faster_bleed_%"]=644,
		["feast_of_flesh_gain_X_energy_shield_per_corpse_consumed"]=645,
		["feast_of_flesh_gain_X_life_per_corpse_consumed"]=645,
		["feast_of_flesh_gain_X_mana_per_corpse_consumed"]=645,
		["fire_beam_additional_stack_damage_+%_final"]=646,
		["fire_beam_enemy_fire_resistance_%_maximum"]=647,
		["fire_beam_enemy_fire_resistance_%_per_stack"]=648,
		["fire_beam_length_+%"]=649,
		["fire_damage_+%"]=297,
		["fire_damage_taken_+"]=227,
		["fire_dot_multiplier_+"]=650,
		["fire_golem_grants_damage_+%"]=314,
		["fire_nova_damage_+%_per_repeat_final"]=324,
		["fire_shield_damage_threshold"]=160,
		["fire_storm_fireball_delay_ms"]=149,
		["fireball_base_radius_up_to_+_at_longer_ranges"]=651,
		["firestorm_initial_impact_area_of_effect_+%_final"]=652,
		["firestorm_initial_impact_damage_+%_final"]=653,
		["firestorm_max_number_of_storms"]=654,
		["firewall_applies_%_fire_exposure"]=655,
		["fixed_skill_effect_duration"]=656,
		["flame_dash_burning_damage_+%_final"]=657,
		["flame_whip_damage_+%_final_vs_burning_enemies"]=289,
		["flameblast_ailment_damage_+%_final_per_stack"]=272,
		["flameblast_area_+%_final_per_stage"]=658,
		["flameblast_ignite_chance_+%_per_stage"]=659,
		["flameblast_maximum_stages"]=660,
		["flamethrower_damage_+%_per_stage_final"]=218,
		["flamethrower_tower_trap_display_cast_speed_affects_rotation"]=661,
		["flamethrower_tower_trap_number_of_flamethrowers"]=662,
		["flamethrower_trap_damage_+%_final_vs_burning_enemies"]=663,
		["flicker_strike_buff_movement_speed_+%"]=664,
		["flicker_strike_teleport_range_+%"]=665,
		["fortify_duration_+%"]=310,
		["fortify_on_hit"]=666,
		["fortify_on_hit_close_range"]=667,
		["freeze_applies_cold_resistance_+"]=668,
		["freeze_as_though_dealt_damage_+%"]=193,
		["freeze_duration_+%"]=87,
		["freeze_mine_cold_resistance_+_while_frozen"]=239,
		["freezing_pulse_damage_+%_final_at_long_range"]=669,
		["frenzy_skill_attack_damage_+%_final_per_frenzy_charge"]=670,
		["frenzy_skill_attack_speed_+%_final_per_frenzy_charge"]=671,
		["from_quality_brand_activation_rate_+%_final_if_75%_attached_duration_expired"]=672,
		["frost_bolt_nova_number_of_frost_bolts_to_detonate"]=673,
		["frost_fury_added_duration_per_stage_ms"]=674,
		["frost_fury_base_fire_interval_ms"]=675,
		["frost_fury_duration_+%_per_stage"]=676,
		["frost_fury_fire_speed_+%_final_while_channelling"]=677,
		["frost_fury_fire_speed_+%_per_stage"]=678,
		["frost_fury_max_number_of_stages"]=679,
		["frost_globe_absorb_damage_%_enemy_in_bubble"]=680,
		["frost_globe_absorb_damage_%_enemy_outside_bubble"]=681,
		["frost_globe_additional_spell_base_critical_strike_chance_per_stage"]=682,
		["frost_globe_health_per_stage"]=683,
		["frost_globe_life_regeneration_rate_per_minute_%"]=684,
		["frost_globe_max_stages"]=685,
		["frost_globe_stage_gain_interval_ms"]=686,
		["frostbolt_projectile_speed_+%_final"]=687,
		["fuse_arrow_explosion_radius_+_per_fuse_arrow_orb"]=148,
		["gain_1_rage_on_use_%_chance"]=688,
		["gain_elusive_on_crit_%_chance"]=689,
		["gain_endurance_charge_on_melee_stun"]=238,
		["gain_endurance_charge_on_melee_stun_%"]=238,
		["gain_frenzy_charge_on_hitting_rare_or_unique_enemy_%"]=690,
		["gain_frenzy_charge_on_hitting_unique_enemy_%"]=691,
		["gain_rage_on_hit"]=692,
		["gain_rage_on_hit_%_chance"]=693,
		["gain_righteous_charge_on_mana_spent_%"]=694,
		["glacial_cascade_final_spike_damage_+%_final"]=695,
		["glacial_cascade_travel_speed_+%"]=696,
		["glacial_hammer_third_hit_freeze_as_though_dealt_damage_+%"]=194,
		["global_always_hit"]=286,
		["global_bleed_on_hit"]=480,
		["global_chance_to_blind_on_hit_%"]=202,
		["global_chance_to_knockback_%"]=53,
		["global_hit_causes_monster_flee_%"]=181,
		["global_maim_on_hit"]=697,
		["global_maximum_added_fire_damage_vs_burning_enemies"]=973,
		["global_maximum_added_physical_damage_vs_bleeding_enemies"]=698,
		["global_minimum_added_fire_damage_vs_burning_enemies"]=973,
		["global_minimum_added_physical_damage_vs_bleeding_enemies"]=698,
		["global_poison_on_hit"]=346,
		["global_reduce_enemy_block_%"]=287,
		["glorious_madness_timer_ms"]=699,
		["golem_buff_effect_+%"]=700,
		["grant_expanding_fire_cone_release_ignite_damage_+%_final"]=701,
		["greater_projectile_intensity_projectile_damage_+%_final_per_intensity"]=702,
		["ground_slam_angle_+%"]=703,
		["groundslam_damage_to_close_targets_+%_final"]=366,
		["herald_of_agony_add_stack_on_poison"]=704,
		["herald_of_agony_poison_damage_+%_final"]=705,
		["herald_of_ash_burning_%_overkill_damage_per_minute"]=706,
		["herald_of_light_summon_champion_on_kill"]=707,
		["herald_of_light_summon_champion_on_unique_or_rare_enemy_hit_%"]=708,
		["herald_of_purity_physical_damage_+%_final"]=709,
		["hexblast_ailment_damage_+%_final_per_5_doom_on_consumed_curse"]=710,
		["hexblast_hit_damage_+%_final_per_5_doom_on_consumed_curse"]=711,
		["hinder_enemy_chaos_damage_+%"]=712,
		["hinder_enemy_chaos_damage_taken_+%"]=713,
		["holy_path_teleport_range_+%"]=714,
		["holy_relic_nova_life_regeneration_rate_per_minute"]=715,
		["holy_relic_nova_minion_life_regeneration_rate_per_second"]=716,
		["ice_crash_first_stage_damage_+%_final"]=717,
		["ice_crash_second_hit_damage_+%_final"]=312,
		["ice_crash_third_hit_damage_+%_final"]=313,
		["ice_dash_cooldown_recovery_per_nearby_normal_or_magic_enemy"]=718,
		["ice_dash_cooldown_recovery_per_nearby_rare_or_unique_enemy"]=718,
		["ice_golem_grants_accuracy_+%"]=316,
		["ice_golem_grants_critical_strike_chance_+%"]=315,
		["ice_nova_number_of_frost_bolts_to_cast_on"]=719,
		["ice_nova_number_of_repeats"]=283,
		["ice_nova_radius_+%_per_repeat"]=284,
		["ice_shield_moving_mana_degeneration_per_minute"]=225,
		["ice_spear_distance_before_form_change_+%"]=720,
		["ice_spear_second_form_critical_strike_chance_+%"]=199,
		["ice_spear_second_form_critical_strike_multiplier_+"]=200,
		["ice_spear_second_form_projectile_speed_+%_final"]=201,
		["ignite_duration_+%"]=91,
		["ignites_apply_fire_resistance_+"]=721,
		["immolation_brand_burn_damage_+%_final_per_stage"]=722,
		["immortal_call_elemental_damage_taken_+%_final_per_endurance_charge_consumed"]=723,
		["impacting_steel_secondary_projectile_damage_+%_final"]=724,
		["impale_debuff_effect_+%"]=725,
		["impale_phys_reduction_%_penalty"]=726,
		["impurity_cold_damage_taken_+%_final"]=727,
		["impurity_fire_damage_taken_+%_final"]=728,
		["impurity_lightning_damage_taken_+%_final"]=729,
		["incinerate_damage_+%_per_stage"]=219,
		["infernal_blow_explosion_applies_uncharged_debuff_on_hit_%_chance"]=730,
		["infernal_blow_explosion_damage_%_of_total_per_stack"]=731,
		["infernal_cry_%_max_life_as_fire_on_death"]=308,
		["infernal_cry_covered_in_ash_fire_damage_taken_%_per_5_monster_power"]=1079,
		["infernal_cry_empowered_attacks_trigger_combust_display"]=1090,
		["infusion_grants_life_regeneration_rate_per_minute_%"]=732,
		["inspiration_charge_duration_+%"]=733,
		["inspiring_cry_damage_+%_per_one_hundred_nearby_enemies"]=321,
		["intermediary_chaos_area_damage_to_deal_per_minute"]=129,
		["intermediary_chaos_damage_to_deal_per_minute"]=130,
		["intermediary_chaos_skill_dot_area_damage_to_deal_per_minute"]=131,
		["intermediary_chaos_skill_dot_damage_to_deal_per_minute"]=132,
		["intermediary_cold_area_damage_to_deal_per_minute"]=133,
		["intermediary_cold_damage_to_deal_per_minute"]=134,
		["intermediary_cold_skill_dot_area_damage_to_deal_per_minute"]=135,
		["intermediary_cold_skill_dot_damage_to_deal_per_minute"]=136,
		["intermediary_fire_area_damage_to_deal_per_minute"]=137,
		["intermediary_fire_damage_to_deal_per_minute"]=138,
		["intermediary_fire_skill_dot_area_damage_to_deal_per_minute"]=139,
		["intermediary_fire_skill_dot_damage_to_deal_per_minute"]=140,
		["intimidate_nearby_enemies_on_use_for_ms"]=734,
		["intimidating_cry_empowerd_attacks_deal_double_damage_display"]=1091,
		["intimidating_cry_enemy_phys_reduction_%_penalty_vs_hit_per_5_MP"]=1076,
		["is_empowered"]=735,
		["is_ranged_attack_totem"]=32,
		["is_remote_mine"]=29,
		["is_snipe_default_projectile"]=909,
		["is_snipe_default_projectile_2"]=908,
		["is_totem"]=32,
		["is_trap"]=30,
		["keystone_minion_instability"]=122,
		["keystone_point_blank"]=177,
		["kill_enemy_on_hit_if_under_10%_life"]=176,
		["killed_monster_dropped_item_quantity_+%"]=96,
		["killed_monster_dropped_item_rarity_+%"]=95,
		["kinetic_blast_projectiles_gain_%_aoe_after_forking"]=736,
		["kinetic_bolt_forks_apply_to_zig_zags"]=737,
		["kinetic_bolt_number_of_zig_zags"]=1101,
		["knockback_chance_%_at_close_range"]=738,
		["knockback_distance_+%"]=54,
		["lacerate_hit_and_ailment_damage_+%_final_vs_bleeding_enemies"]=739,
		["lancing_steel_damage_+%_at_close_range"]=740,
		["lancing_steel_damage_+%_final_after_first_hit_on_target"]=741,
		["lancing_steel_targeting_range_+%"]=742,
		["life_gain_per_target"]=109,
		["life_leech_from_any_damage_permyriad"]=50,
		["life_leech_from_physical_attack_damage_permyriad"]=51,
		["life_regeneration_rate_+%"]=197,
		["life_regeneration_rate_per_minute_%"]=196,
		["light_radius_increases_apply_to_area_of_effect"]=26,
		["lightning_ailment_effect_+%"]=743,
		["lightning_arrow_%_chance_to_hit_an_additional_enemy"]=744,
		["lightning_arrow_maximum_number_of_extra_targets"]=171,
		["lightning_explosion_mine_aura_damage_taken_+%"]=1103,
		["lightning_golem_grants_attack_and_cast_speed_+%"]=319,
		["lightning_tendrils_channelled_larger_pulse_damage_+%_final"]=745,
		["lightning_tendrils_channelled_larger_pulse_interval"]=116,
		["lightning_tendrils_channelled_larger_pulse_radius_+"]=746,
		["lightning_tower_trap_interval_duration_ms"]=747,
		["lightning_tower_trap_number_of_beams"]=747,
		["lightning_trap_projectiles_leave_shocking_ground"]=294,
		["lose_all_righteous_charges_on_mana_use_threshold"]=748,
		["magma_brand_ailment_damage_+%_final_per_additional_pustule"]=749,
		["magma_brand_hit_damage_+%_final_per_additional_pustule"]=750,
		["magma_orb_%_chance_to_big_explode_instead_of_chaining"]=751,
		["maim_effect_+%"]=752,
		["maim_on_hit_%"]=753,
		["mamba_strike_deal_%_of_all_poison_total_damage_per_minute"]=754,
		["mana_degeneration_per_minute"]=224,
		["mana_gain_per_target"]=755,
		["max_crab_aspect_stacks"]=756,
		["max_number_of_lightning_warp_markers"]=757,
		["max_steel_ammo"]=758,
		["maximum_added_cold_damage_per_frenzy_charge"]=771,
		["maximum_added_cold_damage_vs_chilled_enemies"]=772,
		["maximum_added_lightning_damage_from_skill"]=773,
		["maximum_fire_damage_per_fuse_arrow_orb"]=147,
		["maximum_life_+%_for_corpses_you_create"]=759,
		["maximum_number_of_blades_left_in_ground"]=760,
		["maximum_number_of_mirage_warriors"]=761,
		["maximum_number_of_snapping_adder_projectiles"]=762,
		["maximum_number_of_spinning_blades"]=340,
		["maximum_number_of_spiritual_cry_warriors"]=1081,
		["maximum_secondary_physical_damage_per_15_strength"]=775,
		["maximum_virulence_stacks"]=763,
		["melee_ancestor_totem_grant_owner_attack_speed_+%"]=45,
		["melee_ancestor_totem_grant_owner_attack_speed_+%_final"]=42,
		["melee_counterattack_trigger_on_block_%"]=245,
		["melee_counterattack_trigger_on_hit_%"]=243,
		["melee_damage_vs_bleeding_enemies_+%"]=326,
		["melee_physical_damage_+%"]=144,
		["melee_range_+"]=334,
		["melee_splash_area_of_effect_+%_final"]=349,
		["melee_weapon_range_+"]=333,
		["mine_cannot_rearm"]=765,
		["mine_critical_strike_chance_+%_per_power_charge"]=766,
		["mine_detonates_instantly"]=767,
		["mine_detonation_radius_+%"]=34,
		["mine_detonation_speed_+%"]=768,
		["mine_duration"]=191,
		["mine_laying_speed_+%"]=190,
		["mine_projectile_speed_+%_per_frenzy_charge"]=769,
		["mine_throwing_speed_+%_per_frenzy_charge"]=770,
		["minimum_added_cold_damage_per_frenzy_charge"]=771,
		["minimum_added_cold_damage_vs_chilled_enemies"]=772,
		["minimum_added_lightning_damage_from_skill"]=773,
		["minimum_fire_damage_per_fuse_arrow_orb"]=147,
		["minimum_power_from_quality"]=774,
		["minimum_secondary_physical_damage_per_15_strength"]=775,
		["minion_%_chance_to_be_summoned_with_maximum_frenzy_charges"]=790,
		["minion_additional_physical_damage_reduction_%"]=776,
		["minion_ailment_damage_+%"]=777,
		["minion_attack_speed_+%"]=112,
		["minion_block_%"]=778,
		["minion_burning_damage_+%"]=779,
		["minion_cast_speed_+%"]=113,
		["minion_chance_to_deal_double_damage_%"]=780,
		["minion_chance_to_taunt_on_hit_%"]=781,
		["minion_cooldown_recovery_+%"]=782,
		["minion_damage_+%"]=110,
		["minion_damage_+%_on_full_life"]=783,
		["minion_duration"]=75,
		["minion_fire_damage_taken_+%"]=784,
		["minion_grant_puppet_master_buff_to_parent_on_hit_%"]=785,
		["minion_larger_aggro_radius"]=1107,
		["minion_life_regeneration_rate_per_minute_%"]=786,
		["minion_maim_on_hit_%"]=787,
		["minion_maximum_all_elemental_resistances_%"]=788,
		["minion_maximum_life_+%"]=121,
		["minion_melee_damage_+%"]=789,
		["minion_movement_speed_+%"]=114,
		["minion_skill_area_of_effect_+%"]=791,
		["minion_stun_threshold_reduction_+%"]=792,
		["minions_are_defensive"]=1108,
		["minions_cannot_be_damaged_after_summoned_ms"]=793,
		["minions_chance_to_intimidate_on_hit_%"]=794,
		["minions_deal_%_of_physical_damage_as_additional_chaos_damage"]=795,
		["minions_inflict_exposure_on_hit_%_chance"]=796,
		["minions_take_%_of_life_as_chaos_damage_when_summoned_over_1_second"]=797,
		["mirage_archer_number_of_additional_projectiles"]=798,
		["modifiers_to_buff_effect_duration_also_affect_soul_prevention_duration"]=28,
		["modifiers_to_skill_effect_duration_also_affect_soul_prevention_duration"]=27,
		["molten_shell_%_of_absorbed_damage_dealt_as_reflected_fire"]=800,
		["molten_shell_damage_absorb_limit_%_of_armour"]=799,
		["molten_shell_damage_absorbed_%"]=799,
		["molten_shell_explosion_damage_penetrates_%_fire_resistance"]=801,
		["molten_shell_max_damage_absorbed"]=799,
		["molten_strike_projectiles_chain_when_impacting_ground"]=802,
		["monster_response_time_ms"]=142,
		["mortal_call_elemental_damage_taken_+%_final"]=803,
		["mortal_call_physical_damage_taken_+%_final"]=804,
		["mortal_call_physical_damage_taken_per_endurance_charge_consumed_final_permyriad"]=805,
		["mortar_barrage_mine_maximum_added_fire_damage_taken"]=1104,
		["mortar_barrage_mine_maximum_added_fire_damage_taken_limit"]=1104,
		["mortar_barrage_mine_minimum_added_fire_damage_taken"]=1104,
		["mortar_barrage_mine_minimum_added_fire_damage_taken_limit"]=1104,
		["movement_velocity_cap"]=117,
		["multiple_projectiles_projectile_spread_+%"]=806,
		["multistrike_area_of_effect_+%_per_repeat"]=807,
		["multistrike_damage_+%_final_on_first_repeat"]=808,
		["multistrike_damage_+%_final_on_second_repeat"]=809,
		["multistrike_damage_+%_final_on_third_repeat"]=810,
		["never_freeze"]=291,
		["never_ignite"]=292,
		...
		["nightblade_elusive_grants_critical_strike_multiplier_+_to_supported_skills"]=811,
		["no_additional_projectiles_if_no_steel_ammo"]=812,
		["no_movement_speed"]=94,
		["non_damaging_ailment_effect_+%"]=813,
		["number_of_allowed_firewalls"]=814,
		["number_of_champions_of_light_allowed"]=815,
		["number_of_corpses_to_consume"]=816,
		["number_of_herald_scorpions_allowed"]=818,
		["number_of_mines_to_place"]=29,
		["number_of_relics_allowed"]=819,
		["number_of_support_ghosts_allowed"]=456,
		["number_of_totems_to_summon"]=32,
		["number_of_traps_to_throw"]=30,
		["offering_skill_effect_duration_per_corpse"]=19,
		["orb_of_storms_bolt_frequency_ms"]=820,
		["overpowered_effect_+%"]=821,
		["overwhelm_%_physical_damage_reduction_while_fortified"]=822,
		["parallel_projectile_firing_point_x_dist_+%"]=823,
		parent="active_skill_gem_stat_descriptions",
		["penance_brand_additional_descriptions_boolean"]=824,
		["penance_brand_base_spread_radius_+"]=825,
		["petrification_statue_target_action_speed_-%"]=831,
		["phantasm_grant_buff_maximum_added_physical_damage"]=832,
		["phantasm_grant_buff_minimum_added_physical_damage"]=832,
		["phase_run_%_chance_to_not_replace_buff_on_skill_use"]=833,
		["phase_run_melee_physical_damage_+%_final"]=143,
		["phase_through_objects"]=336,
		["phys_cascade_trap_interval_duration_ms"]=834,
		["phys_cascade_trap_number_of_cascades"]=834,
		["physical_damage_%_to_add_as_chaos"]=296,
		["physical_damage_%_to_add_as_fire"]=295,
		["physical_damage_reduction_%_per_crab_aspect_stack"]=835,
		["physical_damage_reduction_rating_+%"]=161,
		["physical_damage_taken_+"]=226,
		["plague_bearer_chaos_damage_taken_+%_while_incubating"]=836,
		["plague_bearer_movement_speed_+%_while_infecting"]=837,
		["poison_dot_multiplier_+"]=838,
		["poison_skill_effect_duration"]=74,
		["portal_alternate_destination_chance_permyriad"]=839,
		["power_siphon_fire_at_all_targets"]=38,
		["primary_projectile_display_targets_to_pierce"]=82,
		["primary_projectile_impale_chance_%"]=840,
		["projectile_attack_damage_+%_in_blood_stance"]=841,
		["projectile_chance_to_not_pierce_%"]=843,
		["projectile_damage_+%_if_pierced_enemy"]=844,
		["projectile_damage_+%_per_remaining_chain"]=845,
		["projectile_damage_modifiers_apply_to_skill_dot"]=25,
		["projectile_ground_effect_duration"]=72,
		["projectile_maximum_range_override"]=846,
		["projectile_number_of_targets_to_pierce"]=81,
		["projectile_return_%_chance"]=847,
		["projectile_speed_+%_in_sand_stance"]=848,
		["projectile_spiral_nova_angle"]=38,
		["projectiles_barrage"]=38,
		["projectiles_can_split_at_end_of_range"]=842,
		["projectiles_can_split_from_terrain"]=842,
		["projectiles_chance_to_return_%"]=215,
		["projectiles_damage_+%_to_nearby_targets"]=849,
		["projectiles_nova"]=38,
		["projectiles_pierce_all_targets_in_x_range"]=850,
		["projectiles_rain"]=851,
		["projectiles_return"]=215,
		["projectiles_return_if_no_hit_object"]=215,
		["puncture_bleeding_damage_+%_final"]=852,
		["puppet_master_duration_ms"]=853,
		["purge_expose_resist_%_matching_highest_element_damage"]=854,
		["purifying_flame_%_chance_to_create_consecrated_ground_around_you"]=855,
		["quake_slam_fully_charged_explosion_damage_+%_final"]=338,
		["quality_display_active_skill_ignite_damage_is_gem"]=399,
		["quality_display_active_skill_returning_damage_is_gem"]=365,
		["quality_display_circle_of_power_is_gem"]=527,
		["quality_display_glacial_cascade_is_gem"]=695,
		["quality_display_ice_crash_is_gem"]=313,
		["quality_display_immortal_call_is_gem"]=805,
		["quality_display_incinerate_is_gem_hit"]=640,
		["quality_display_incinerate_is_gem_ingite"]=701,
		["quality_display_rune_paint_is_gem"]=869,
		["quick_guard_damage_absorb_limit"]=856,
		["quick_guard_damage_absorbed_%"]=856,
		["rain_of_arrows_additional_sequence_chance_%"]=857,
		["rain_of_arrows_sequences_to_fire"]=38,
		["raised_spectre_level"]=858,
		["rallying_cry_buff_effect_on_minions_+%_final"]=1082,
		["rallying_cry_damage_+%_final_from_osm_per_nearby_ally"]=1085,
		["rallying_cry_weapon_damage_%_for_allies_per_5_monster_power"]=1074,
		["reave_additional_max_stacks"]=859,
		["reave_area_of_effect_+%_final_per_stage"]=237,
		["recall_sigil_target_search_range_+%"]=860,
		["recover_%_life_when_stunning_an_enemy_permyriad"]=861,
		["recover_%_maximum_life_on_cull"]=862,
		["reduce_enemy_chaos_resistance_%"]=863,
		["reduce_enemy_dodge_%"]=288,
		["reduce_enemy_elemental_resistance_%"]=207,
		["refresh_bleeding_duration_on_hit_%_chance"]=864,
		["rejuvenation_totem_nearby_enemies_taken_%_of_life_regen_as_chaos_damage"]=866,
		["returning_projectiles_always_pierce"]=368,
		["righteous_fire_spell_damage_+%_final"]=167,
		["rune_paint_area_of_effect_+%_final_per_rune_level"]=867,
		["rune_paint_area_of_effect_+%_per_rune_level"]=868,
		["rune_paint_damage_+%_final_per_rune_level"]=869,
		["rune_paint_mana_spend_per_rune_upgrade"]=870,
		["rune_paint_max_rune_level"]=871,
		["sanctify_wave_damage_+%_final"]=872,
		["scorpion_minion_attack_speed_+%"]=873,
		["scorpion_minion_maximum_added_physical_damage"]=875,
		["scorpion_minion_minimum_added_physical_damage"]=875,
		["scorpion_minion_physical_damage_+%"]=874,
		["secondary_buff_effect_duration"]=69,
		["secondary_intermediary_fire_skill_dot_damage_to_deal_per_minute"]=141,
		["secondary_maximum_chaos_damage"]=16,
		["secondary_maximum_cold_damage"]=14,
		["secondary_maximum_fire_damage"]=13,
		["secondary_maximum_lightning_damage"]=15,
		["secondary_maximum_physical_damage"]=12,
		["secondary_minimum_chaos_damage"]=16,
		["secondary_minimum_cold_damage"]=14,
		["secondary_minimum_fire_damage"]=13,
		["secondary_minimum_lightning_damage"]=15,
		["secondary_minimum_physical_damage"]=12,
		["secondary_minion_duration"]=76,
		["secondary_skill_effect_duration"]=71,
		["seismic_cry_+%_enemy_stun_threshold_per_5_MP"]=1075,
		["seismic_cry_base_slam_skill_area_+%"]=1088,
		["seismic_cry_base_slam_skill_damage_+%_final"]=1086,
		["seismic_cry_exerted_attack_damage_+%"]=876,
		["seismic_cry_slam_skill_area_+%_increase_per_repeat"]=1089,
		["seismic_cry_slam_skill_damage_+%_final_increase_per_repeat"]=1087,
		["sentinel_minion_cooldown_speed_+%"]=877,
		["shattering_steel_damage_+%_final_scaled_by_projectile_distance_per_ammo_consumed"]=878,
		["shield_block_%"]=158,
		["shield_charge_damage_+%_maximum"]=80,
		["shield_charge_scaling_stun_threshold_reduction_+%_at_maximum_range"]=78,
		["shield_charge_stun_duration_+%_maximum"]=79,
		["shield_spell_block_%"]=159,
		["shock_duration_+%"]=90,
		["shock_effect_+%"]=879,
		["shock_nova_ring_chance_to_shock_+%"]=880,
		["shock_nova_ring_damage_+%"]=353,
		["shock_nova_ring_shocks_as_if_dealing_damage_+%_final"]=881,
		["shocked_ground_base_magnitude_override"]=882,
		["shockwave_slam_explosion_damage_+%_final"]=351,
		["shrapnel_shot_cone_placement_distance_+"]=883,
		["shrapnel_trap_number_of_secondary_explosions"]=884,
		["sigil_attached_target_fire_penetration_%"]=885,
		["sigil_attached_target_lightning_penetration_%"]=886,
		["sigil_recall_extend_base_secondary_skill_effect_duration"]=887,
		["sigil_recall_extend_base_skill_effect_duration"]=888,
		["siphon_life_leech_from_damage_permyriad"]=339,
		["skeletal_chains_aoe_%_health_dealt_as_chaos_damage"]=2,
		["skeletal_chains_no_minions_damage_+%_final"]=209,
		["skeletal_chains_no_minions_radius_+"]=210,
		["skeletal_chains_no_minions_targets_self"]=208,
		["skill_angle_+%_in_sand_stance"]=889,
		["skill_area_angle_+%"]=890,
		["skill_area_of_effect_+%_final_in_sand_stance"]=891,
		["skill_buff_effect_+%"]=354,
		["skill_buff_grants_attack_and_cast_speed_+%"]=892,
		["skill_buff_grants_chance_to_poison_%"]=343,
		["skill_can_only_use_bow"]=1011,
		["skill_can_only_use_non_melee_weapons"]=1014,
		["skill_can_own_mirage_archers"]=893,
		["skill_code_movement_speed_+%_final"]=894,
		["skill_convert_%_physical_damage_to_random_element"]=895,
		["skill_damage_+%_final_per_chain_from_skill_specific_stat"]=896,
		["skill_display_number_of_remote_mines_allowed"]=185,
		["skill_display_number_of_totems_allowed"]=183,
		["skill_display_number_of_traps_allowed"]=184,
		["skill_effect_and_damaging_ailment_duration_+%"]=897,
		["skill_effect_duration"]=70,
		["skill_effect_duration_+%_per_removable_frenzy_charge"]=157,
		["skill_effect_duration_+%_while_dead"]=899,
		["skill_effect_duration_per_100_int"]=898,
		["skill_empower_limitation_specifier_for_stat_description"]=1083,
		["skill_empowers_next_x_melee_attacks"]=1083,
		["skill_is_ice_storm"]=654,
		["skill_is_steel_skill_reload"]=3,
		["skill_max_unleash_seals"]=1099,
		["skill_maximum_travel_distance_+%"]=900,
		["skill_travel_distance_+%"]=901,
		["skill_triggered_by_snipe"]=902,
		["skill_triggered_when_you_focus_chance_%"]=903,
		["skill_used_by_mirage_chieftain_damage_+%_final"]=904,
		["skill_used_by_mirage_warrior_damage_+%_final"]=905,
		["skill_withered_duration_ms"]=108,
		["slam_ancestor_totem_grant_owner_melee_damage_+%"]=46,
		["slam_ancestor_totem_grant_owner_melee_damage_+%_final"]=43,
		["slash_ancestor_totem_grant_owner_physical_damage_added_as_fire_+%"]=44,
		["slither_wither_stacks"]=906,
		["snapping_adder_released_projectile_damage_+%_final"]=367,
		["snipe_max_stacks"]=907,
		["snipe_triggered_skill_ailment_damage_+%_final_per_stage"]=908,
		["snipe_triggered_skill_hit_damage_+%_final_per_stage"]=909,
		["spectre_duration"]=77,
		["spell_area_damage_+%_in_blood_stance"]=910,
		["spell_area_of_effect_+%_in_sand_stance"]=911,
		["spell_cast_time_cannot_be_modified"]=912,
		["spell_damage_+%"]=169,
		["spell_damage_modifiers_apply_to_skill_dot"]=24,
		["spell_echo_plus_chance_double_damage_%_final"]=913,
		["spell_maximum_added_cold_damage"]=299,
		["spell_maximum_added_lightning_damage"]=300,
		["spell_maximum_base_cold_damage_+_per_10_intelligence"]=21,
		["spell_maximum_base_cold_damage_per_removable_frenzy_charge"]=20,
		["spell_maximum_base_fire_damage_per_removable_endurance_charge"]=18,
		["spell_maximum_base_lightning_damage_per_removable_power_charge"]=17,
		["spell_maximum_base_physical_damage_per_shield_quality"]=914,
		["spell_maximum_chaos_damage"]=11,
		["spell_maximum_cold_damage"]=9,
		["spell_maximum_fire_damage"]=8,
		["spell_maximum_lightning_damage"]=10,
		["spell_maximum_physical_damage"]=7,
		["spell_minimum_added_cold_damage"]=299,
		["spell_minimum_added_lightning_damage"]=300,
		["spell_minimum_base_cold_damage_+_per_10_intelligence"]=21,
		["spell_minimum_base_cold_damage_per_removable_frenzy_charge"]=20,
		["spell_minimum_base_fire_damage_per_removable_endurance_charge"]=18,
		["spell_minimum_base_lightning_damage_per_removable_power_charge"]=17,
		["spell_minimum_base_physical_damage_per_shield_quality"]=914,
		["spell_minimum_chaos_damage"]=11,
		["spell_minimum_cold_damage"]=9,
		["spell_minimum_fire_damage"]=8,
		["spell_minimum_lightning_damage"]=10,
		["spell_minimum_physical_damage"]=7,
		["spell_only_castable_on_death"]=242,
		["spell_repeat_count"]=36,
		["spell_uncastable_if_triggerable"]=242,
		["spells_chance_to_hinder_on_hit_%"]=915,
		["spellslinger_mana_reservation"]=916,
		["spellslinger_trigger_on_wand_attack_%"]=260,
		["spider_aspect_max_web_count"]=917,
		["spike_slam_additional_spike_%_chance"]=918,
		["spike_slam_explosion_damage_+%_final"]=919,
		["spike_slam_fissure_damage_+%_final"]=920,
		["spike_slam_fissure_length_+%"]=921,
		["spike_slam_max_spikes"]=922,
		["spike_slam_num_spikes"]=923,
		["spike_slam_spike_damage_+%_final"]=924,
		["spiritual_cry_double_movement_velocity_+%"]=925,
		["spiritual_cry_doubles_summoned_per_5_MP"]=1081,
		["splitting_steel_area_+%_final_after_splitting"]=926,
		["static_strike_beam_damage_+%_final"]=927,
		["static_strike_beam_damage_+%_final_while_moving"]=928,
		["static_strike_explosion_damage_+%_final"]=302,
		["static_strike_number_of_beam_targets"]=929,
		["stealth_+%"]=930,
		["steel_ammo_consumed_per_use"]=931,
		["steel_skill_%_chance_to_not_consume_ammo"]=932,
		["steel_steal_area_of_effect_+%"]=933,
		["steel_steal_reflect_damage_+%"]=934,
		["stone_golem_grants_base_life_regeneration_rate_per_minute"]=318,
		["storm_burst_explosion_area_of_effect_+%"]=935,
		["storm_burst_new_damage_+%_final_per_remaining_teleport_zap"]=936,
		["storm_burst_zap_area_of_effect_+%"]=937,
		["storm_call_chance_to_strike_on_cast_%"]=938,
		["summon_cold_resistance_+"]=233,
		["summon_fire_resistance_+"]=232,
		["summon_lightning_resistance_+"]=234,
		["summon_mirage_archer_on_hit"]=939,
		["summon_mirage_warrior_on_crit"]=940,
		["summon_totem_cast_speed_+%"]=327,
		["summoned_spider_grants_attack_speed_+%"]=941,
		["summoned_spider_grants_poison_damage_+%"]=942,
		["sunder_shockwave_area_of_effect_+%"]=943,
		["sunder_shockwave_limit_per_cascade"]=944,
		["sunder_wave_area_of_effect_+%"]=945,
		["sunder_wave_delay_+%"]=946,
		["sunder_wave_max_steps"]=947,
		["sunder_wave_min_steps"]=948,
		["sunder_wave_radius_+_per_step"]=949,
		["support_additional_trap_%_chance_for_1_additional_trap"]=953,
		["support_additional_trap_mine_%_chance_for_1_additional_trap_mine"]=950,
		["support_additional_trap_mine_%_chance_for_2_additional_trap_mine"]=951,
		["support_additional_trap_mine_%_chance_for_3_additional_trap_mine"]=952,
		["support_ancestral_slam_big_hit_ailment_damage_+%_final"]=389,
		["support_ancestral_slam_big_hit_area_+%"]=390,
		["support_ancestral_slam_big_hit_hit_damage_+%_final"]=388,
		["support_anticipation_charge_gain_interval_ms"]=1099,
		["support_anticipation_rapid_fire_count"]=1099,
		["support_arcane_surge_cast_speed_+%"]=371,
		["support_arcane_surge_duration_ms"]=372,
		["support_arcane_surge_gain_buff_on_mana_use_threshold"]=370,
		["support_arcane_surge_mana_regeneration_rate_per_minute_%"]=371,
		["support_arcane_surge_spell_damage_+%_final"]=371,
		["support_attack_totem_attack_speed_+%_final"]=279,
		["support_aura_duration_buff_duration"]=954,
		["support_aura_duration_reserve_duration"]=955,
		["support_better_ailments_ailment_damage_+%_final"]=956,
		["support_bloodlust_melee_physical_damage_+%_final_vs_bleeding_enemies"]=325,
		["support_blunt_chance_to_trigger_shockwave_on_hit_%"]=957,
		["support_chance_to_bleed_bleeding_damage_+%_final"]=958,
		["support_chilling_areas_also_grant_cold_damage_taken_+%_equal_to_slow_amount"]=960,
		["support_chilling_areas_also_grant_cold_damage_taken_per_minute_+%"]=959,
		["support_chills_also_grant_cold_damage_taken_+%_equal_to_slow_amount"]=962,
		["support_chills_also_grant_cold_damage_taken_per_minute_+%"]=961,
		["support_concentrated_effect_skill_area_of_effect_+%_final"]=63,
		["support_debilitate_hit_damage_+%_final_per_poison_stack"]=963,
		["support_debilitate_hit_damage_max_poison_stacks"]=963,
		["support_energy_shield_leech_damage_+%_while_leeching_energy_shield_final"]=964,
		["support_ghost_duration"]=965,
		["support_greater_spell_echo_area_of_effect_+%_per_repeat"]=966,
		["support_greater_spell_echo_spell_damage_+%_final_per_repeat"]=967,
		["support_hypothermia_damage_+%_vs_chilled_enemies_final"]=335,
		["support_ignite_prolif_ignite_damage_+%_final"]=968,
		["support_ignite_proliferation_radius"]=173,
		["support_innervate_buff_duration_ms"]=375,
		["support_innervate_chance_to_gain_buff_on_shock_vs_unique_%"]=969,
		["support_innervate_gain_buff_on_killing_shocked_enemy"]=373,
		["support_innervate_maximum_added_lightning_damage"]=374,
		["support_innervate_minimum_added_lightning_damage"]=374,
		["support_maim_chance_physical_damage_+%_final"]=970,
		["support_maimed_enemies_physical_damage_taken_+%"]=971,
		["support_minefield_mine_throwing_speed_+%_final"]=972,
		["support_minion_defensive_stance_minion_damage_+%_final_against_enemies_near_you"]=974,
		["support_minion_defensive_stance_minion_damage_taken_+%_final"]=975,
		["support_minion_maximum_life_+%_final"]=120,
		["support_minion_offensive_stance_minion_damage_+%_final_while_you_have_puppet_master"]=976,
		["support_minion_totem_resistance_elemental_damage_+%_final"]=977,
		["support_mirage_archer_attack_speed_+%_final"]=978,
		["support_mirage_archer_duration"]=979,
		["support_multicast_cast_speed_+%_final"]=49,
		["support_multiple_attacks_melee_attack_speed_+%_final"]=231,
		["support_multiple_projectiles_critical_strike_chance_+%_final"]=105,
		["support_overpowered_duration_ms"]=980,
		["support_parallel_projectile_number_of_points_per_side"]=981,
		["support_power_charge_on_crit_damage_+%_final_per_power_charge"]=982,
		["support_projectile_attack_speed_+%_final"]=277,
		["support_pulverise_area_of_effect_+%_final"]=983,
		["support_rage_gain_rage_on_melee_hit_cooldown_ms"]=984,
		["support_reduce_enemy_block_and_spell_block_%"]=985,
		["support_reduce_enemy_dodge_and_spell_dodge_%"]=986,
		["support_remote_mine_2_chance_to_deal_double_damage_%_against_enemies_near_mines"]=1105,
		["support_remote_mine_damage_+%_final_per_mine_detonation_cascade"]=987,
		["support_ruthless_big_hit_damage_+%_final"]=377,
		["support_ruthless_big_hit_max_count"]=376,
		["support_ruthless_big_hit_stun_base_duration_override_ms"]=379,
		["support_ruthless_blow_bleeding_damage_from_melee_hits_+%_final"]=378,
		["support_scion_onslaught_for_3_seconds_on_hitting_unique_enemy_%_chance"]=988,
		["support_scion_onslaught_on_killing_blow_%_chance"]=989,
		["support_scion_onslaught_on_killing_blow_duration_ms"]=989,
		["support_slashing_buff_attack_cast_speed_+%_final_to_grant"]=991,
		["support_slashing_buff_duration_ms"]=990,
		["support_slashing_damage_+%_final_from_distance"]=992,
		["support_spell_boost_area_damage_+%_final_per_charge"]=993,
		["support_spell_boost_area_of_effect_+%_final_per_charge"]=993,
		["support_spell_cascade_area_delay_+%"]=994,
		["support_spell_cascade_area_of_effect_+%_final"]=995,
		["support_spell_cascade_number_of_cascades_per_side"]=996,
		["support_spell_cascade_sideways"]=996,
		["support_spell_echo_final_repeat_damage_+%_final"]=997,
		["support_spell_rapid_fire_repeat_use_damage_+%_final"]=1100,
		["support_spell_totem_cast_speed_+%_final"]=278,
		["support_storm_barrier_chaos_damage_+%_final_to_apply"]=998,
		["support_storm_barrier_chaos_damage_taken_+%_final_from_hits_while_channelling"]=1005,
		["support_storm_barrier_cold_damage_+%_final_to_apply"]=999,
		["support_storm_barrier_cold_damage_taken_+%_final_from_hits_while_channelling"]=1006,
		["support_storm_barrier_damage_buff_duration_ms"]=1000,
		["support_storm_barrier_fire_damage_+%_final_to_apply"]=1001,
		["support_storm_barrier_fire_damage_taken_+%_final_from_hits_while_channelling"]=1007,
		["support_storm_barrier_lightning_damage_+%_final_to_apply"]=1002,
		["support_storm_barrier_lightning_damage_taken_+%_final_from_hits_while_channelling"]=1008,
		["support_storm_barrier_physical_damage_+%_final_to_apply"]=1003,
		["support_storm_barrier_physical_damage_taken_when_hit_+%_final"]=1004,
		["support_unbound_ailments_ailment_damage_+%_final"]=1009,
		["supported_skill_can_only_use_axe_and_sword"]=1010,
		["supported_skill_can_only_use_dagger_and_claw"]=1012,
		["supported_skill_can_only_use_mace_and_staff"]=1013,
		["tectonic_slam_side_crack_additional_chance_%"]=1016,
		["tectonic_slam_side_crack_additional_chance_%_per_endurance_charge"]=1017,
		["tectonic_slam_side_crack_additional_chance_1%_per_2_stat_value"]=1015,
		["tethered_enemies_take_attack_projectile_damage_taken_+%"]=1018,
		["tethered_movement_speed_+%_final_per_rope"]=1019,
		["tethered_movement_speed_+%_final_per_rope_vs_rare"]=1020,
		["tethered_movement_speed_+%_final_per_rope_vs_unique"]=1021,
		["tethering_arrow_display_rope_limit"]=1022,
		["throw_traps_in_circle_radius"]=31,
		["total_number_of_arrows_to_fire"]=38,
		["total_number_of_projectiles_to_fire"]=38,
		["totem_duration"]=186,
		["totem_life_+%"]=192,
		["totem_range"]=182,
		["totems_cannot_evade"]=187,
		["totems_explode_on_death_for_%_life_as_physical"]=1023,
		["totems_regenerate_%_life_per_second"]=1024,
		["trap_critical_strike_multiplier_+_per_power_charge"]=1025,
		["trap_duration"]=188,
		["trap_spread_+%"]=1026,
		["trap_throwing_speed_+%"]=189,
		["trap_throwing_speed_+%_per_frenzy_charge"]=1027,
		["trap_trigger_radius_+%"]=33,
		["trap_trigger_radius_+%_per_power_charge"]=1028,
		["trigger_after_spending_200_mana_%_chance"]=1029,
		["trigger_brand_support_hit_ailment_damage_+%_final_vs_branded_enemy"]=1030,
		["trigger_on_block_%_chance"]=1031,
		["trigger_on_bow_attack_%"]=1032,
		["trigger_on_corpse_consume_%_chance"]=1033,
		["trigger_on_kill_vs_frozen_enemy_%"]=1034,
		["trigger_on_skill_use_%_if_you_have_a_spirit_charge"]=254,
		["trigger_on_skill_use_%_if_you_have_a_void_arrow"]=1035,
		["trigger_on_skill_use_from_chest_%"]=253,
		["trigger_on_slam_%_chance"]=1036,
		["triggered_by_brand_support"]=1037,
		["triggered_by_infernal_cry"]=1038,
		["triggered_by_item_buff"]=1039,
		["triggered_by_spiritual_cry"]=1040,
		["triggered_vicious_hex_explosion"]=1041,
		["unearth_corpse_level"]=282,
		["unleash_support_seal_gain_frequency_+%_while_channelling"]=1042,
		["unleash_support_seal_gain_frequency_+%_while_not_channelling"]=1043,
		["upheaval_number_of_spikes"]=1044,
		["vaal_blade_vortex_has_10_spinning_blades"]=1045,
		["vaal_cold_snap_gain_frenzy_charge_every_second_if_enemy_in_aura"]=508,
		["vaal_earthquake_maximum_aftershocks"]=1046,
		["vaal_flameblast_radius_+_per_stage"]=1047,
		["vaal_lightning_strike_beam_damage_+%_final"]=285,
		["vaal_righteous_fire_life_and_es_%_as_damage_per_second"]=4,
		["vaal_righteous_fire_life_and_es_%_to_lose_on_use"]=4,
		["vaal_righteous_fire_spell_damage_+%_final"]=168,
		["vaal_storm_call_delay_ms"]=1048,
		["virtual_always_pierce"]=81,
		["virtual_berserk_hundred_times_rage_loss_per_second"]=385,
		["virtual_bladefall_number_of_volleys"]=1049,
		["virtual_blood_spears_total_number_of_spears"]=1050,
		["virtual_chill_minimum_slow_%"]=1051,
		["virtual_cyclone_skill_area_of_effect_+%_from_melee_range"]=60,
		["virtual_divine_tempest_number_of_nearby_enemies_to_zap"]=1052,
		["virtual_firestorm_drop_chilled_ground_duration_ms"]=320,
		["virtual_herald_of_thunder_bolt_base_frequency"]=1053,
		["virtual_intensity_loss_ms_while_moving_interval"]=180,
		["virtual_intensity_lost_on_teleport"]=180,
		["virtual_maximum_intensity"]=179,
		["virtual_melee_splash"]=228,
		["virtual_mine_detonation_time_ms"]=1054,
		["virtual_minion_elemental_resistance_%"]=235,
		["virtual_number_of_additional_curses_allowed"]=1055,
		["virtual_number_of_chains"]=211,
		["virtual_number_of_chains_for_beams"]=212,
		["virtual_number_of_chains_for_projectiles"]=1056,
		["virtual_number_of_forks_for_projectiles_final"]=214,
		["virtual_number_of_spirit_strikes"]=764,
		["virtual_onslaught_on_hit_%_chance"]=1057,
		["virtual_projectile_number_to_split"]=213,
		["virtual_projectiles_cannot_pierce"]=81,
		["virtual_regenerate_x_life_over_1_second_on_cast"]=865,
		["virtual_skill_gains_intensity"]=178,
		["virtual_spider_aspect_web_interval_ms"]=1058,
		["virtual_static_strike_base_zap_frequency_ms"]=1059,
		["virtual_steelskin_damage_%_taken_to_buff"]=1060,
		["virtual_steelskin_damage_limit"]=1060,
		["virtual_support_anticipation_charge_gain_interval_ms"]=1099,
		["virtual_support_storm_barrier_damage_buff_time_threshold_ms"]=1061,
		["virtual_support_storm_barrier_physical_damage_taken_+%_final_from_hits_while_channelling"]=1062,
		["virtual_tectonic_slam_%_chance_to_do_charged_slam"]=1063,
		["virtual_trap_and_mine_throwing_time_+%_final"]=1064,
		["virulent_arrow_damage_+%_final_per_stage"]=1065,
		["virulent_arrow_maximum_number_of_stacks"]=1066,
		["virulent_arrow_number_of_pod_projectiles"]=1067,
		["virulent_arrow_pod_projectile_damage_+%_final"]=1068,
		["volatile_dead_core_movement_speed_+%"]=1069,
		["volatile_dead_max_cores_allowed"]=1070,
		["volatile_dead_number_of_corpses_to_consume"]=1071,
		["wall_expand_delay_ms"]=126,
		["wall_maximum_length"]=127,
		["warcries_have_infinite_power"]=1073,
		["warcries_knock_back_enemies"]=1072,
		["warcry_count_power_from_enemies"]=1073,
		["warcry_gain_mp_from_allies"]=1073,
		["warcry_gain_mp_from_corpses"]=1073,
		["whirling_blades_evasion_rating_+%_while_moving"]=1092,
		["winter_brand_max_number_of_stages"]=1093,
		["wither_applies_additional_wither_%"]=1094,
		["wither_chance_to_apply_another_stack_if_hand_cast_%"]=1095,
		["withered_on_hit_chance_%"]=1096,
		["withering_step_chance_to_not_remove_on_skill_use_%"]=1097,
		["you_and_enemy_movement_velocity_+%_while_affected_by_ailment_you_inflicted"]=1098,
		["zombie_slam_cooldown_speed_+%"]=1106
	}